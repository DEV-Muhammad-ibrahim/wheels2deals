                                        ...
                                        <table class="table qd-table mb6 align-middle">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">User Can Add Products</th>
                                            ...
                                            <tbody>
                                                @foreach ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($user->user_can_add_products == 1)
                                                                <span
                                                                    class="badge rounded-pill badge-soft text-bg-success">True
                                                                </span>
                                                            @else
                                                                <span
                                                                    class="badge rounded-pill badge-soft text-bg-danger">
                                                                ...
                                                                <ul class="dropdown-menu text-start">
                                                                    ...
                                                                    <li>
                                                                        <a class="btn btn-secondary"
                                                                            href="{{ Route('vendor_details', $user->id) }}">Details</a>
                                                                    </li>
                                                                    <li>
                                                                        <form
                                                                    ...
                                                                    @if ($user->user_can_add_products == 1)
                                                                        <li>
                                                                            <form
                                                                                action="{{ Route('disable_vendor', $user->id) }}"
                                                                                method="POST">
                                                                                @method('POST')
                                                                                @csrf

                                                                                <button type="submit"
                                                                                    class="btn btn-danger mt-2">Disapprove</button>
                                                                                </a>
                                                                            </form>
                                                                        </li>
                                                                    @else
                                                                        <li>
                                                                            <form
                                                                                action="{{ Route('approve_vendor', $user->id) }}"
                                                                                method="POST">
                                                                                @method('POST')
                                                                                @csrf

                                                                                <button type="submit"
                                                                                    class="btn btn-success mt-2">Approve</button>
                                                                                </a>
                                                                            </form>
                                                                        </li>
                                                                    @endif
