...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-blog-blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:46:16 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-blog-blog-list.html"><span>Blog List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Blog List</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="projects-blog-add-blog.html" class="btn btn-primary">Add Post</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
										...
										<div class="row align-items-center">
											...
											<div class="col-md-9 text-end">
												<div id="edit-buttons" class="visibility-hide">
													...
													<button type="button" class="btn btn-outline-secondary me2">Archive</button>
													<button type="button" class="btn btn-outline-secondary me2">Publish</button>
													<button type="button" class="btn btn-outline-secondary">Unpublish</button>
												</div>
											</div>
										</div>
									</div>
										...
										<table class="table qd-table mb6 align-middle">
											...
											<tbody>
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
													...
													<td>
														<strong class="text-heading">12.2K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">36</strong>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">26.3K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">127</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">3.4K</strong>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">9.2K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">54</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">23.1K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Unpublish</span>
													</td>
													<td>
														<strong class="text-heading">217</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/blog/6.jpg" alt="">
															</div>
													...
													<td>
														<strong class="text-heading">16.3K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">93</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/blog/7.jpg" alt="">
															</div>
													...
													<td>
														<strong class="text-heading">7.9K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">11.1K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-info">Archive</span>
													</td>
													<td>
														<strong class="text-heading">483</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">4.0K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Unpublish</span>
													</td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/blog/10.jpg" alt="">
															</div>
													...
													<td>
														<strong class="text-heading">1.5K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">214</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check12" id="check12" class="select-item">
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/blog/11.jpg" alt="">
															</div>
													...
													<td>
														<strong class="text-heading">5.6K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-info">Archive</span>
													</td>
													<td>
														<strong class="text-heading">96</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check13" id="check13" class="select-item">
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/blog/12.jpg" alt="">
															</div>
													...
													<td>
														<strong class="text-heading">8.3K</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
													</td>
													<td>
														<strong class="text-heading">49</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-blog-blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:00 GMT -->
</html>