...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-add-task.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:52 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-tasks-add-task.html"><span>Add Task</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12 mobile-bottom-fix">
							<h1 class="page-title mb2">Add Task</h1>
						...
						<div class="row mb5">
										...
										<div class="card shadow-card p6">
											<div class="row">
												...
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-1" class="form-control" type="text" required>
												...
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-3" class="form-control qd-datepicker-single" autocomplete="off" type="text" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-4" class="form-control qd-datepicker-single" type="text" autocomplete="off" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-12 mb5">
													...
													<textarea class="form-control" id="add-form-5" rows="6"></textarea>
												</div>
												<div class="col-12">
													<label for="add-form-6" class="form-label">
														<span>Add Tasks</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="You can add multiple tasks."></i>
													</label>
													<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
														<div class="d-flex align-items-center justify-content-start">
															<div class="checkbox checkbox-primary me2">
																<input class="task-checkbox" type="checkbox" name="task1" id="task1">
																<label for="task1"></label>
															</div>
															<span>Conducting research for design, collecting samples.</span>
														</div>
														<small>09 April 2023</small>
													</div>
													<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
														<div class="d-flex align-items-center justify-content-start">
															<div class="checkbox checkbox-primary me2">
																<input class="task-checkbox" type="checkbox" name="task2" id="task2">
																<label for="task2"></label>
															</div>
															<span>Determination and purchase of software to be used for design.</span>
														</div>
														<small>10 April 2023</small>
													</div>
													<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
														<div class="d-flex align-items-center justify-content-start w-100 me4">
															<div class="checkbox checkbox-primary me2">
																<input class="task-checkbox" type="checkbox" name="task3" id="task3">
																<label for="task3"></label>
															</div>
															<input id="add-form-7" class="form-control" type="text" placeholder="Task name">
														</div>
														<input id="add-form-8" class="form-control qd-datepicker-single w-25" autocomplete="off" type="text" placeholder="Date">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-xxl-4">
								<div class="row">
									...
									<div class="col-12 mb6">
										<div class="card shadow-card p6">
											<h6 class="mb4">Add User</h6>
											<div class="border-dashed rounded p6 pb3 group-contact height-820 overflow-auto">
	...
	<script src="assets/js/pages/apps/tasks/add-task.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-add-task.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
</html>