...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-order-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:46:16 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-ecommerce-order-details.html"><span>Order Details</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-lg-7 mobile-bottom-fix">
							<h1 class="page-title mb2">Order Details - #2748</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="projects-ecommerce-order-list.html">Order List</a></li>
									<li class="breadcrumb-item active" aria-current="page">Order Details</li>
								</ol>
							</nav>
						</div>
						<div class="col-lg-5 text-start text-md-end mobile-bottom-fix">
							<!-- Progressbar Start -->
								<div class="position-relative d-flex align-items-center">
									<div class="position-absolute w-100 height-3 bg-body-secondary z-1 rounded">
										<div class="position-absolute w-50 height-3 bg-primary z-1 rounded"></div>
									</div>
									<div class="d-flex z-2 w-100">
										<div class="w-25 d-flex align-items-center justify-content-start">
											<div class="width-15 height-15 bg-primary rounded-circle border border-2 border-white"></div>
										</div>
										...
										<div class="w-25 d-flex align-items-center justify-content-end">
											<div class="width-15 height-15 bg-success rounded-circle border border-2 border-white"></div>
										</div>
									</div>
									<div class="position-absolute d-flex justify-content-between z-2 w-100 mt7 text-center">
										<small class="w-25 d-flex align-items-center justify-content-start">Order Placed</small>
										<small class="w-25 d-flex align-items-center justify-content-center">Packed</small>
										<small class="w-25 d-flex align-items-center justify-content-center">Shipped</small>
										<small class="w-25 d-flex align-items-center justify-content-end">Delivered</small>
									</div>
								</div>
							<!-- Progressbar End -->
						</div>
					...
					<!-- Content Start -->
					<div class="row">
						<!-- Items From Order Start -->
						<div class="col-xxl-8 mb6">
							<div class="card shadow-card p6">
								<h6 class="mb3">Items From Order</h6>
									...
									<table class="table qd-table align-middle mb0">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-end">
													<strong class="text-heading">$52,90</strong>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td class="text-end">
													<strong class="text-heading">$140,00</strong>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<!-- Items From Order End -->

						<!-- Order Summary Start -->
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6 pb7">
								...
								<div class="row">
									<div class="col-12">
										<div class="table-responsive text-nowrap">
											<table class="table qd-table align-middle mb2">
												<thead>
													<tr>
												...
												<tbody>
													<tr>
														...
														<td class="text-end">
															<strong class="text-heading">$319,35</strong>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<strong class="text-heading">$27,00</strong>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<strong class="text-heading">$16,48</strong>
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td class="text-end">
															<strong class="text-primary">$362,83</strong>
														</td>
													</tr>
												</tbody>
											</table>
					...
					<div class="row">
						...
						<div class="col-xxl-6 mb6">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb3">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0">Payment Address</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
						...
						<div class="col-xxl-6 mb6">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb3">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0">Shipping Address</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
					...
					<div class="row">
											...
											<table class="table qd-table align-middle mb0">
												<tbody>
													...
													<tr>
														...
														<td class="text-end">
															<strong class="text-heading">Mastercard</strong>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<strong class="text-heading">Flat Shipping Rate</strong>
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td class="text-end">
															<span class="badge rounded-pill badge-soft text-bg-info">Shipped</span>
														</td>
													</tr>
												</tbody>
											</table>
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb3">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0">Customer Details</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
											...
											<table class="table qd-table align-middle mb0">
												<tbody>
													...
													<tr>
														...
														<td class="text-end">
															<a href="#" class="text-decoration-none text-primary">justin@example.com</a>
														</td>
													</tr>
													<tr>
														<td>
													...
													<tr>
														...
														<td class="text-end">
															<strong class="text-heading">Facebook</strong>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td class="text-end">
															<div class="d-flex align-items-center justify-content-end">
																<div class="d-flex me2">
																	<i data-feather="star" stroke-width="2" width="18" class="text-warning me1" fill="var(--bs-warning)"></i>
																	<i data-feather="star" stroke-width="2" width="18" class="text-warning me1" fill="var(--bs-warning)"></i>
																	<i data-feather="star" stroke-width="2" width="18" class="text-warning me1" fill="var(--bs-warning)"></i>
																	<i data-feather="star" stroke-width="2" width="18" class="text-warning me1" fill="var(--bs-warning)"></i>
																	<i data-feather="star" stroke-width="2" width="18" class="text-warning me1 opacity-30" fill="var(--bs-warning)"></i>
																</div>
																<span>4,2</span>
															</div>
														</td>
									...
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Invoice - #YB2227</span>
											</div>
									...
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Shipping - #AYB-164827</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">PDF</span>
										</a>
									</div>
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Sales Agreement</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">PDF</span>
										</a>
									</div>
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Refund Policy</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">DOC</span>
										</a>
									</div>
									<div class="col-12 mb1">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Transport Insurance</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">DOC</span>
										</a>
									</div>
