...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-project.html"><span>Project</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Project</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-project.html">Project</a></li>
					...
					<div class="row mb6">
						...
						<div class="col-12 mb4">
							<div class="card shadow-card rounded overflow-hidden">
								<div class="row">
									<div class="col-xxl-2 mb-4 mb-xxl-0">
										<div class="bg-light p5 d-flex align-items-center justify-content-center">
											<div class="d-flex">
												<div class="width-50 height-50 rounded-circle bg-primary d-flex align-items-center justify-content-center me2">
													<i data-feather="play" stroke-width="2" height="22" class="text-white"></i>
												</div>
											</div>
											<div class="d-flex flex-column">
												...
												<div class="d-flex align-items-center">
													<i data-feather="clock" stroke-width="2" height="16" class="me1"></i>
													<span>09:00 am</span>
												</div>
											</div>
										</div>
									</div>
									<div class="col-xxl-4 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center justify-content-xxl-start">
										<div class="d-flex flex-column justify-content-start">
											<h6 class="ps1">iOS Development Project</h6>
											<div class="d-flex align-items-center">
												<i data-feather="message-circle" stroke-width="2" height="18" class="me1"></i>
												<span>7 comments</span>
											</div>
										</div>
									</div>
									<div class="col-xxl-4 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
										<div class="d-flex flex-column">
											<div class="d-flex align-items-center mb4">
												<h6 class="mb0 me1">48%</h6>
												<span class="text-heading">complete</span>
											</div>
											<div class="progress width-200 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="48" aria-valuemin="0" aria-valuemax="100">
												<div class="progress-bar bg-info" style="width: 48%"></div>
											</div>
										</div>
									</div>
									<div class="col-xxl-2 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
										<a class="btn btn-primary btn-soft d-block" href="#">Detail</a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="row">
									...
									<div class="col-xxl-4 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
										<div class="d-flex flex-column">
											...
											<div class="progress width-200 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100">
								...
								<div class="row">
									...
									<div class="col-xxl-4 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
										<div class="d-flex flex-column">
											...
											<div class="progress width-200 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100">
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.html" class="card shadow-card text-decoration-none overflow-hidden">
								<div class="img-fix w-100 height-190">
									<img src="assets/media/projects/1.jpg" alt="">
								</div>
								<div class="p6">
									<div class="d-flex flex-row justify-content-between align-items-center mb4">
										<span class="badge rounded-pill badge-soft text-bg-primary">Web Design</span>
										<div class="dropdown">
											...
											<ul class="dropdown-menu text-start">
												<li><div class="dropdown-item cursor-pointer">Edit</div></li>
												<li><div class="dropdown-item cursor-pointer">Details</div></li>
												<li>
													<div class="dropdown-item cursor-pointer d-flex align-items-center justify-content-between">
									...
									<p class="mb4 text-body">UI/UX Design, prototype, wireframing, mockups, clients collaboration</p>
									<span class="mb2 text-heading text-end">60%</span>
						...
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.html" class="card shadow-card text-decoration-none overflow-hidden">
								...
								<div class="p6">
									<div class="d-flex flex-row justify-content-between align-items-center mb4">
										<span class="badge rounded-pill badge-soft text-bg-info">App Design</span>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
									...
									<p class="mb4 text-body">UI/UX Design, prototype, wireframing, mockups, clients collaboration</p>
									<span class="mb2 text-heading text-end">42%</span>
									<div class="progress w-100 height-10 mb5" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
						...
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.html" class="card shadow-card text-decoration-none overflow-hidden">
								...
								<div class="p6">
									<div class="d-flex flex-row justify-content-between align-items-center mb4">
										<span class="badge rounded-pill badge-soft text-bg-success">Front-End Coding</span>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
									...
									<p class="mb4 text-body">UI/UX Design, prototype, wireframing, mockups, clients collaboration</p>
									<span class="mb2 text-heading text-end">36%</span>
									<div class="progress w-100 height-10 mb5" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
					...
					<div class="row">
						<!-- Card 1 Start -->
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.html" class="card shadow-card p6 text-decoration-none">
								<div class="d-flex flex-row justify-content-between align-items-center mb4">
									<span class="badge rounded-pill badge-soft text-bg-primary">Web Design</span>
									<div class="dropdown">
										<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
