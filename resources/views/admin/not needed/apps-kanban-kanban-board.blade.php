...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-kanban-kanban-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">Create New List</h5>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Kanban Board</h1>
	...
	<script src="assets/js/pages/apps/kanban-board/kanban.js" crossorigin="anonymous"></script>
</body>
