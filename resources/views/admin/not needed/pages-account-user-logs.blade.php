...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-logs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-logs.html"><span>Logs</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Logs</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-logs.html">Logs</a></li>
								</ul>
							</div>
							<!-- Nav End -->
						</div>
							...
							<div class="card shadow-card p6 pt3">
								<div class="table-responsive text-nowrap">
									<table class="table qd-table m0 align-middle">
										<thead>
											<tr>
												<th scope="col"><span class="badge rounded-pill text-bg-warning">Warning</span></th>
										...
										<tbody>
											<tr>
												<td>
													<strong class="text-heading">Critical Server Warning: Unresponsive Database</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Important</span>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Server Warning: High CPU Usage</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Important</span>
												</td>
											...
											<tr>
												<td>
													<strong class="text-heading">Server Warning: Memory Usage Exceeded</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Critical</span>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">09 Apr, 2023</strong>
												...
												<td>
													<span>/home/user/public_html/main.js</span>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="card shadow-card p6 pt3">
								<div class="table-responsive text-nowrap">
									<table class="table qd-table m0 align-middle">
										<thead>
											<tr>
												<th scope="col"><span class="badge rounded-pill text-bg-danger">Error</span></th>
												<th scope="col">PRIORITY</th>
												<th scope="col">DATE TIME</th>
												<th scope="col">FILES</th>
												<th scope="col" class="text-end">ACTIONS</th>
										...
										<tbody>
											<tr>
												<td>
													<strong class="text-heading">HTTP Error 500: Internal Server Error</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Important</span>
												</td>
											...
											<tr>
												<td>
													<strong class="text-heading">SSL Certificate Error: Invalid Certificate or Certificate Chain</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Important</span>
												</td>
											...
											<tr>
												<td>
													<strong class="text-heading">Resource Exhaustion Error: Insufficient System Resources to Complete Request</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Critical</span>
												</td>
											...
											<tr>
												<td>
													<strong class="text-heading">Database Connection Error: Unable to Establish Connection with Database Server</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Critical</span>
												</td>
												...
												<td>
													<span>/home/user/folder/app.js</span>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-logs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:50 GMT -->
</html>