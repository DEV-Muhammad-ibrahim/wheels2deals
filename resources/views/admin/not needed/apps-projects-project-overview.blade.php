...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-project-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:48 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-project-overview.html"><span>Project Overview</span></a></li>
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									<li class="active"><a href="apps-projects-project-overview.html">Overview</a></li>
							...
							<div class="card shadow-card p6 mb6">
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Task Summary</h6>
										<div class="dropdown">
								...
								<div class="row">
									<div class="col-lg-4 mb-sm-1">
										<div class="bg-primary rounded height-250 d-flex flex-column align-items-center justify-content-center">
											<div class="rounded-circle width-70 height-70 border border-white d-flex align-items-center justify-content-center mb4">
												<i data-feather="activity" stroke-width="2" height="22" class="text-white"></i>
											</div>
											<span class="text-white d-block mb4">Open Tasks</span>
											<div class="display-5 text-white">48</div>
										</div>
									</div>
									<div class="col-lg-4 mb-sm-1">
										<div class="bg-info rounded height-250 d-flex flex-column align-items-center justify-content-center">
											<div class="rounded-circle width-70 height-70 border border-white d-flex align-items-center justify-content-center mb4">
												<i data-feather="paperclip" stroke-width="2" height="22" class="text-white"></i>
											</div>
											<span class="text-white d-block mb4">Ongoing Tasks</span>
											<div class="display-5 text-white">16</div>
										</div>
									</div>
									<div class="col-lg-4 mb-sm-1">
										<div class="bg-light rounded height-250 d-flex flex-column align-items-center justify-content-center">
											<div class="rounded-circle width-70 height-70 border d-flex align-items-center justify-content-center mb4">
												<i data-feather="check-circle" stroke-width="2" height="22"></i>
											</div>
											<span class="text-heading d-block mb4">Closed Tasks</span>
											<div class="display-5 text-heading">27</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card shadow-card p6 mb6">
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Projects Timeline</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
							...
							<div class="row">
								...
								<div class="col-xxl-6 mb6">
									<div class="card shadow-card overflow-hidden p6">
										<div class="row">
											<div class="col-12">
												<div class="border border-dashed rounded p6">
													<div class="row">
														<div class="col-12">
															<div class="d-flex align-items-center justify-content-between border-bottom-dashed pb4 mb4">
																<div class="d-flex align-items-center pe6">
																	...
																	<div class="d-flex flex-column">
																		<strong class="text-heading mb1">Create new component in React</strong>
	...
	<script src="assets/js/pages/apps/projects/project-overview.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-project-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:50 GMT -->
</html>