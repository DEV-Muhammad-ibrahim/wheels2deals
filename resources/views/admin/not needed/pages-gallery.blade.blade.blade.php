...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:54 GMT -->
            ...
            <div class="modal-content">
                <form method="post" action="#" id="addcar" class="needs-validation" novalidate>
                    <div class="modal-header px-4">
                        <h5 class="modal-title fs-5">Add Library</h5>
                                ...
                                <div class="col-sm-12">
                                    <label for="add-form-2" class="form-label">
                                        ...
                                        <i data-feather="info" stroke-width="2" width="12" class="text-body"
                                            ...
                                            data-bs-custom-class="qd-tooltip" data-bs-title="Type a title."></i>
                                    </label>
                                    <input id="add-form-2" class="form-control" type="text" autocomplete="off"
                                        required>
            ...
            <div class="sidebar-menu custom-scroll pt-4">
                ...
                <ul class="menu-group m-0 px-4 mb-4">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <i data-feather="shopping-cart" stroke-width="1.5" height="18"
                                    class="me2"></i>
                                <span>eCommerce</span>
                            </div>
                            <i class="arrow" data-feather="chevron-right" height="14"></i>
                ...
                <div class="container p0">
                    ...
                    <div class="row mb6 align-items-center">
                        <div class="col-md-6 mobile-bottom-fix">
                            <h1 class="page-title mb2">Business Photos</h1>
                            <nav class="breadcrumb-nav" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#">Gallery</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Business Photos</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-md-6 text-start text-md-end">
                            <!-- Upload Button Start-->
                            <a href="apps-file-manager-files.html" class="btn btn-primary">Upload</a>
                            <!-- Upload Button End-->
                        </div>
                    </div>
                    <!-- Page Top End -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 mb6">
                            <div class="card shadow-card p6">
                                <h6 class="mb4">Media Library</h6>
                                <ul class="list-unstyled mb0 p0">
                                    <li>
                                        <a href="#"
                                            class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded active-light">
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="image"
                                                    width="16"></i>
                                                <small class="text-heading">Business Photos</small>
                                            </div>
                                            <span class="badge rounded-pill badge-soft text-bg-secondary">20</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="image"
                                                    width="16"></i>
                                                <small class="text-heading">Family Photos</small>
                                            </div>
                                    ...
                                    <li>
                                        <a href="#"
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="image"
                                                    width="16"></i>
                                                <small class="text-heading">Customer Photos</small>
                                            </div>
                                    ...
                                    <li>
                                        <a href="#"
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="image"
                                                    width="16"></i>
                                                <small class="text-heading">Project Photos</small>
                                            </div>
                                    ...
                                    <li>
                                        <a href="#"
                                            ...
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="image"
                                                    width="16"></i>
                                                <small class="text-heading">Team Photos</small>
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#addModal"
                                            class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
                                            <div class="d-flex align-items-center justify-content-start">
                                                <i class="text-body me3" stroke-width="2" data-feather="plus"
                                                    width="20"></i>
                                                <small class="text-body">Add Library</small>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-xxl-9 mb6">
                            <div class="card shadow-card p6">
                                <div class="row mb2">
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            <div class="position-absolute top-0 start-100 translate-middle z-2">
                                                <a href="#"
                                                    class="width-20 height-20 bg-danger rounded-circle overflow-hidden d-flex align-items-center justify-content-center">
                                                    <i class="text-white" stroke-width="1.5" data-feather="x"
                                                        height="14"></i>
                                                </a>
                                            </div>
                                            <a href="assets/media/gallery/1.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/1.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">office-worker.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">1.3MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/2.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/2.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">code-editor.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">9.1MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/3.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/3.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">spread-data.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">3.8MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/4.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/4.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">program-mind.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">3.4MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/5.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/5.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">presentation-pic.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">9.4MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/6.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/6.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">software-dev.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">4.5MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/7.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/7.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">database-entry.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">2.8MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/8.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/8.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">office-supplies.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">5.5MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/9.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/9.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">coding-language.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">5.8MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/10.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/10.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">excel-formula.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">2.5MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/11.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/11.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">program-loop.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">5.7MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/12.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/12.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">word-document.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">1.2MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/13.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/13.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">developer-tool.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">6.9MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/14.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/14.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">access-control.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">9.8MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/15.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/15.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">power-design.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">6.4MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/16.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/16.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">coding-logic.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">6.3MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/17.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/17.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">excel-chart.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">4.1MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/18.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/18.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">program-debug.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">6.8MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/19.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/19.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">word-processing.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">1.4MB</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-sm-6 mb6">
                                        <div class="position-relative">
                                            ...
                                            <a href="assets/media/gallery/20.jpg"
                                                class="d-block img-fix rounded w-100 height-150 mb1"
                                                data-fslightbox="gallery">
                                                <img src="assets/media/gallery/20.jpg" alt="">
                                            </a>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="text-heading">office-env.jpg</span>
                                                <span class="badge rounded-pill badge-soft text-bg-info">2.1MB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:53:01 GMT -->
