...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:46 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-billing.html"><span>Billing</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Billing</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-billing.html">Billing</a></li>
					...
					<!-- Current Plan & Card Content Start -->
					<div class="row">
						<!-- Current Plan Start -->
						<div class="col-xxl-8 mb6">
							<div class="card shadow-card p6">
								<h6 class="mb4">Current Plan</h6>
								<div class="row align-items-center">
									<div class="col-xxl-7 mobile-bottom-fix">
										<strong class="text-heading d-block mb1">Active until Apr 09, 2023</strong>
										<span class="d-block mb4">We will send you a notification upon Subscription expiration.</span>
										<div class="d-block mb1 flex-column align-items-center justify-content-start">
											<strong class="text-heading me3">$29,99 Per Month</strong>
											<span class="badge rounded-pill badge-soft text-bg-primary">Basic Plan</span>
										</div>
										<span class="d-block mb4">Standard plan for small to medium businesses.</span>
										<div class="d-block mb1 flex-column align-items-center justify-content-start">
											<strong class="text-heading me3">**** **** **** **48</strong>
											<span class="badge rounded-pill badge-soft text-bg-info">Visa</span>
										</div>
										<span class="d-block">Automatic payment will be made with your defined credit card.</span>
									</div>
									<div class="col-xxl-5">
										<div class="d-flex align-items-center justify-content-between mb2">
											<span class="text-heading">Days</span>
											<span class="text-heading">16 of 30 Days</span>
										</div>
										<div class="progress w-100 height-5 mb2" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar bg-primary" style="width: 60%"></div>
										</div>
										<small class="d-block mb6">14 days remaining until your plan requires update</small>
										<div class="d-flex align-items-center justify-content-between">
											<button type="button" class="btn btn-secondary btn-soft">Cancel Subscription</button>
											<button type="button" class="btn btn-success btn-soft">Upgrade Plan</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card overflow-hidden">
								<div class="bg-primary p5">
									<div class="d-flex align-items-center justify-content-between mb6">
										<h6 class="text-white m0">Horizon Trust Bank</h6>
										<div class="width-40 height-20 rounded bg-primary-subtle"></div>
									</div>
									<strong class="text-white-50 d-block mb1">Card Balance</strong>
									<div class="display-6 text-white">$226,40</div>
								</div>
								<div class="p5">
									<span class="d-block mb2">04/25</span>
									<div class="d-flex align-items-center justify-content-between">
										<span class="text-heading">Barry Tone</span>
										<span class="text-heading">**** 4827</span>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- Current Plan & Card Content End -->

					<!-- Payment Methods Start -->
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6">
								<h6 class="mb4">Payment Methods</h6>
								<div class="row">
									<!-- Item 1 Start -->
									<div class="col-xxl-6 mb6">
										<div class="border-dashed rounded p6">
											<div class="row align-items-center">
												<div class="col-lg-6 mobile-bottom-fix">
													<div class="d-flex flex-row align-items-center justify-content-start">
														<div class="width-80 height-60 bg-light rounded d-flex align-items-center justify-content-center me4">
															<img src="assets/media/logos/visa.svg" class="height-20" alt="">
														</div>
												...
												<div class="col-lg-6 text-lg-end text-center">
													<button type="button" class="btn btn-secondary btn-soft me3">Delete</button>
													<button type="button" class="btn btn-secondary btn-soft">Edit</button>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="border-dashed rounded p6">
											<div class="row align-items-center">
												<div class="col-lg-6 mobile-bottom-fix">
													<div class="d-flex flex-row align-items-center justify-content-start">
														<div class="width-80 height-60 bg-light rounded d-flex align-items-center justify-content-center me4">
															<img src="assets/media/logos/mastercard.svg" class="height-30" alt="">
														</div>
														<div class="d-flex flex-column">
															<strong class="text-heading d-block mb1">Gustav Purpleson</strong>
															<span>**** 1627</span>
													</div>
													</div>
												</div>
										...
										<div class="border-dashed rounded p6">
											<div class="row align-items-center">
												<div class="col-lg-6 mobile-bottom-fix">
													<div class="d-flex flex-row align-items-center justify-content-start">
														<div class="width-80 height-60 bg-light rounded d-flex align-items-center justify-content-center me4">
															<img src="assets/media/logos/amex.svg" class="height-30" alt="">
														</div>
														<div class="d-flex flex-column">
															<strong class="text-heading d-block mb1">Benjamin Evalent</strong>
															<span>**** 2216</span>
													</div>
													</div>
												</div>
										...
										<div class="border-dashed rounded p6">
											<div class="row align-items-center">
												<div class="col-lg-6 mobile-bottom-fix">
													<div class="d-flex flex-row align-items-center justify-content-start">
														<div class="width-80 height-60 bg-light rounded d-flex align-items-center justify-content-center me4">
															<img src="assets/media/logos/paypal.svg" class="height-50" alt="">
														</div>
														<div class="d-flex flex-column">
															<strong class="text-heading d-block mb1">Brandon Guide</strong>
															<span>barry@domain.com</span>
													</div>
													</div>
												</div>
												<div class="col-lg-6 text-lg-end text-center">
					...
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6">
								<h6 class="mb4">Billing History</h6>
								<div class="table-responsive text-nowrap">
									<table class="table qd-table m0 align-middle">
										<thead>
											<tr>
										...
										<tbody>
											<tr>
												...
												<td>
													<span>Monthly subscription for premium streaming service</span>
												</td>
												<td>
													<strong class="text-heading">$68.93</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Unpaid</span>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td>
													<span>Annual membership fee for online shopping platform</span>
												</td>
												<td>
													<strong class="text-heading">$136.25</strong>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<span>Monthly billing for cloud storage service</span>
												</td>
												<td>
													<strong class="text-heading">$102.80</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Paid</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">03 Apr, 2023</strong>
														<small>18:23PM</small>
													</div>
												</td>
												<td>
													<span>Annual access fee for educational website</span>
												</td>
												<td>
													<strong class="text-heading">$42.11</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Paid</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">02 Apr, 2023</strong>
														<small>11:16AM</small>
													</div>
												</td>
												<td>
													<span>Annual subscription for digital art platform</span>
												</td>
												<td>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
</html>