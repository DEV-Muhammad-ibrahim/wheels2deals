...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-contacts-contact-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:14 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-contacts-contact-list.html"><span>Contact List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<a href="apps-contacts-add-contact.html" class="btn btn-primary">Add New</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
										...
										<div class="row align-items-center">
											...
											<div class="col-md-8 text-end">
												<div id="edit-buttons" class="visibility-hide">
													...
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Block">
														<i class="text-body" data-feather="alert-circle" width="20"></i>
													</button>
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
														<i class="text-body" data-feather="edit-3" width="20"></i>
													</button>
													<button type="button" class="btn btn-danger btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
										...
										<table class="table qd-table mb6 align-middle">
											<tbody>
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none d-block">
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">norman@example.com</a>
													</td>
													<td class="text-end">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">fleece@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">thomas@domain.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">benjamin@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">niles@site.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">rodney@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">wisteria@revenclaw.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">justin@yoursite.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																<div class="width-40 height-40 rounded-circle me4 d-flex align-items-center justify-content-center bg-success-subtle">
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">nathaneal@sitename.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.html" class="text-decoration-none text-body hover-primary">indigo@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
	...
	<script src="assets/js/pages/apps/contacts/contact-list.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-contacts-contact-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:15 GMT -->
</html>