...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-blog-add-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:00 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-blog-add-blog.html"><span>Add Blog</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12 mobile-bottom-fix">
							<h1 class="page-title mb2">Add Blog</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="projects-blog-blog-list.html">Blog List</a></li>
						...
						<div class="row mb5">
									...
									<div class="row">
										...
										<div class="col-md-6 mb5">
											<label for="add-form-1" class="form-label">
												...
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Write a title for the blog post."></i>
											</label>
										...
										<div class="col-md-6 mb5">
											<label for="add-form-3" class="form-label">
												<span>Category</span>
												<span class="text-danger">*</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a category for the blog post."></i>
											</label>
											<select id="add-form-3" class="form-select js-choice" required>
											...
											<div class="invalid-feedback">Please make a selection from the list.</div>
										</div>
										<div class="col-md-6 mb5">
											<label for="add-form-4" class="form-label">
												<span>Visibility</span>
												<span class="text-danger">*</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select the visibility of the blog post."></i>
											</label>
											<select id="add-form-4" class="form-select js-choice" required>
										...
										<div class="col-12">
											<label for="add-form-5" class="form-label">
												...
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Blog content"></i>
											</label>
								...
								<div class="card shadow-card p6">
									<div class="row">
										...
										<div class="col-12 mb5">
											...
											<input id="add-form-6" class="form-control" type="text" required>
											<div class="invalid-feedback">Please fill out all fields.</div>
										</div>
										<div class="col-12">
										...
										<div class="col-12">
											...
											<input id="add-form-8" class="form-control tagify" type="text" value="fps game, online">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-xxl-4 mb6">
								<div class="card shadow-card p6">
									...
									<div id="drop-area" class="d-flex flex-column align-items-center bg-light height-440 mb1">
										<div class="width-120 height-120 border-dashed rounded bg-body-secondary position-relative overflow-hidden d-flex align-items-center justify-content-center mt7 mb4">
								...
								<div class="card shadow-card p6">
									<div class="row">
										...
										<div class="col-12 mb5">
											...
											<select id="add-form-9" class="form-select js-choice" required>
										...
										<div class="col-12 mb5">
											...
											<select id="add-form-10" class="form-select js-choice">
										...
										<div class="col-12">
											<label for="add-category-form-4" class="form-label d-block">
												<span>Other</span>
											</label>
							...
							<div class="col-12 text-end">
								<button type="button" class="btn btn-secondary me2" data-bs-dismiss="modal">Discard</button>
	...
	<script src="assets/js/pages/projects/blog/add-blog.js" crossorigin="anonymous"></script>
</body>
