...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-documents.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-documents.html"><span>Documents</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Documents</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								<div class="border-bottom p6 position-relative">
									<div class="position-absolute bg-gradient w-100 height-100 border top-0 start-0 z-1"></div>
									<div class="row position-relative z-2">
										<div class="col-xxl-2 col-md-3 col-sm-5 col-12 mobile-bottom-fix">
											<img src="assets/media/avatars/man.jpg" class="img-fluid rounded" alt="">
										</div>
										<div class="col-xxl-10 col-md-9 col-sm-7 col-12">
											<div class="row mb7 pb2">
												<div class="col-12 text-end">
													<div class="d-block flex-row align-items-center justify-content-start">
														<button class="btn btn-light me2">Hire Me</button>
														<button class="btn btn-light me2">Follow</button>
														<div class="dropdown d-inline">
															<button type="button" class="btn p1 btn-light dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
																<i data-feather="more-horizontal" stroke-width="2" width="20" class="text-body ms1"></i>
															</button>
															<ul class="dropdown-menu text-start">
																...
																<li>
																	<a class="dropdown-item d-flex align-items-center justify-content-between" href="#">
																		Message <i data-feather="info" stroke-width="2" height="12" class="text-body me1" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="qd-tooltip" data-bs-title="Quickly send a message to the user."></i>
																	</a>
																</li>
															</ul>
														</div>
											...
											<div class="row align-items-center">
												<div class="col-xxl-8 mobile-bottom-fix">
													<div class="d-flex flex-row align-items-center justify-content-start mb1">
														<h5 class="mb0 me3">Barry Tone</h5>
														<span class="badge rounded-pill badge-soft text-bg-success">Pro</span>
													</div>
													<small class="d-block mb5">@BarryTone</small>
													<div class="row">
														<div class="col-lg-4">
															<i data-feather="map-pin" stroke-width="2" width="14" class="text-heading me1"></i>
															<span>Florida, United States</span>
														</div>
														<div class="col-lg-8">
															<i data-feather="link" stroke-width="2" width="14" class="text-heading me1"></i>
															<a href="#" class="text-decoration-none text-body hover-primary">examplesite.com</a>
														</div>
													</div>
												</div>
												<div class="col-xxl-4 text-end">
													...
													<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-documents.html">Documents</a></li>
					...
					<div class="row mb6">
						<div class="col-12">
							<div class="alert alert-primary mb0" role="alert">
								<div class="row align-items-center">
									<div class="col-lg-7 mobile-bottom-fix">
										<h4 class="text-primary mb4">You can quickly organize your files.</h4>
										<p class="text-primary m0">You can quickly organize your files by going to the file manager app. Adding and deleting new files is now very easy. Keep trying.</p>
									</div>
									<div class="col-lg-5 text-end">
										<a href="apps-file-manager-files.html" class="btn btn-primary">File Manager</a>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- Files Start -->
					<div class="row">
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">documentation</strong>
										<span class="text-body">27 files</span>
									</div>
								</div>
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">html</strong>
										<span class="text-body">48 files</span>
									</div>
								</div>
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">node_modules</strong>
										<span class="text-body">16 files</span>
									</div>
								</div>
								<span class="badge rounded-pill badge-soft text-bg-success">127.2 MB</span>
							</a>
						</div>
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">scss</strong>
										<span class="text-body">22 files</span>
									</div>
								</div>
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">react-files</strong>
										<span class="text-body">35 files</span>
									</div>
								</div>
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
								<div class="d-flex align-items-center justify-content-start">
									<i class="fa fa-folder-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
									<div class="d-flex flex-column">
										<strong class="text-heading mb1">vue-files</strong>
										<span class="text-body">34 files</span>
									</div>
								</div>
