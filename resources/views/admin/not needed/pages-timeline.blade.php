...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:53 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Timeline</h1>
					...
					<!-- Page Bottom Start -->
					<div class="row mb6 position-relative overflow-hidden">
						<div class="col-12">
							<!-- Item 1 Start -->
							<div class="row mb7">
								<div class="position-absolute h-100 border-start-dashed start-50 z-1"></div>
								<div class="col-xxl-7 ps5 sm-p-0 position-relative z-2 order-xxl-1 mobile-bottom-fix">
									<div class="d-flex align-items-center flex-row ps7 sm-p-0">
										<div class="card shadow-card rounded-circle width-80 height-80 d-flex align-items-center justify-content-center me3">
											<i data-feather="archive" stroke-width="1.5" height="24" class="text-primary"></i>
										</div>
								...
								<div class="col-xxl-5 position-relative z-2">
									<div class="card shadow-card rounded p5">
										<div class="d-flex flex-row align-items-center justify-content-between mb4">
										...
										<div class="d-flex">
											<p class="m0">Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget. Aliquam dui mi, ullamcorper et venenatis nec, tincidunt ut quam.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row mb7">
								<div class="position-absolute h-100 border-start-dashed start-50 z-1"></div>
								<div class="col-xxl-7 mobile-bottom-fix pe5 sm-p-0 position-relative z-2">
									<div class="d-flex align-items-center justify-content-end flex-row pe7 sm-p-0">
										<div class="d-flex flex-column align-items-end justify-content-end me3">
											<strong class="text-heading">05 Nov, 2022</strong>
											<small>09:42AM</small>
										</div>
										<div class="card shadow-card rounded-circle width-80 height-80 d-flex align-items-center justify-content-center">
											<i data-feather="award" stroke-width="1.5" height="24" class="text-primary"></i>
										</div>
									</div>
								</div>
								<div class="col-xxl-5 position-relative z-2">
							...
							<div class="row mb7">
								...
								<div class="col-xxl-7 ps5 sm-p-0 position-relative z-2 order-xxl-1 mobile-bottom-fix">
									<div class="d-flex align-items-center flex-row ps7 sm-p-0">
										<div class="card shadow-card rounded-circle width-80 height-80 d-flex align-items-center justify-content-center me3">
											<i data-feather="download-cloud" stroke-width="1.5" height="24" class="text-primary"></i>
										</div>
										<div class="d-flex flex-column align-items-start justify-content-start">
											<strong class="text-heading">01 Nov, 2022</strong>
											<small>10:12AM</small>
										</div>
									</div>
								</div>
									...
									<div class="card shadow-card p6">
										<div class="row align-items-center mb4">
											<div class="col d-flex flex-row justify-content-between align-items-center">
												<h6 class="mb0">Download Files</h6>
											</div>
										</div>
										<div class="row">
											<div class="col-12 mb3">
												<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
													<div class="d-flex align-items-center justify-content-start">
														...
														<span class="text-heading">Theme Documentation</span>
													</div>
											...
											<div class="col-12 mb3">
												<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
													<div class="d-flex align-items-center justify-content-start">
														...
														<span class="text-heading">License Certificate</span>
													</div>
													<span class="badge rounded-pill badge-soft text-bg-info">PDF</span>
												</a>
											</div>
											<div class="col-12">
												<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
													<div class="d-flex align-items-center justify-content-start">
														...
														<span class="text-heading">New Logo</span>
													</div>
							...
							<div class="row mb7">
								...
								<div class="col-xxl-7 mobile-bottom-fix pe5 sm-p-0 position-relative z-2">
									<div class="d-flex align-items-center justify-content-end flex-row pe7 sm-p-0">
										<div class="d-flex flex-column align-items-end justify-content-end me3">
											<strong class="text-heading">27 Mar, 2009</strong>
											<small>16:22PM</small>
										</div>
										<div class="card shadow-card rounded-circle width-80 height-80 d-flex align-items-center justify-content-center">
											<i data-feather="flag" stroke-width="1.5" height="24" class="text-primary"></i>
										</div>
									</div>
								</div>
								<div class="col-xxl-5 position-relative z-2">
									<div class="card shadow-card p6">
										<div class="d-flex align-items-start justify-content-start w-100">
											...
											<div class="d-flex flex-column">
												...
												<p>Cras tristique risus massa, a interdum ante pharetra vel. Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc.</p>
												<div class="d-flex align-items-center justify-content-start">
							...
							<div class="row">
								...
								<div class="col-xxl-7 ps5 sm-p-0 position-relative z-2 order-xxl-1 mobile-bottom-fix">
									<div class="d-flex align-items-center flex-row ps7 sm-p-0">
										<div class="card shadow-card rounded-circle width-80 height-80 d-flex align-items-center justify-content-center me3">
											<i data-feather="dollar-sign" stroke-width="1.5" height="24" class="text-primary"></i>
										</div>
										<div class="d-flex flex-column align-items-start justify-content-start">
											<strong class="text-heading">20 Mar, 2008</strong>
											<small>22:38PM</small>
										</div>
									</div>
								</div>
