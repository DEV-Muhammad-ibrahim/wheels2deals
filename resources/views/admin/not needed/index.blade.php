        ...
        <div class="app-sidebar">
            ...
            <div class="sidebar-logo d-flex justify-content-center">
                <a href="index.html">
                    ...
                    <h2 style="color: white">Wheels2Deal</h2>
                </a>
            </div>
            <!-- ***** Logo End ***** -->
                                        ...
                                        <div class="row mb4 align-items-center">
                                            ...
                                            <div class="col d-flex flex-row justify-content-end">
                                                <div class="d-flex align-items-center me4">
                                                    <div class="width-10 height-10 bg-primary rounded-circle me1">
                                                    </div>
                                                    <span>Gained</span>
                                                </div>
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="card shadow-card p5 mb5">
                                <div class="row align-items-center mb4">
                                    <div class="col d-flex flex-row justify-content-between align-items-center">
                                        ...
                                        <small><a href="#"
                                                class="text-body text-decoration-none hover-primary">VIEW
                                                ALL</a></small>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <a href="#"
                                            class="rounded border-dashed p4 mb4 d-block text-decoration-none text-body">
                                            <strong class="text-heading d-block mb4">Developing an idea for admin
                                                dashboard & pages</strong>
                                            <div class="d-flex flex-row align-items-center justify-content-between">
                                                <span
                                                    class="badge rounded-pill badge-soft text-bg-success p-e">UI/UX</span>
                                                <div class="d-flex align-items-center">
                                        ...
                                        <a href="#"
                                            class="rounded border-dashed p4 mb4 d-block text-decoration-none text-body">
                                            <strong class="text-heading d-block mb4">Find React Framework for car
                                                website and mobile app</strong>
                                            <div class="d-flex flex-row align-items-center justify-content-between">
                                                <span
                                                    class="badge rounded-pill badge-soft text-bg-info p-e">CODE</span>
                                                <div class="d-flex align-items-center">
                                        ...
                                        <a href="#"
                                            class="rounded border-dashed p4 mb4 d-block text-decoration-none text-body">
                                            <strong class="text-heading d-block mb4">Redesign header & footer content
                                                for client app</strong>
                                            <div class="d-flex flex-row align-items-center justify-content-between">
                                                <span
                                                    class="badge rounded-pill badge-soft text-bg-warning p-e">APP</span>
                                                <div class="d-flex align-items-center">
                                        ...
                                        <a class="btn btn-info btn-soft d-block mb1" href="#"
                                            role="button">All Tasks</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 mb5">
                            <div class="card shadow-card p6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div
                                            class="d-flex align-items-center justify-content-between border-bottom-dashed pb4 mb4">
                                    ...
                                    <div class="col-12">
                                        <div
                                            ...
                                            <div class="d-flex align-items-center pe6">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <strong class="text-heading mb1">Improve workflow in
                                                        Figma</strong>
                                    ...
                                    <div class="col-12">
                                        <div
                                            class="d-flex align-items-center justify-content-between border-bottom-dashed pb4">
                                            <div class="d-flex align-items-center pe6">
                        ...
                        <div class="col-xxl-6 mb5">
                            <div class="card shadow-card p6 position-relative overflow-hidden">
                                ...
                                <div class="card shadow-card shadow-lg p5 mb4">
                                    ...
                                    <div class="row mb4">
                                        <div class="col">
                                            <div class="progress height-8" role="progressbar"
                                                aria-label="Basic example" aria-valuenow="25" aria-valuemin="0"
                                                aria-valuemax="100">
                            ...
                            <div class="card shadow-card p6">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <div class="d-flex">
                                            <i data-feather="trending-up" stroke-width="2" height="20"
                                                class="text-success"></i>
                            ...
                            <div class="card shadow-card p6">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <div class="d-flex">
                                            <i data-feather="trending-down" stroke-width="2" height="20"
                                                class="text-danger"></i>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive text-nowrap">
                                            <table class="table qd-table mb0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row"><strong class="text-heading">Smart
                                                                Phone</strong></th>
                                                        <td>4827</td>
                                                        <td>Phone</td>
                                                        <td>$1.200</td>
                                                        <td><span
                                                                class="badge badge-soft rounded-pill text-bg-success">In
                                                                Stock</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><strong class="text-heading">Smart
                                                        ...
                                                        <td>$400</td>
                                                        <td><span
                                                                class="badge badge-soft rounded-pill text-bg-danger">Out
                                                                Stock</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><strong class="text-heading">Black
                                                                Laptop</strong></th>
                                                        <td>1187</td>
                                                        <td>Computer</td>
                                                        <td>$1.750</td>
                                                        <td><span
                                                                class="badge badge-soft rounded-pill text-bg-warning">Low
                                                                Stock</span></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"><strong class="text-heading">7”
                                                                Tablet</strong></th>
                                                        <td>784</td>
                                                        <td>Phone</td>
                                                        <td>$650</td>
