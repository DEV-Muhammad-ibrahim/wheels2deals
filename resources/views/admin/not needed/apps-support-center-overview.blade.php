...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-support-center-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:09 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">New Ticket</h5>
									...
									<div class="row">
										...
										<div class="col-sm-12 mb5">
											<label for="add-form-2" class="form-label">
												<span>Priority</span>
												<span class="text-danger">*</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a priority from the list."></i>
											</label>
										...
										<div class="col-12">
											<label for="add-form-4" class="form-label">
												...
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a description."></i>
											</label>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-support-center-overview.html"><span>Overview</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Support Center</h1>
						...
						<div class="col-md-6 text-start text-md-end">
									...
									<div class="p5 px-4">
										<div class="row mb5">
											<div class="col-12 mb4">
												<label for="form-element-1" class="form-label">Priority:</label>
											...
											<div class="col-12 mb4">
												<label for="form-element-2" class="form-label">Status:</label>
							...
							<!-- Add Button Start-->
							<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">New Ticket</button>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p2 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-column align-items-start ps3">
									<h6 class="mb5">Total Tickets</h6>
									<div class="d-flex">
								...
								<div class="d-flex">
									<div class="bg-light p6 rounded">
										<h4 class="m0 text-primary">4.827</h4>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p2 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-column align-items-start ps3">
									<h6 class="mb5">Pending Tickets</h6>
									<div class="d-flex">
								...
								<div class="d-flex">
									<div class="bg-light p6 rounded">
										<h4 class="m0 text-danger">2.216</h4>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p2 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-column align-items-start ps3">
									<h6 class="mb5">Closed Tickets</h6>
									<div class="d-flex">
										<i data-feather="trending-up" stroke-width="2" width="22" class="text-success me2"></i>
										<strong class="text-heading me2">+3.3%</strong>
										<strong>+2.3K this week</strong>
									</div>
								</div>
								<div class="d-flex">
									<div class="bg-light p6 rounded">
										<h4 class="m0 text-success">1.648</h4>
									</div>
								</div>
							</div>
						</div>
										...
										<table class="table qd-table mb6 align-middle">
											...
											<tbody>
												<tr>
													...
													<td>
														<span>I Can't Receive Mail</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Open</span>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<span>I am having a payment problem.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">09 Apr, 2023</strong>
												...
												<tr>
													...
													<td>
														<span>Server setup is very slow.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
												...
												<tr>
													...
													<td>
														<span>I want to cancel my subscription.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">08 Apr, 2023</strong>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-warning">Inprogress</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<span>I did not receive the invoice.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">08 Apr, 2023</strong>
												...
												<tr>
													...
													<td>
														<span>When will the new version be released?</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
												...
												<tr>
													...
													<td>
														<span>In-app purchase problem.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">07 Apr, 2023</strong>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Closed</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<span>Can I get the API code?</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
												...
												<tr>
													...
													<td>
														<span>iPad version resolution problem.</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
	...
	<script src="assets/js/pages/apps/support-center/overview.js" crossorigin="anonymous"></script>
</body>
