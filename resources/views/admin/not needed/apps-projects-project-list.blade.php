...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-project-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:32 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-projects-project-list.html"><span>Project List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Project List</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="apps-projects-add-project.html" class="btn btn-primary">Add Project</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-project-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:47 GMT -->
</html>