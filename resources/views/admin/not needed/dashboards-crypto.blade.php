...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-crypto.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:02 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="dashboards-crypto.html"><span>Crypto</span></a></li>
		...
		<main class="app-main">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container-fluid p0">
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-6 flex-column align-items-start">
										<img class="me3" src="assets/media/logos/bitcoin.svg" height="60" alt="">
										<h6 class="d-inline text-body">Bitcoin</h6>
									</div>
									<div class="col-6 d-flex justify-content-end">
										<div class="height-60 overflow-hidden">
									...
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0">$23.081,14</h3>
												<span class="badge rounded-pill badge-soft text-bg-primary">3.47%</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-primary-subtle rounded-bottom z-1 opacity-30"></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-6 flex-column align-items-start">
										<img class="me3" src="assets/media/logos/ethereum.svg" height="60" alt="">
										<h6 class="d-inline text-body">Ethereum</h6>
									</div>
									<div class="col-6 d-flex justify-content-end">
										<div class="height-60 overflow-hidden">
								...
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0">$1.576,02</h3>
												<span class="badge rounded-pill badge-soft text-bg-info">-1.26%</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-info-subtle rounded-bottom z-1 opacity-30"></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-6 flex-column align-items-start">
										<img class="me3" src="assets/media/logos/tether.svg" height="60" alt="">
										<h6 class="d-inline text-body">Tether</h6>
									</div>
									<div class="col-6 d-flex justify-content-end">
										<div class="height-60 overflow-hidden">
								...
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0">$1,0003</h3>
												<span class="badge rounded-pill badge-soft text-bg-primary">0.03%</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-primary-subtle rounded-bottom z-1 opacity-30"></div>
										</div>
									</div>
					...
					<div class="row">
						...
						<div class="col-xxl-8 mb5">
							<div class="card shadow-card p6 pb5">
									...
									<div class="col d-flex flex-row justify-content-end">
										<div class="dropdown">
											<button type="button" class="bg-transparent p0 outline-none dropdown-toggle arrow-none border height-30 rounded ps3" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<span class="text-body">BTC/USD</span>
												<i data-feather="chevron-down" stroke-width="2" height="16" class="text-heading"></i>
											</button>
											<ul class="dropdown-menu text-start">
												<li><a class="dropdown-item" href="#">BTC/ETH</a></li>
												<li><a class="dropdown-item" href="#">BTC/XRP</a></li>
												<li><a class="dropdown-item" href="#">BTC/ADA</a></li>
											</ul>
										</div>
									</div>
								</div>
								<div class="row mb1">
									<div class="col-12">
										<div id="chart24" class="chart24"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline me3">Stop - Limit</h6>
										<div class="dropdown">
								...
								<div class="row">
									<div class="col-12 mb5">
										<select class="form-select js-choice">
											...
											<option value="1">BTC/XRP</option>
											<option value="2">BTC/ADA</option>
								...
								<div class="row align-items-center mb4">
									<div class="col-4">
										<label for="inputStop" class="col-form-label">Stop</label>
									</div>
									<div class="col-8">
										<div class="input-group">
											<input type="text" id="inputStop" class="form-control" placeholder="0.00897899">
								...
								<div class="row align-items-center mb4">
									...
									<div class="col-8">
										<div class="input-group">
											<input type="text" id="inputLimit" class="form-control" placeholder="0.00897899">
								...
								<div class="row align-items-center mb5">
									...
									<div class="col-8">
										<div class="input-group">
											<input type="text" id="inputAmount" class="form-control" placeholder="0.00897899">
											<span class="input-group-text">ETH</span>
										</div>
									</div>
								</div>
								...
								<div class="row align-items-center mb6">
									...
									<div class="col-8">
										<div class="input-group">
											<input type="text" id="inputTotal" class="form-control" placeholder="0.00897899">
											<span class="input-group-text">BTC</span>
										</div>
									</div>
								</div>
								<div class="row mb2">
									<div class="col-6">
										<div class="d-grid gap-2">
											<button class="btn btn-success d-block" role="button">BUY</button>
										</div>
									</div>
									<div class="col-6">
										<div class="d-grid gap-2">
											<button class="btn btn-danger btn-soft d-block" role="button">SELL</button>
										</div>
									</div>
								</div>
							</div>
					...
					<!-- Market Depth Row Start -->
					<div class="row mb5">
						<div class="col-12">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline me3">Market Depth</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
						...
						<div class="col-xxl-6 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline me3">Market List</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
										...
										<div class="table-responsive text-nowrap">
											<table class="table qd-table mb0 align-middle">
												<tbody>
													<tr>
														<td>
															<img src="assets/media/logos/bitcoin.svg" width="60" alt="">
															<strong class="text-heading ms4">Bitcoin</strong>
														</td>
														<td><span>BTC</span></td>
														<td><span class="text-heading">$22.998,25</span></td>
														<td>
															<i data-feather="trending-up" stroke-width="2" height="20" class="text-success"></i>
															<strong class="text-success">+3.7%</strong>
														</td>
													</tr>
													<tr>
														<td>
															<img src="assets/media/logos/ethereum.svg" width="60" alt="">
															<strong class="text-heading ms4">Ethereum</strong>
														</td>
														<td><span>ETH</span></td>
														<td><span class="text-heading">$1.571,19</span></td>
														<td>
															<i data-feather="trending-down" stroke-width="2" height="20" class="text-danger"></i>
															<strong class="text-danger">-2.6%</strong>
														</td>
													</tr>
													<tr>
														<td>
															<img src="assets/media/logos/tether.svg" width="60" alt="">
															<strong class="text-heading ms4">Tether</strong>
														</td>
														<td><span>USDT</span></td>
														<td><span class="text-heading">$1,0003</span></td>
														<td>
															<i data-feather="trending-up" stroke-width="2" height="20" class="text-success"></i>
															<strong class="text-success">+0.2%</strong>
														</td>
													</tr>
													<tr>
														<td>
															<img src="assets/media/logos/bnb.svg" width="60" alt="">
															<strong class="text-heading ms4">BNB</strong>
														</td>
														<td><span>BNB</span></td>
														<td><span class="text-heading">$306,88</span></td>
														<td>
															<i data-feather="trending-down" stroke-width="2" height="20" class="text-danger"></i>
													...
													<tr>
														<td>
															<img src="assets/media/logos/cardano.svg" width="60" alt="">
															<strong class="text-heading ms4">Cardano</strong>
														</td>
														<td><span>ADA</span></td>
														<td><span class="text-heading">$0,3802</span></td>
														<td>
															<i data-feather="trending-up" stroke-width="2" height="20" class="text-success"></i>
															<strong class="text-success">+4.2%</strong>
														</td>
													</tr>
												</tbody>
											</table>
							...
							<div class="row">
								...
								<div class="col-12 mb5">
									<div class="card shadow-card p6">
										<div class="row align-items-center mb4">
											<div class="col d-flex flex-row justify-content-between align-items-center">
												<h6 class="mb0 d-inline me3">Connect Wallet</h6>
												<div class="dropdown">
													<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
														<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
													</button>
										...
										<div class="row">
											<div class="col-12">
												<div class="d-flex justify-content-between border-bottom-dashed pb4 mb4">
													<div class="d-flex align-items-center">
														<div class="width-40 height-40 img-fix me3">
															<img src="assets/media/logos/metamask.svg" alt="">
														</div>
														<div class="d-flex flex-column align-items-start">
															<strong class="text-heading d-block mb1">Metamask</strong>
															<span>Store Payment</span>
														</div>
													</div>
													<button class="btn btn-primary btn-soft btn-sm px-4 rounded" role="button">Connect</button>
												</div>
											</div>
											<div class="col-12">
												<div class="d-flex justify-content-between">
													<div class="d-flex align-items-center">
														<div class="width-40 height-40 img-fix me3">
															<img src="assets/media/logos/fortmatic.svg" alt="">
														</div>
														<div class="d-flex flex-column align-items-start">
															<strong class="text-heading d-block mb1">Fortmatic</strong>
															<span>Store Payment</span>
														</div>
													</div>
													<button class="btn btn-info btn-soft btn-sm px-4 rounded" role="button">Remove</button>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-12">
									<div class="card shadow-card p6">
										<div class="row align-items-center mb5">
											<div class="col d-flex flex-row justify-content-between align-items-center">
												<h6 class="mb0 d-inline me3">My Savings</h6>
												<div class="dropdown">
													<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
														<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
													</button>
										...
										<div class="row">
											<div class="col-12">
												<div class="border-bottom-dashed pb4 mb4">
													<div class="d-flex justify-content-between mb4">
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading d-block mb2">Bitcoin</strong>
															<span>1.01682658 BTC</span>
														</div>
														<div class="d-flex flex-column justify-content-end text-end">
															<strong class="text-heading d-block mb2">$38.457,74</strong>
															<span class="text-primary">68%</span>
														</div>
													</div>
													<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100">
											...
											<div class="col-12">
												<div>
													<div class="d-flex justify-content-between mb4">
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading d-block mb2">Ethereum</strong>
															<span>3.2619371 ETH</span>
														</div>
														<div class="d-flex flex-column justify-content-end text-end">
															<strong class="text-heading d-block mb2">$4.743,12</strong>
															<span class="text-primary">37%</span>
														</div>
													</div>
													<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="37" aria-valuemin="0" aria-valuemax="100">
														<div class="progress-bar bg-info" style="width: 37%"></div>
													</div>
												</div>
											</div>
										</div>
	...
	<script src="assets/js/pages/dashboards/dashboard-05.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-crypto.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:05 GMT -->
</html>