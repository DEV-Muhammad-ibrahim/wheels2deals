...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-security.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:46 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-security.html"><span>Security</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Security</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-security.html">Security</a></li>
					...
					<!-- Page Content Start -->
					<div class="row">
						<!-- Recent Devices Start -->
						<div class="col-12">
							<div class="card shadow-card p6 mb6">
								<h6 class="mb4">Recent Devices</h6>
									...
									<table class="table qd-table m0 align-middle">
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center justify-content-start">
														<i class="fa fa-chrome text-heading me2" aria-hidden="true"></i>
														<strong class="text-heading">Google Chrome</strong>
													</div>
												</td>
												<td>
													<span>Gateway Notebook 11.6</span>
												</td>
												<td>
												...
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">OK</span>
												</td>
												<td>
													<strong class="text-heading">156.68.147.21</strong>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center justify-content-start">
														<i class="fa fa-safari text-heading me2" aria-hidden="true"></i>
														<strong class="text-heading">Safari</strong>
													</div>
												</td>
												<td>
													<span>Dell XPS Touchmate</span>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">210.91.120.57</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center justify-content-start">
														<i class="fa fa-firefox text-heading me2" aria-hidden="true"></i>
														<strong class="text-heading">Mozilla Firefox</strong>
													</div>
												</td>
												<td>
													<span>Huawei MateTab Pro</span>
												</td>
												<td>
												...
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">ERROR</span>
												</td>
												<td>
													<strong class="text-heading">183.64.98.5</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center justify-content-start">
														<i class="fa fa-opera text-heading me2" aria-hidden="true"></i>
														<strong class="text-heading">Opera</strong>
													</div>
												</td>
												<td>
													<span>Google Pixelbook Pulse</span>
												</td>
												<td>
												...
												<td>
													<span class="badge rounded-pill badge-soft text-bg-warning">WARNING</span>
												</td>
												<td>
													<strong class="text-heading">22.143.155.11</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center justify-content-start">
														<i class="fa fa-edge text-heading me2" aria-hidden="true"></i>
														<strong class="text-heading">Microsoft Edge</strong>
													</div>
												</td>
												<td>
													<span>Lenovo ThinkPad Nova</span>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">197.190.216.226</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<!-- Two-Factor Authentication (2FA) Start -->
						<div class="col-12">
							<div class="card shadow-card p6 mb6">
								<h6 class="mb3">Two-Factor Authentication (2FA)</h6>
								<div class="table-responsive text-nowrap">
									<table class="table qd-table align-middle mb0">
										<tbody>
											<tr>
												<td>
													<div class="d-flex flex-column align-items-start">
														<strong class="text-heading mb1">Biometric Authentication/Security Key</strong>
														<span>Protect your account and withdrawals with a security key such as Yubikey.</span>
													</div>
												</td>
												<td>
													<div class="d-flex flex-row align-items-center justify-content-start">
														<i data-feather="check-circle" stroke-width="2" height="18" class="text-success me1"></i>
														<strong class="text-heading mb1">On</strong>
													</div>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">Manage</button>
												</td>
											</tr>
											<tr>
												<td>
													<div class="d-flex flex-column align-items-start">
														<strong class="text-heading mb1">Email Address Verification</strong>
														<a href="#" class="text-body text-decoration-none hover-primary">barry@domain.com</a>
													</div>
												</td>
												<td>
													<div class="d-flex flex-row align-items-center justify-content-start">
												...
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft me2">Change</button>
													<button type="button" class="btn btn-secondary btn-soft">Remove</button>
												</td>
											</tr>
											<tr>
												<td>
													<div class="d-flex flex-column align-items-start">
														<strong class="text-heading mb1">Google Authenticator (Recommended)</strong>
											...
											<tr>
												<td>
													<div class="d-flex flex-column align-items-start">
														<strong class="text-heading mb1">Phone Number Verification</strong>
														<span>+1-202-555-0116</span>
													</div>
												</td>
												<td>
													<div class="d-flex flex-row align-items-center justify-content-start">
														<i data-feather="x-circle" stroke-width="2" height="18" class="text-danger me1"></i>
														<strong class="text-heading mb1">Not linked</strong>
													</div>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">Verify</button>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<!-- Two-Factor Authentication (2FA) End -->
					</div>
					<!-- Page Content End -->
				</div>
			</div>
