...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-website-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:43:56 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="dashboards-website-analytics.html"><span>Website Analytics</span></a></li>
				...
				<div class="container-fluid p0">
							...
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<h6 class="mb0 d-inline me3">Organic Sessions</h6>
											<span class="badge badge-soft text-bg-success">+12.2%</span>
										</div>
										<div class="dropdown">
								...
								<div class="row align-items-end">
									<div class="col-7">
										<h3 class="text-heading mb1">42.543</h3>
										<small>Organic Sessions</small>
									</div>
									<div class="col-5">
										<div class="position-relative">
											<div class="position-absolute bg-primary-subtle w-100 height-50 bottom-0 rounded z-1 opacity-50"></div>
											<div class="height-100 position-relative z-2">
												<canvas class="chart17"></canvas>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<h6 class="mb0 d-inline me3">External Links</h6>
											<span class="badge badge-soft text-bg-danger">-3.7%</span>
										</div>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
								...
								<div class="row align-items-end">
									<div class="col-7">
										<h3 class="text-heading mb1">3.519</h3>
										<small>External Links</small>
									</div>
									<div class="col-5">
										<div class="position-relative">
											<div class="position-absolute bg-info-subtle w-100 height-50 bottom-0 rounded z-1 opacity-50"></div>
											<div class="height-100 position-relative z-2">
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<div class="d-flex align-items-center">
											<h6 class="mb0 d-inline me3">Social Networks</h6>
											<span class="badge badge-soft text-bg-success">+4.7%</span>
										</div>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
								...
								<div class="row align-items-end">
									<div class="col-7">
										<h3 class="text-heading mb1">12.873</h3>
					...
					<div class="row">
						...
						<div class="col-xxl-9 mb5">
							<div class="card shadow-card p6 pb5">
								<div class="row mb4 align-items-center">
									<div class="col">
										<h6 class="mb0">Visitor</h6>
									</div>
									<div class="col d-flex flex-row justify-content-end">
										<div class="dropdown">
											<button type="button" class="bg-transparent p0 outline-none dropdown-toggle arrow-none border height-30 rounded ps3" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div class="row">
									<div class="col-12">
										<div id="chart20" class="chart20"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-3 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline me3">Top Browsers</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
								...
								<div class="row">
									<!-- Chrome Start -->
									<div class="col-12">
										<div class="border border-dashed rounded mb1 p4">
											<div class="d-flex flex-row align-items-center justify-content-between">
												<div class="d-flex align-items-center">
													<img src="assets/media/logos/chrome.svg" width="40" alt="">
													<div class="d-flex flex-column align-items-start ms2">
														<span>Google Chrome</span>
														<strong class="text-heading">12.467</strong>
													</div>
												</div>
												<div class="display-6 text-body">1</div>
											</div>
										</div>
									</div>
									<!-- Chrome End -->
									...
									<div class="col-12">
										<div class="border border-dashed rounded mb1 p4">
											<div class="d-flex flex-row align-items-center justify-content-between">
												<div class="d-flex align-items-center">
													<img src="assets/media/logos/firefox.svg" width="40" alt="">
													<div class="d-flex flex-column align-items-start ms2">
														<span>Mozilla Firefox</span>
														<strong class="text-heading">8.283</strong>
													</div>
												</div>
												<div class="display-6 text-body">2</div>
											</div>
										</div>
									</div>
									<!-- Firefox End -->
									...
									<div class="col-12">
										<div class="border border-dashed rounded mb1 p4">
											<div class="d-flex flex-row align-items-center justify-content-between">
												<div class="d-flex align-items-center">
													<img src="assets/media/logos/opera.svg" width="40" alt="">
													<div class="d-flex flex-column align-items-start ms2">
														<span>Opera</span>
														<strong class="text-heading">5.937</strong>
													</div>
												</div>
												<div class="display-6 text-body">3</div>
											</div>
										</div>
									</div>
									<!-- Opera End -->
									...
									<div class="col-12">
										<div class="border border-dashed rounded mb1 p4">
											<div class="d-flex flex-row align-items-center justify-content-between">
												<div class="d-flex align-items-center">
													<img src="assets/media/logos/safari.svg" width="40" alt="">
													<div class="d-flex flex-column align-items-start ms2">
														<span>Safari</span>
														<strong class="text-heading">3.196</strong>
													</div>
												</div>
												<div class="display-6 text-body">4</div>
											</div>
										</div>
									</div>
									<!-- Safari End -->
					...
					<div class="row mb5">
						<div class="col-12">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline me3">Top Location</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
								...
								<div class="row align-items-center">
									...
									<div class="col-xxl-4">
										<!-- Flag Start -->
										<div class="d-flex justify-content-start align-items-center border-bottom-dashed pb4 mb4">
											<div class="width-40 me3">
												<img src="assets/media/flags/us.svg" width="40">
											</div>
											<div class="d-flex flex-column align-items-start flex-grow-1">
												<div class="d-flex flex-row justify-content-between w-100 mb2">
													<strong class="text-heading">United States</strong>
													<span>32%</span>
												</div>
												<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="32" aria-valuemin="0" aria-valuemax="100">
										...
										<div class="d-flex justify-content-start align-items-center border-bottom-dashed pb4 mb4">
											<div class="width-40 me3">
												<img src="assets/media/flags/de.svg" width="40">
											</div>
											<div class="d-flex flex-column align-items-start flex-grow-1">
												<div class="d-flex flex-row justify-content-between w-100 mb2">
													<strong class="text-heading">Germany</strong>
													<span>22%</span>
												</div>
												<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100">
										...
										<div class="d-flex justify-content-start align-items-center border-bottom-dashed pb4 mb4">
											<div class="width-40 me3">
												<img src="assets/media/flags/in.svg" width="40">
											</div>
											<div class="d-flex flex-column align-items-start flex-grow-1">
												<div class="d-flex flex-row justify-content-between w-100 mb2">
													<strong class="text-heading">India</strong>
													<span>18%</span>
												</div>
												<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100">
										...
										<div class="d-flex justify-content-start align-items-center border-bottom-dashed pb4 mb4">
											<div class="width-40 me3">
												<img src="assets/media/flags/ca.svg" width="40">
											</div>
											<div class="d-flex flex-column align-items-start flex-grow-1">
												<div class="d-flex flex-row justify-content-between w-100 mb2">
													<strong class="text-heading">Canada</strong>
													<span>15%</span>
												</div>
												<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
										...
										<!-- Flag Start -->
										<div class="d-flex justify-content-start align-items-center border-bottom-dashed pb4">
											<div class="width-40 me3">
												<img src="assets/media/flags/fr.svg" width="40">
											</div>
											<div class="d-flex flex-column align-items-start flex-grow-1">
												<div class="d-flex flex-row justify-content-between w-100 mb2">
													<strong class="text-heading">France</strong>
													<span>8%</span>
												</div>
												<div class="progress w-100 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="8" aria-valuemin="0" aria-valuemax="100">
					...
					<!-- Bottom Row Start -->
					<div class="row">
						<!-- Session by Device Start -->
						<div class="col-xxl-6 mb5">
							<div class="card shadow-card overflow-hidden">
								<div class="row">
									<div class="col-md-7 p6">
										<div class="row align-items-center mb5">
											<div class="col d-flex flex-row justify-content-between align-items-center">
												<h6 class="mb0 d-inline me3">Session by Device</h6>
											</div>
										</div>
										<div class="row">
											<div class="col-12">
												<div class="d-flex">
													<div class="height-220 bg-primary rounded d-flex align-items-center justify-content-center me2" data-qd-width="60">
														<h6 class="text-white mb0">60%</h6>
													</div>
													<div class="height-220 bg-info rounded d-flex align-items-center justify-content-center me2" data-qd-width="25">
														<h6 class="text-white mb0">25%</h6>
													</div>
													<div class="height-220 bg-success rounded d-flex align-items-center justify-content-center" data-qd-width="15">
														<h6 class="text-white mb0">15%</h6>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-5">
										<div class="bg-light p6 h-100 d-flex flex-column justify-content-between">
											<div class="row align-items-center mb5">
											...
											<div class="row">
												<div class="col-12">
													<div class="d-flex align-items-center justify-content-between border-bottom-dashed pb4 mb4">
														<div class="d-flex align-items-center">
															<div class="width-40 height-40 bg-primary rounded-circle d-flex align-items-center justify-content-center me3">
																<i data-feather="monitor" stroke-width="2" height="22" class="text-white"></i>
															</div>
															<span>Desktop</span>
														</div>
														<strong class="text-heading">12.675</strong>
													</div>
													<div class="d-flex align-items-center justify-content-between border-bottom-dashed pb4 mb4">
														<div class="d-flex align-items-center">
															<div class="width-40 height-40 bg-info rounded-circle d-flex align-items-center justify-content-center me3">
																<i data-feather="smartphone" stroke-width="2" height="22" class="text-white"></i>
															</div>
															<span>Mobile</span>
														</div>
														<strong class="text-heading">8.389</strong>
													</div>
													<div class="d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<div class="width-40 height-40 bg-success rounded-circle d-flex align-items-center justify-content-center me3">
																<i data-feather="tablet" stroke-width="2" height="22" class="text-white"></i>
															</div>
															<span>Tablet</span>
														</div>
														<strong class="text-heading">4.268</strong>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-12">
										<div class="table-responsive text-nowrap">
											<table class="table qd-table mb3 align-middle">
												<tbody>
													<tr>
														<td>1</td>
														<td><a class="hover-primary" href="#">www.yoursite.com/blog/category/development-tools</a></td>
														<td>12.743</td>
														<td>
															<div class="progress width-70 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="32" aria-valuemin="0" aria-valuemax="100">
													...
													<tr>
														<td>2</td>
														<td><a class="hover-primary" href="#">www.yoursite.com/blog/top-react-native-repos</a></td>
														<td>8.548</td>
														<td>
															<div class="progress width-70 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="24" aria-valuemin="0" aria-valuemax="100">
													...
													<tr>
														<td>3</td>
														<td><a class="hover-primary" href="#">www.yoursite.com/blog/vue-vs-react</a></td>
														<td>6.319</td>
														<td>
															<div class="progress width-70 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="48" aria-valuemin="0" aria-valuemax="100">
													...
													<tr>
														<td>4</td>
														<td><a class="hover-primary" href="#">www.yoursite.com/blog/is-jquery-dead</a></td>
														<td>4.769</td>
														<td>
															<div class="progress width-70 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100">
	...
	<script src="assets/js/pages/dashboards/dashboard-04.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-website-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:02 GMT -->
</html>