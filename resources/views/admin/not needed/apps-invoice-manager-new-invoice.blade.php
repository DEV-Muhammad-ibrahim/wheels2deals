...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-invoice-manager-new-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:08 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-invoice-manager-new-invoice.html"><span>New Invoice</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">New Invoice</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-invoice-manager-invoice-list.html">Invoice List</a></li>
							...
							<div class="card shadow-card">
								<div class="p6 border-bottom">
									<div class="row d-flex align-items-center justify-content-between">
										<div class="col-md-6 d-flex flex-column align-items-start justify-content-start mobile-bottom-fix">
											<img src="assets/media/logo/logo-dark.svg" class="height-40 mb4" alt="">
											<span>39 Main St, Scottsville,<br>New York 14546, USA<br>+1 (562) 201-1232</span>
										</div>
										<div class="col-md-6 d-flex flex-column align-items-end justify-content-start text-end">
											<div class="d-flex align-items-center justify-content-end mb2">
												<strong class="text-heading me4">Invoice</strong>
												<input class="form-control width-150" type="text" autocomplete="off" placeholder="#3844">
											</div>
											<div class="d-flex align-items-center justify-content-end mb2">
												<strong class="text-heading me4">Date Issued</strong>
												<input class="form-control width-150 qd-datepicker-single" type="text" autocomplete="off" placeholder="YYYY-MM-DD">
											</div>
											<div class="d-flex align-items-center justify-content-end">
												<strong class="text-heading me4">Due Date</strong>
												<input class="form-control width-150 qd-datepicker-single" type="text" autocomplete="off" placeholder="YYYY-MM-DD">
											</div>
										</div>
									</div>
								...
								<div class="p6 border-bottom">
									<div class="row d-flex align-items-start justify-content-between">
										<div class="col-md-5 d-flex flex-column align-items-start justify-content-start mobile-bottom-fix">
											<h6 class="mb4">Invoice To:</h6>
											<textarea class="form-control" rows="9"></textarea>
										</div>
										<div class="col-md-6 offset-md-1">
											<h6 class="mb4">Bill To:</h6>
											<div class="row align-items-center mb2">
												<div class="col-4">
													<strong class="text-heading">Total Due:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="$3.745,20">
												</div>
											</div>
											<div class="row align-items-center mb2">
												<div class="col-4">
													<strong class="text-heading">Bank Name:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="American Bank">
												</div>
											</div>
											<div class="row align-items-center mb2">
												<div class="col-4">
													<strong class="text-heading">Country:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="United States">
												</div>
											</div>
											<div class="row align-items-center mb2">
												<div class="col-4">
													<strong class="text-heading">IBAN:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="US61C142001109919890N422042">
												</div>
											</div>
											<div class="row align-items-center">
												<div class="col-4">
													<strong class="text-heading">SWIFT Code:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="US91905">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="p6 border-bottom">
									<div class="bg-light p3 rounded text-center mb5">
										<strong class="text-heading">Items</strong>
									</div>
									<div class="border-dashed p4 pb2 rounded mb2">
										<div class="row">
											<div class="col-lg-8 pb2">
												<input class="form-control w-100" type="text" placeholder="Item Name">
											</div>
											<div class="col-lg-2 pb2">
												<input class="form-control w-100" type="text" placeholder="Quantity">
											</div>
											<div class="col-lg-2 pb2">
												<input class="form-control w-100" type="text" placeholder="Price">
											</div>
										</div>
									</div>
									<div class="border-dashed p4 pb2 rounded mb2">
									...
									<div class="border-dashed p4 pb2 rounded">
										<div class="row">
											<div class="col-lg-8 pb2">
												<input class="form-control w-100" type="text" placeholder="Item Name">
											</div>
									...
									<div class="row d-flex align-items-start justify-content-between">
										<div class="col-md-6 mobile-bottom-fix">
											<div class="row align-items-center mb4">
												<div class="col-4">
													<strong class="text-heading">Salesperson:</strong>
												</div>
												<div class="col-8">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="Niles Peppertrout">
												</div>
											</div>
											<div class="row">
												<div class="col-12">
													<input class="form-control w-100" type="text" autocomplete="off" placeholder="Thanks for your business">
												</div>
											</div>
										</div>
										<div class="col-md-3 offset-md-3">
											<div class="row mb2">
												...
												<div class="col">
													<strong class="text-heading">$130,50</strong>
												</div>
											</div>
											<div class="row mb2">
												<div class="col text-end">
												...
												<div class="col">
													<strong class="text-heading">$0,00</strong>
												</div>
											</div>
											<div class="row mb2">
												<div class="col text-end">
												...
												<div class="col">
													<strong class="text-heading">$20,00</strong>
												</div>
											</div>
											<div class="row">
												<div class="col text-end">
												...
												<div class="col">
													<strong class="text-heading">$150,50</strong>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="p6">
									...
									<textarea class="form-control" id="add-form-4" rows="6"></textarea>
								</div>
							</div>
						</div>
						<!-- Invoice End -->
								...
								<div class="row">
									...
									<div class="col-12 mb6">
										<div class="card shadow-card p6">
											<button type="button" class="btn btn-primary mb2">Send Invoice</button>
											<button type="button" class="btn btn-secondary btn-soft mb2">Preview</button>
											<button type="button" class="btn btn-secondary btn-soft">Save</button>
										</div>
									</div>
									<!-- Buttons End -->
											...
											<div class="row">
												...
												<div class="col-12 mb5">
													<label for="add-form-2" class="form-label">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a currenct from the list."></i>
													</label>
												...
												<div class="col-12 mb5">
													<label for="add-form-3" class="form-label">
														<span>Accept Payment Via</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a payment method."></i>
													</label>
													<select id="add-form-3" class="form-select js-choice">
