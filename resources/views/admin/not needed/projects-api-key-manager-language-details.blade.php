...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-api-key-manager-language-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:11 GMT -->
<head>
	<meta charset="UTF-8">
	...
	<!-- highlight.js Theme -->
	<link href="assets/js/highlight/styles/github-dark.min.css" rel="stylesheet" type="text/css"/>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-api-key-manager-language-details.html"><span>Language Details</span></a></li>
						</ul>
					</li>
				</ul>
				<!-- ***** Projects Menu End ***** -->
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">JavaScript</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="projects-api-key-manager-languages.html">Languages</a></li>
									<li class="breadcrumb-item active" aria-current="page">Language Details</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="card shadow-card p6">
								<div class="row align-items-center">
									<div class="col-md-2 mobile-bottom-fix">
										<img src="assets/media/logos/javascript.svg" class="w-100">
									</div>
									<div class="col-md-10">
										<h6 class="mb2">API for JavaScript</h6>
										<p class="mb5">Quisque sed suscipit leo. Donec in nibh sit amet nulla pellentesque consequat. Nulla facilisi. Nulla finibus, ex nec auctor posuere, neque ex maximus quam, vitae vehicula neque enim eu orci.</p>
										<div class="d-flex align-items-center mb5">
											<a href="#" class="btn btn-primary me4">Download SDK</a>
											<a href="#" class="btn btn-secondary me4">Documentation</a>
											<a href="#" class="text-decoration-none text-heading">
												<i class="me1 text-heading" data-feather="github" width="20"></i>
										...
										<div class="d-flex">
											...
											<span>4.2 Total 4.836 review</span>
										</div>
									</div>
								</div>
							</div>
...
const unfold = (f, seed) => {
  ...
  return go(f, seed, [])
					...
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6">
								<h6 class="mb4">Requirements</h6>
								<ul class="mb6">
									<li>Quisque sed suscipit leo. Donec in nibh sit amet nulla pellentesque consequat.</li>
									<li>Mauris lorem sem, sodales sit amet pharetra sed.</li>
									<li>Donec id facilisis nisi. Maecenas massa magna, maximus nec pharetra.</li>
									<li>Vestibulum ac urna id lorem ultrices pretium nec.</li>
								</ul>

								<h6 class="mb4">Installation</h6>
								<p>Etiam viverra turpis magna, non fringilla purus efficitur interdum. Sed et diam non libero dapibus pellentesque vel nec velit. Ut vulputate tortor vitae dui dictum varius. Duis eget felis vitae metus mollis sollicitudin. Nam a gravida arcu. Proin a pulvinar est.</p>
								<div class="rounded bg-light p4 mb4">
									<code>$ yarn add redux react-redux redux-starter-kit</code>
								</div>
								<p>Mauris lorem sem, sodales sit amet pharetra sed, hendrerit ut lorem. Fusce risus lectus, pulvinar id efficitur vel, molestie quis magna. Etiam tempor a tortor ac volutpat.</p>
								<p>Integer laoreet lorem nisl, vitae sodales lectus lacinia ac. Nullam a ex sed enim rutrum malesuada aliquam eu nibh. Mauris ac nunc ante. Cras sit amet ligula urna. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Fusce maximus consectetur mi, et viverra turpis elementum at.</p>
							</div>
						</div>
					</div>
					<!-- Text End -->
	...
	<!-- highlight.js Javascript Language Include -->
	<script src="assets/js/highlight/languages/javascript.min.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-api-key-manager-language-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:12 GMT -->
</html>