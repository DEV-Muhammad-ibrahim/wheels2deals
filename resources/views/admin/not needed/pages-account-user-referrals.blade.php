...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-referrals.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-referrals.html"><span>Referrals</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Referrals</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-referrals.html">Referrals</a></li>
					...
					<!-- Mini Cards & Links Content Start -->
					<div class="row">
						<!-- Mini Cards Start -->
						<div class="col-xxl-6">
							<div class="row">
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p2">
										<div class="row align-items-center justify-content-center p5">
											<strong class="text-center">Your Earnings</strong>
										</div>
										<div class="row">
											<div class="col-12">
												<div class="position-relative">
													<div class="z-2 position-relative p4 d-flex flex-row align-items-center justify-content-between">
														<h3 class="mb0">$127,589</h3>
														<span class="badge rounded-pill text-bg-success">+ 16,70%</span>
													</div>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p2">
										<div class="row align-items-center justify-content-center p5">
											<strong class="text-center">Your Profit</strong>
										</div>
										<div class="row">
											<div class="col-12">
												<div class="position-relative">
													<div class="z-2 position-relative p4 d-flex flex-row align-items-center justify-content-between">
														<h3 class="mb0">$67,325</h3>
														<span class="badge rounded-pill text-bg-danger">- 1,23%</span>
													</div>
													<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
												</div>
											</div>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p2">
										<div class="row align-items-center justify-content-center p5">
											<strong class="text-center">Average Value</strong>
										</div>
										<div class="row">
											<div class="col-12">
												<div class="position-relative">
													<div class="z-2 position-relative p4 d-flex flex-row align-items-center justify-content-between">
														<h3 class="mb0">$69.00</h3>
														<span class="badge rounded-pill text-bg-success">+ 3,28%</span>
													</div>
													<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
												</div>
											</div>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p2">
										<div class="row align-items-center justify-content-center p5">
											<strong class="text-center">Refund Rate</strong>
										</div>
										<div class="row">
											<div class="col-12">
												<div class="position-relative">
													<div class="z-2 position-relative p4 d-flex flex-row align-items-center justify-content-between">
														<h3 class="mb0">5,70%</h3>
														<span class="badge rounded-pill text-bg-success">+ 1,42%</span>
													</div>
													<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
												</div>
											</div>
						...
						<div class="col-xxl-6 mb6">
							<div class="card shadow-card p6">
								<h6 class="mb1">Invite Your Friends</h6>
								<p class="mb5">Add your friends email address and sent them invitations to join!</p>
								<div class="pb5 border-bottom-dashed mb5">
									<div class="row align-items-center">
										<div class="col-8 col-sm-9">
											<input class="form-control" type="text" autocomplete="off" placeholder="Email Address">
										</div>
										<div class="col-4 col-sm-3">
											<div class="btn btn-primary btn-sm btn-soft w-100">Send</div>
										</div>
									</div>
								</div>
								
								<h6 class="mb1">Share The Referral Link</h6>
								<p class="mb4">You can also share your referral link by copying and sending it to your friends or sharing it on social media.</p>
								<div class="row align-items-center">
									<div class="col-8 col-sm-9">
										<input class="form-control" id="link" type="text" autocomplete="off" value="examplesite.com/ref=271648">
									</div>
									<div class="col-4 col-sm-3">
										<div class="btn btn-primary btn-sm btn-soft w-100" id="copy-link">Copy Link</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="alert alert-primary mb0" role="alert">
								<div class="row align-items-center">
									<div class="col-lg-7 mobile-bottom-fix">
										<h4 class="text-primary mb4">You can now request payment.</h4>
										<p class="text-primary m0">You have passed the $100 payment threshold. If you wish, you can withdraw your entire balance to your bank account or PayPal account.</p>
									</div>
									<div class="col-lg-5 text-end">
										<button class="btn btn-primary">Withdraw Money</button>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- Referred Users Start -->
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6">
								<h6 class="mb4">Referred Users</h6>
								<div class="table-responsive text-nowrap mb6">
									<table class="table qd-table align-middle mb0">
										...
										<tbody>
											<tr>
												<td>
													<strong class="text-heading">#4827</strong>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">35%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$478.69</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4826</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">09 Apr, 2023</strong>
												...
												<td>
													<span>Jennifer Brown</span>
												</td>
												<td>
													<strong class="text-heading">22%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$792.15</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4825</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">09 Apr, 2023</strong>
												...
												<td>
													<strong class="text-heading">87%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$663.24</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4824</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
												...
												<td>
													<span>Amanda Davis</span>
												</td>
												<td>
													<strong class="text-heading">61%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$218.91</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4823</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">08 Apr, 2023</strong>
												...
												<td>
													<span>Kevin Wilson</span>
												</td>
												<td>
													<strong class="text-heading">74%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$926.57</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4822</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
												...
												<td>
													<strong class="text-heading">46%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$365.82</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4821</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
												...
												<td>
													<strong class="text-heading">17%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$581.46</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4820</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">06 Apr, 2023</strong>
												...
												<td>
													<span>Emily Green</span>
												</td>
												<td>
													<strong class="text-heading">91%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$314.25</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4819</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">06 Apr, 2023</strong>
												...
												<td>
													<span>Patrick Jones</span>
												</td>
												<td>
													<strong class="text-heading">27%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$542.36</strong>
												</td>
											</tr>
											<tr>
												<td>
													<strong class="text-heading">#4818</strong>
												</td>
												<td>
													<div class="d-flex flex-column justify-content-start">
												...
												<td>
													<span>Jessica Robinson</span>
												</td>
												<td>
													<strong class="text-heading">68%</strong>
												</td>
												<td class="text-end">
													<strong class="text-success">$879.72</strong>
												</td>
											</tr>
										</tbody>
									</table>
	...
	<script src="assets/js/pages/pages/account-user/referrals.js" crossorigin="anonymous"></script>
</body>
