...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:54 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Pricing</h1>
					...
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6 pb0">
								<div class="row mb6">
								...
								<div class="row">
									...
									<div class="col-xxl-4 mb6">
										<div class="border-dashed rounded p6 text-center">
											<h6 class="text-primary mb5">BASIC PLAN</h6>
											<div class="display-3 mb5">$19</div>
											<p class="mb6">Curabitur interdum nulla vel ligula ultrices ultricies. Fusce condi mentum dui vitae tempor.</p>
											<div class="border-bottom-dashed mb6"></div>
											<ul class="list-unstyled text-center mb6">
												<li class="mb4"><span class="text-heading">Unlimited Website</span></li>
												<li class="mb4"><span class="text-heading">Unlimited Users</span></li>
												<li class="mb4"><span class="text-heading">5 GB Bandwidth</span></li>
												<li class="mb4"><span class="text-heading">Highest Speed</span></li>
												<li class="mb4"><span class="text-heading opacity-30">Data Security and Backupss</span></li>
												<li class="mb4"><span class="text-heading opacity-30">1 GB Storage</span></li>
												<li class="mb4"><span class="text-heading opacity-30">24x7 Great Support</span></li>
												<li><span class="text-heading opacity-30">Monthly Reports and Analytics</span></li>
											</ul>
									...
									<div class="col-xxl-4 mb6">
										<div class="border-dashed rounded p6 text-center">
											<h6 class="text-success mb5">ADVANCED PLAN</h6>
											<div class="display-3 mb5">$29</div>
											<p class="mb6">Curabitur interdum nulla vel ligula ultrices ultricies. Fusce condi mentum dui vitae tempor.</p>
											<div class="border-bottom-dashed mb6"></div>
											<ul class="list-unstyled text-center mb6">
												<li class="mb4"><span class="text-heading">Unlimited Website</span></li>
												<li class="mb4"><span class="text-heading">Unlimited Users</span></li>
												<li class="mb4"><span class="text-heading">15 GB Bandwidth</span></li>
												<li class="mb4"><span class="text-heading">Highest Speed</span></li>
												<li class="mb4"><span class="text-heading">Data Security and Backupss</span></li>
												<li class="mb4"><span class="text-heading">1 GB Storage</span></li>
												<li class="mb4"><span class="text-heading opacity-30">24x7 Great Support</span></li>
												<li><span class="text-heading opacity-30">Monthly Reports and Analytics</span></li>
											</ul>
									...
									<div class="col-xxl-4 mb6">
										<div class="border-dashed rounded p6 text-center">
											<h6 class="text-primary mb5">EXPERT PLAN</h6>
											<div class="display-3 mb5">$39</div>
											<p class="mb6">Curabitur interdum nulla vel ligula ultrices ultricies. Fusce condi mentum dui vitae tempor.</p>
											<div class="border-bottom-dashed mb6"></div>
											<ul class="list-unstyled text-center mb6">
												<li class="mb4"><span class="text-heading">Unlimited Website</span></li>
												<li class="mb4"><span class="text-heading">Unlimited Users</span></li>
												<li class="mb4"><span class="text-heading">25 GB Bandwidth</span></li>
												<li class="mb4"><span class="text-heading">Highest Speed</span></li>
												<li class="mb4"><span class="text-heading">Data Security and Backupss</span></li>
												<li class="mb4"><span class="text-heading">5 GB Storage</span></li>
												<li class="mb4"><span class="text-heading">24x7 Great Support</span></li>
												<li><span class="text-heading">Monthly Reports and Analytics</span></li>
											</ul>
											<button class="btn btn-primary">Select Plan</button>
										</div>
									</div>
