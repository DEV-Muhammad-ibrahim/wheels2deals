...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-inbox-view-reply.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:14 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-inbox-view-reply.html"><span>View & Reply</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12">
							<h1 class="page-title mb2">View & Reply</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-inbox-mailbox.html">Inbox</a></li>
					...
					<div class="row">
						...
						<div class="col-xxl-3 mb6">
							<div class="card shadow-card p6">
								...
								<div class="progress w-100 height-10 mb2" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
						...
						<div class="col-xxl-9 mb6">
							<div class="mail-tree mb6">
								<div class="accordion">
									<div class="accordion-item mb4 p2">
										<h2 class="accordion-header">
											<button class="accordion-button d-block" type="button" data-bs-toggle="collapse" data-bs-target="#post-1" aria-expanded="true" aria-controls="post-1">
												<div class="row align-items-center">
													<div class="col-sm-6 d-flex align-items-center justify-content-start mobile-bottom-fix">
														<div class="width-60 height-60 rounded-circle img-fix me3">
															<img src="assets/media/avatars/3.jpg" alt="">
														</div>
														<div class="d-flex flex-column align-items-start justify-content-start">
															<strong class="text-heading mb1">Niles Peppertrout</strong>
															<a href="#" class="text-body hover-primary text-decoration-none">niles@example.com</a>
														</div>
													</div>
													<div class="col-sm-6 text-end">
														<small class="me3">09 Apr 2023, 20:32PM</small>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add star">
															<i class="text-body" data-feather="star" width="14"></i>
														</a>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add bookmark">
															<i class="text-body" data-feather="bookmark" width="14"></i>
														</a>
														<a href="#" type="button" class="btn btn-secondary btn-soft" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
															<i class="text-body" data-feather="edit-3" width="14"></i>
														</a>
													</div>
												</div>
											</button>
										</h2>
										<div id="post-1" class="accordion-collapse collapse show">
											<div class="accordion-body">
												<div class="d-flex align-items-center justify-content-start mb6">
													<h6 class="m0 me4">Payment completed successfully, welcome to Qoduby</h6>
													<span class="badge rounded badge-soft text-bg-primary">Inbox</span>
												</div>
												<p>Welcome, Thomas</p>
												<p>Quisque quis viverra metus. Duis ultricies scelerisque elementum. Suspendisse accumsan consequat leo, eu feugiat neque laoreet ac. Aenean dignissim sodales sapien, a finibus nisi tincidunt eget. Proin ac mollis mauris.</p>
												<p>Aliquam dictum ultricies quam, in vulputate ipsum ornare at. Maecenas semper dolor sed metus sodales, sit amet sagittis quam luctus. Nullam sit amet lectus lobortis, scelerisque orci sed, auctor est. Donec malesuada purus dolor, sed tempor metus dignissim dignissim. Vestibulum vitae porta mauris. Vestibulum rhoncus tortor sit amet sem mollis facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
												<p>Best regards,</p>
												<p>Niles Peppertrout</p>
											</div>
										</div>
									</div>
									...
									<div class="accordion-item mb4 p2">
										<h2 class="accordion-header">
											<button class="accordion-button d-block collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#post-2" aria-expanded="false" aria-controls="post-2">
												<div class="row align-items-center">
													<div class="col-sm-6 d-flex align-items-center justify-content-start mobile-bottom-fix">
														<div class="width-60 height-60 rounded-circle img-fix me3">
														...
														<div class="d-flex flex-column align-items-start justify-content-start">
															...
															<a href="#" class="text-body hover-primary text-decoration-none">thomas@example.com</a>
														</div>
													</div>
													<div class="col-sm-6 text-end">
														<small class="me3">Yesterday</small>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add star">
															<i class="text-body" data-feather="star" width="14"></i>
														</a>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add bookmark">
										...
										<div id="post-2" class="accordion-collapse collapse">
											<div class="accordion-body">
												<div class="d-flex align-items-center justify-content-start mb6">
													<h6 class="m0 me4">Payment completed successfully, welcome to Qoduby</h6>
													<span class="badge rounded badge-soft text-bg-primary">Inbox</span>
									...
									<div class="accordion-item mb4 p2">
										<h2 class="accordion-header">
											<button class="accordion-button d-block collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#post-3" aria-expanded="false" aria-controls="post-3">
												<div class="row align-items-center">
													<div class="col-sm-6 d-flex align-items-center justify-content-start mobile-bottom-fix">
														<div class="width-60 height-60 rounded-circle me3 d-flex align-items-center justify-content-center bg-info-subtle">
															<h6 class="m0 text-info">WR</h6>
														</div>
														<div class="d-flex flex-column align-items-start justify-content-start">
															<strong class="text-heading mb1">Wisteria Ravenclaw</strong>
															<a href="#" class="text-body hover-primary text-decoration-none">wisteria@example.com</a>
														</div>
													</div>
													<div class="col-sm-6 text-end">
														<small class="me3">07 Apr 2023, 20:32PM</small>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add star">
															<i class="text-body" data-feather="star" width="14"></i>
														</a>
														<a href="#" type="button" class="btn btn-secondary btn-soft me2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add bookmark">
										...
										<div id="post-3" class="accordion-collapse collapse">
											<div class="accordion-body">
												<div class="d-flex align-items-center justify-content-start mb6">
													<h6 class="m0 me4">Payment completed successfully, welcome to Qoduby</h6>
													<span class="badge rounded badge-soft text-bg-primary">Inbox</span>
							...
							<div class="card shadow-card p6">
								<h6 class="mb5">Compose Message</h6>
								<div class="border rounded-3 mb6">
									<div class="border-bottom p4 pb3">
										<div class="row align-items-center">
											<div class="col-8 d-flex flex-row justify-content-start align-items-center">
												<strong class="text-heading">To:</strong>
												<input type="text" class="form-control border-0" tabindex="1">
											</div>
											<div class="col-4 text-end">
												<a href="#" class="text-body text-decoration-none hover-primary me2">Cc</a>
												<a href="#" class="text-body text-decoration-none hover-primary">Bcc</a>
											</div>
										</div>
									</div>
									<div class="border-bottom p4 pb3">
										<div class="row align-items-center">
											<div class="col-12 d-flex flex-row justify-content-start align-items-center">
												...
												<input type="text" class="form-control border-0" tabindex="2">
											</div>
										</div>
									</div>
									<div class="border-0">
										<div class="row align-items-center">
											<div class="col-12">
												<div class="mail-editor height-400">
								...
								<div class="row">
									<div class="col-6">
										<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add Attachment">
											<i class="text-body" data-feather="paperclip" width="18"></i>
										</button>
										<button type="button" class="btn btn-secondary btn-soft" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add Location">
											<i class="text-body" data-feather="map-pin" width="18"></i>
										</button>
									</div>
									<div class="col-6 text-end">
										<button type="button" class="btn btn-primary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive">
											<i class="text-primary" data-feather="archive" width="18"></i>
										</button>
										<button type="button" class="btn btn-primary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
											<i class="text-primary" data-feather="trash-2" width="18"></i>
										</button>
	...
	<script src="assets/js/pages/apps/inbox/compose.js" crossorigin="anonymous"></script>
</body>
