...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-add-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:47 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-add-project.html"><span>Add Project</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12 mobile-bottom-fix">
							<h1 class="page-title mb2">Add Project</h1>
										...
										<div class="card shadow-card p6">
											<div class="row">
												...
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-3" class="form-control qd-datepicker-single" type="text" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-4" class="form-control qd-datepicker-single" type="text" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-lg-6 mb5">
								...
								<div class="row">
									...
									<div class="col-12 mb6">
										<div class="card shadow-card p6">
											...
											<div class="border-dashed rounded p6 pb3 group-contact height-630 overflow-auto">
	...
	<script src="assets/js/pages/apps/projects/add-project.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-add-project.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:48 GMT -->
</html>