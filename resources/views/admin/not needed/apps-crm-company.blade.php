...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-crm-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:56 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">Add Company</h5>
									...
									<div class="row">
										...
										<div class="col-sm-6 mb5">
											<label for="add-form-2" class="form-label">
												<span>Email</span>
												<span class="text-danger">*</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a email."></i>
											</label>
										...
										<div class="col-sm-6 mb5">
											...
											<input id="add-form-3" class="form-control" type="text" autocomplete="off" required>
											<div class="invalid-feedback">You need to fill this field.</div>
										</div>
										<div class="col-sm-6 mb5">
											<label for="add-form-5" class="form-label">
												<span>Owner</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a owner name."></i>
											</label>
											<input id="add-form-5" class="form-control" type="text" autocomplete="off">
										</div>
										<div class="col-sm-6 mb5">
											<label for="add-form-5" class="form-label">
												<span>Rating</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a rating."></i>
											</label>
											<div id="slider" class="slider-primary"></div>
											<span id="field" class="d-block mt1">5.5</span>
										</div>
										<div class="col-12">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-crm-company.html"><span>Company</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Company</h1>
											...
											<tbody>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/1.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Sage Technologies</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">norman@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Norman Gordon</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">4.2</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/2.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">IntraRailroading</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">fleece@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Fleece Marigold</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/3.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Equipmentee</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">thomas@domain.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Thomas R. Toe</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">8.1</strong>
														</div>
													</td>
													<td>
														<span>Glenwood</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 rounded-circle me4 bg-primary-subtle d-flex justify-content-center align-items-center">
																<h6 class="m0 text-primary">PF</h6>
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Profession Fashion</strong>
													...
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">4.8</strong>
														</div>
													</td>
													<td>
														<span>Wellston</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/4.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Bella Technologies</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">niles@site.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Niles Peppertrout</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">2.4</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/5.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Make Application</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">rodney@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Rodney Artichoke</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">5.3</strong>
														</div>
													</td>
													<td>
														<span>Demarest</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 rounded-circle me4 bg-info-subtle d-flex align-items-center justify-content-center">
																<h6 class="m0 text-info">MA</h6>
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">MonoApplication</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">wisteria@revenclaw.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Wisteria Ravenclaw</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/6.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Click Profession</strong>
													...
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">7.8</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/company/7.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Justice Engineering</strong>
													...
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">2.9</strong>
														</div>
													</td>
													<td>
														<span>Richwood</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 rounded-circle me4 d-flex align-items-center justify-content-center bg-warning-subtle">
																<h6 class="m0 text-warning">R</h6>
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Railroading</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">parsley@yourdomain.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Parsley Montana</span>
													</td>
													<td>
														<div class="d-flex align-items-center justify-content-start">
															<i data-feather="star" stroke-width="2" height="18" class="text-warning" fill="var(--bs-warning)"></i>
															<strong class="text-heading">9.9</strong>
														</div>
													</td>
													<td>
														<span>Crestwood Village</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">06 Apr, 2023</strong>
	...
	<script src="assets/js/pages/apps/crm/company.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-crm-company.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:04 GMT -->
</html>