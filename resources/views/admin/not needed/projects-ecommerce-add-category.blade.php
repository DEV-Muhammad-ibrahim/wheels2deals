...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-add-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:59 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-ecommerce-add-category.html"><span>Add Category</span></a></li>
						...
						<div class="col-md-12 mobile-bottom-fix">
							...
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="projects-ecommerce-categories.html">Categories</a></li>
											...
											<div class="row">
												...
												<div class="col-12 mb5">
													<label for="add-form-6" class="form-label">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a name for the category."></i>
													</label>
													<input id="add-form-6" class="form-control slug-target" type="text" required>
												...
												<div class="col-12 mb5">
													...
													<input id="add-form-7" class="form-control slug-url" type="text">
												</div>
												<div class="col-12 mb5">
													...
													<select id="add-form-8" class="form-select js-choice">
										...
										<div class="card shadow-card p6">
											<div class="row">
												...
												<div class="col-12 mb5">
													...
													<input id="add-form-10" class="form-control" type="text" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-12">
												...
												<div class="col-12">
													...
													<input id="add-form-12" class="form-control tagify" type="text" value="fps game, online">
												</div>
											</div>
										</div>
									</div>
	...
	<script src="assets/js/pages/projects/ecommerce/add-category.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-add-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:45:00 GMT -->
</html>