                ...
                <ul class="menu-group m-0 px-4 mb-4">
                    ...
                    <li class="sub-menu active">
                        ...
                        <ul class="sub-menu-group">
                            ...
                            <li class="active"><a href="projects-ecommerce-add-category.html"><span>Add
                                        Category</span></a></li>
                                        ...
                                        <div class="card shadow-card p6">
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb5">
                                                    ...
                                                    <input id="add-form-7" class="form-control slug-url"
                                                        type="text">
                                                </div>
                                                <div class="col-12 mb5">
                                        ...
                                        <div class="card shadow-card p6">
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb5">
                                                    ...
                                                    <input id="add-form-10" class="form-control" type="text"
                                                        required>
                                                    <div class="invalid-feedback">Please fill out all fields.</div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="add-form-12" class="form-control tagify"
                                            ...
                                            <div class="card shadow-card p6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb5">
                                                        ...
                                                        <select id="add-form-2" class="form-select js-choice"
                                                            required>
