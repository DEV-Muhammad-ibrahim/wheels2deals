...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-files.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:51 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-files.html"><span>Files</span></a></li>
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="apps-projects-files.html">Files</a></li>
									<li><a href="apps-projects-activity.html">Activity</a></li>
							...
							<div class="row">
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
										...
										<span class="badge rounded-pill badge-soft text-bg-success">16.2 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-excel-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">customer-data.xls</strong>
												<span class="text-body">Dianne Ameter</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">8.4 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-powerpoint-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">sales-presentation.ppt</strong>
												<span class="text-body">Dominic L. Ement</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">3.2 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-word-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">design-notes.doc</strong>
												<span class="text-body">Gunther Beard</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">22.7 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-audio-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">meeting-audio-recording.mp3</strong>
												<span class="text-body">Richard Tea</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">135.2 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-video-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">tv-commercial-movie.mov</strong>
												<span class="text-body">Gustav Purpleson</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">165.2 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-code-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">database-dump.json</strong>
												<span class="text-body">Pelican Steve</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">1.8 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-image-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">final-logo.png</strong>
												<span class="text-body">Jake Weary</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">2.7 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-archive-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">server-backup.zip</strong>
												<span class="text-body">Theodore Handle</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">76.7 MB</span>
									</a>
								</div>
								<div class="col-lg-6 mb6">
									<a href="#" class="card shadow-card p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
										<div class="d-flex align-items-center justify-content-start">
											<i class="fa fa-file-text-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">seo-word-list.txt</strong>
												<span class="text-body">Sue Shei</span>
											</div>
										</div>
										<span class="badge rounded-pill badge-soft text-bg-success">1.3 MB</span>
									</a>
								</div>
							</div>
							<!-- Files End -->
									...
									<div class="card shadow-card p6">
										<div class="row align-items-center mb4">
											<div class="col d-flex flex-row justify-content-between align-items-center">
												<h6 class="mb0 d-inline">File Upload</h6>
												<div class="dropdown">
