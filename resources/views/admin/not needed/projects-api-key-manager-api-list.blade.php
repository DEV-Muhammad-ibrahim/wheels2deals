...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-api-key-manager-api-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:07 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">Add API Key</h5>
							...
							<div class="row">
								<div class="col-sm-12 mb1">
									<label for="add-form-1" class="form-label">
										...
										<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Choose a platform to develop applications."></i>
									</label>
								</div>
								<div class="col-sm-4 mb5">
									<div class="custom-check d-flex align-items-center justify-content-center">
										<input type="radio" id="custom-check-1" class="cursor-pointer" name="platform" checked>
										<label for="custom-check-1" class="rounded"></label>
										<div class="checkbox-content p5 text-center">
											<i class="fa fa-apple fa-4x mb6"></i>
											<h6 class="mb2">iOS</h6>
											<span>For iPhone, iPad and Apple TV apps.</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 mb5">
									<div class="custom-check d-flex align-items-center justify-content-center">
										<input type="radio" id="custom-check-1" class="cursor-pointer" name="platform">
										<label for="custom-check-1" class="rounded"></label>
										<div class="checkbox-content p5 text-center">
											<i class="fa fa-android fa-4x mb6"></i>
											<h6 class="mb2">Android</h6>
											<span>For Phone, Tablet and TV Android apps.</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 mb5">
									<div class="custom-check d-flex align-items-center justify-content-center">
										...
										<label for="custom-check-1" class="rounded"></label>
										<div class="checkbox-content p5 text-center">
											<i class="fa fa-desktop fa-4x mb6"></i>
											<h6 class="mb2">Web</h6>
											<span>For React JS, Vue JS and other applications.</span>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12 mb5">
									<label for="add-form-2" class="form-label">
										...
										<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a app name."></i>
									</label>
								...
								<div class="col-sm-12 mb5">
									<label for="add-form-3" class="form-label">
										...
										<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a domain name."></i>
									</label>
									<div class="input-group mb-3">
										<span class="input-group-text" id="add-form-3">https://</span>
								...
								<div class="col-sm-12 mb5">
									...
									<div class="invalid-feedback">Please select a environment.</div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="projects-api-key-manager-api-list.html"><span>API List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">API Key Manager</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">API Key Manager</li>
								</ol>
							</nav>
						</div>
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<button class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addApiModal">Add API Key</button>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->

					<!-- Developer Plan Start -->
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6 align-items-center">
								<div class="bg-primary-subtle p1 pe4 rounded d-flex flex-row align-items-center mb6">
									<div class="rounded width-30 height-30 bg-primary d-flex align-items-center justify-content-center me2">
										<i data-feather="terminal" stroke-width="2" height="16" class="text-white"></i>
									</div>
									<small class="text-primary">Developer Plan</small>
								</div>
								<div class="progress w-100 height-5 mb3" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
									<div class="progress-bar" style="width: 60%"></div>
								</div>
								<strong>You used 168 of 200 of your API</strong>
							</div>
						</div>
					</div>
					<!-- Developer Plan End -->
					...
					<div class="row">
						<!-- Successful Start -->
						<div class="col-xxl-6 mb6">
							<div class="card shadow-card p6">
								<div class="row align-items-center">
									<div class="col-lg-4 mobile-bottom-fix">
										<div class="bg-success-subtle p1 pe4 rounded d-inline-flex flex-row align-items-center">
											<div class="rounded width-30 height-30 bg-success d-flex align-items-center justify-content-center me2">
												<i data-feather="check" stroke-width="2" height="16" class="text-white"></i>
											</div>
											<small class="text-success">Successful</small>
										</div>
									</div>
									<div class="col-lg-5 mobile-bottom-fix">
										<div class="d-flex">
											<i data-feather="trending-up" stroke-width="2" width="22" class="text-success me2"></i>
											<strong class="text-heading me2">+7.2%</strong>
											<strong>+3.7K this week</strong>
										</div>
									</div>
									<div class="col-lg-3 text-end">
										<h4 class="m0">4.827</h4>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-6 mb6">
							<div class="card shadow-card p6">
								<div class="row align-items-center">
									<div class="col-lg-4 mobile-bottom-fix">
										<div class="bg-danger-subtle p1 pe4 rounded d-inline-flex flex-row align-items-center">
											<div class="rounded width-30 height-30 bg-danger d-flex align-items-center justify-content-center me2">
												<i data-feather="x" stroke-width="2" height="16" class="text-white"></i>
											</div>
									...
									<div class="col-lg-5 mobile-bottom-fix">
										<div class="d-flex">
											<i data-feather="trending-down" stroke-width="2" width="22" class="text-danger me2"></i>
											<strong class="text-heading me2">-2.3%</strong>
											<strong>-1.3K this week</strong>
										</div>
									</div>
									<div class="col-lg-3 text-end">
										<h4 class="m0">523</h4>
								...
								<div class="table-responsive text-nowrap">
									<table class="table qd-table mb6 align-middle">
										...
										<tbody>
											<tr>
												<td>
													<strong class="text-heading">Jackson Pot</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="c42032c2-7e67-4e58-a8e5-9aa5e1ba5a87">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Active</span>
												</td>
												<td>
													<strong class="text-heading">09 Apr, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">09 Apr, 2024</strong>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Phillip Anthropy</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="1a84629d-31e2-4b27-abd5-939f9040f2d6">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">07 Apr, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">07 Apr, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Elon Gated</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="caf0c8ec-f812-44e7-87af-4e4171521c51">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-danger">Disable</span>
												</td>
												<td>
													<strong class="text-heading">03 Apr, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">03 Apr, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Max Conversion</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="31f897d5-6d28-49ae-93e7-28bcbde91368">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">02 Apr, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">02 Apr, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Desmond Eagle</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="d51b2217-4a91-4142-9288-cac0981775e6">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Lance Bogrol</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="036ef9ab-cd95-4d78-95f4-613057756ac2">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">30 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">30 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Ravi O'Leigh</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="150f4a26-b04f-4318-8dba-78296c5aa9cd">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="e57d8722-b427-4d32-8be3-e67e40f21190">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">29 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">29 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Miles Tone</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="74a9204f-cd8c-4664-a3d1-fd65236d15c2">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">27 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">27 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Caspian Bellevedere</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="747f4e09-fe1d-4241-a674-3a26ed0c4bd8">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Indigo Violet</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="00f99ea8-dfb5-4e2c-b438-416dfad9298e">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">25 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">25 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Chaplain Mondover</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="c611dae9-8df6-499e-bc6b-ff6888fc1432">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Hugh Saturation</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="6bef5b9c-7cee-4ab4-8777-f17cca95b1b5">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">20 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">20 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Ursula Gurnmeister</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="490001f0-6e44-4385-ae2c-ada85b603263">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												<td>
													<strong class="text-heading">Abraham Pigeon</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="21e2a24b-92cc-4ad0-901c-23fcdc1a196d">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">19 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">19 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Fletch Skinner</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="12f7654d-1222-41c9-a61d-bf2f4ad859bf">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">16 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">16 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Eric Widget</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="94fb09fb-6094-4fc5-84d4-7342c208b840">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="07d635f8-0a12-4dc0-8fe3-b0b39a3e8493">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">15 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">15 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												...
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="25cefdb9-664d-47e9-9e73-2601bab0486b">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">14 Mar, 2023</strong>
												</td>
												<td>
													<strong class="text-heading">14 Mar, 2024</strong>
												</td>
												<td>
													<div class="dropdown text-end">
														<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
											...
											<tr>
												<td>
													<strong class="text-heading">Theodore Handle</strong>
												</td>
												<td>
													<div class="input-group width-360">
														<input type="text" class="form-control" value="a75c9b57-8ac0-4c72-a476-2b0bc558462e">
														<span class="input-group-text cursor-pointer"><i data-feather="copy" stroke-width="2" width="16" class="text-body"></i></span>
													</div>
												</td>
												<td>
	...
	<script src="assets/js/pages/projects/api-key-manager/api-list.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-api-key-manager-api-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:08 GMT -->
</html>