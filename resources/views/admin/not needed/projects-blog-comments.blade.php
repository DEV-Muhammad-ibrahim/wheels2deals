...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-blog-comments.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:00 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-blog-comments.html"><span>Comments</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Comments</h1>
										...
										<div class="row align-items-center">
											...
											<div class="col-md-9 text-end">
												<div id="edit-buttons" class="visibility-hide">
													...
													<button type="button" class="btn btn-outline-success me2">Approve</button>
													<button type="button" class="btn btn-outline-secondary">Spam</button>
												</div>
											</div>
										</div>
									</div>
										...
										<table class="table qd-table mb6 align-middle">
											<thead>
												<tr>
													...
													<th scope="col">WRITER & COMMENT</th>
											...
											<tbody>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Norman Gordon</strong>
																<span class="width-270 text-wrap">Quisque sed suscipit leo. Donec in nibh sit amet nulla pellentesque consequat.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Tips & Tricks on Upgrading Node.js</strong>
													</td>
													<td>
														<strong class="text-heading d-block">09 Apr, 2023</strong>
														<small>11:38PM</small>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Fleece Marigold</strong>
																<span class="width-270 text-wrap">Ut vulputate tortor vitae dui dictum varius. Duis eget felis vitae metus mollis sollicitudin.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">React SDK Release (February 2023)</strong>
													</td>
													<td>
														<strong class="text-heading d-block">09 Apr, 2023</strong>
														<small>10:28PM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Thomas R. Toe</strong>
																<span class="width-270 text-wrap">Proin mollis felis at magna ultrices congue. Integer viverra lectus vitae commodo varius.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Code IDE AI-Assistance</strong>
													</td>
													<td>
														<strong class="text-heading d-block">08 Apr, 2023</strong>
														<small>08:12PM</small>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-info">Archive</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 rounded-circle bg-primary-subtle d-flex align-items-center justify-content-center me4">
																<h6 class="m0 text-primary">BE</h6>
															</div>
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Benjamin Evalent</strong>
																<span class="width-270 text-wrap">Curabitur ut nisi ac lacus dignissim rutrum. Sed venenatis ultrices odio ut dapibus.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">On-device machine learning with IDE</strong>
													</td>
													<td>
														<strong class="text-heading d-block">08 Apr, 2023</strong>
														<small>09:38PM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Niles Peppertrout</strong>
																<span class="width-270 text-wrap">Sed bibendum nisl non nisl posuere, at facilisis nisl luctus. Donec at semper odio.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Is jQuery Dead (I do not think so)</strong>
													</td>
													<td>
														<strong class="text-heading d-block">08 Apr, 2023</strong>
														<small>09:38AM</small>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Spam</span>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Rodney Artichoke</strong>
																<span class="width-270 text-wrap">Vestibulum augue libero, fringilla sed rutrum at, volutpat sed arcu. In hac habitasse platea.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Keyboard Shortcuts to Git Flow</strong>
													</td>
													<td>
														<strong class="text-heading d-block">07 Apr, 2023</strong>
														<small>12:44PM</small>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 bg-info-subtle d-flex align-items-center justify-content-center rounded-circle me4">
																<h6 class="m0 text-info">WR</h6>
															</div>
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Wisteria Ravenclaw</strong>
																<span class="width-270 text-wrap">Maecenas magna nibh, pharetra nec rhoncus in, dictum a metus. Morbi et dictum turpis.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">The Invisible JavaScript Backdoor</strong>
													</td>
													<td>
														<strong class="text-heading d-block">07 Apr, 2023</strong>
														<small>07:17PM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Justin Case</strong>
																<span class="width-270 text-wrap">Aliquam aliquam erat vitae sem congue venenatis. Suspendisse potenti.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">React Native Development Environment</strong>
													</td>
													<td>
														<strong class="text-heading d-block">07 Apr, 2023</strong>
														<small>06:25AM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 d-flex align-items-center justify-content-center bg-success-subtle rounded-circle me4">
																<h6 class="text-success m0">ND</h6>
															</div>
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Nathaneal Down</strong>
																<span class="width-270 text-wrap">Curabitur ut nisi ac lacus dignissim rutrum. Sed venenatis ultrices odio ut dapibus.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">ES2021 Features & Performance</strong>
													</td>
													<td>
														<strong class="text-heading d-block">06 Apr, 2023</strong>
														<small>10:26PM</small>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Spam</span>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 d-flex align-items-center justify-content-center bg-warning-subtle rounded-circle me4">
																<h6 class="text-warning m0">PM</h6>
															</div>
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Parsley Montana</strong>
																<span class="width-270 text-wrap">Etiam viverra turpis magna, non fringilla purus efficitur interdum. Sed et diam non libero.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Drag and Drop With Vue.js</strong>
													</td>
													<td>
														<strong class="text-heading d-block">06 Apr, 2023</strong>
														<small>08:16AM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Indigo Violet</strong>
																<span class="width-270 text-wrap">Maecenas massa magna, maximus nec pharetra non, dictum ut metus. Hac habitasse platea.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Sticky Scroll Now in Preview</strong>
													</td>
													<td>
														<strong class="text-heading d-block">06 Apr, 2023</strong>
														<small>07:22AM</small>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading d-block">Lance Bogrol</strong>
																<span class="width-270 text-wrap">Donec in nibh sit amet nulla pellentesque consequat. Nulla facilisi. Nulla finibus.</span>
															</div>
														</div>
													</td>
													<td>
														<strong class="text-heading">Using RichEdit for Text Processing</strong>
													</td>
													<td>
														<strong class="text-heading d-block">05 Apr, 2023</strong>
														<small>11:30PM</small>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
	...
	<script src="assets/js/pages/projects/blog/blog-list.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-blog-comments.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:07 GMT -->
</html>