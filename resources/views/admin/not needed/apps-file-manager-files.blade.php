...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-file-manager-files.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:09 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-file-manager-files.html"><span>Files</span></a></li>
						...
						<div class="col-xxl-9 mb6">
							...
							<div class="card shadow-card mb6">
								...
								<ul class="horizontal-menu ss-container">
									<li class="active"><a href="apps-file-manager-files.html">Files</a></li>
									<li><a href="apps-file-manager-setting.html">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
										...
										<div class="row align-items-center">
											...
											<div class="col-md-8 text-end">
												<div id="edit-buttons" class="visibility-hide">
													...
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Permissions">
														<i class="text-body" data-feather="alert-circle" width="20"></i>
													</button>
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Rename">
											...
											<tbody>
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/folder.svg" alt="" class="me4">
															<strong class="text-heading">documentation</strong>
														</a>
													</td>
													<td>
														<span>-</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/folder.svg" alt="" class="me4">
															<strong class="text-heading">html</strong>
														</a>
													</td>
													<td>
														<span>-</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/folder.svg" alt="" class="me4">
															<strong class="text-heading">node_modules</strong>
														</a>
													</td>
													<td>
														<span>-</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/folder.svg" alt="" class="me4">
															<strong class="text-heading">scss</strong>
														</a>
													</td>
													<td>
														<span>-</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/html.svg" alt="" class="me4">
															<strong class="text-heading">about-us.html</strong>
														</a>
													</td>
													<td>
														<span>1.2 MB</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/html.svg" alt="" class="me4">
															<strong class="text-heading">contact.html</strong>
														</a>
													</td>
													<td>
														<span>0.8 MB</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/html.svg" alt="" class="me4">
															<strong class="text-heading">index.html</strong>
														</a>
													</td>
													<td>
														<span>1.4 MB</span>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-file-manager-files.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:11 GMT -->
</html>