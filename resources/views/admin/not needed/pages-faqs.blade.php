...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:53 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">FAQ's</h1>
					...
					<div class="row mb7">
						<div class="col-12">
							<div class="bg-primary rounded p7 d-flex align-items-center justify-content-center flex-column">
								<h5 class="text-white mb4 mt6">How can we help?</h5>
								<p class="text-white-50 mb6">You can search for anything you need help with.</p>
								<div class="position-relative w-75 height-50 mb4">
									<input class="form-control h-100" type="text" placeholder="Search...">
									<button class="btn btn-success position-absolute top-0 end-0 height-50 rounded-start-0" role="button">
										<i data-feather="search" stroke-width="1.5" width="24" class="text-white"></i>
									</button>
								</div>
								<div class="d-flex mb6">
									<span class="me4 text-white-50">Popular searches:</span>
									<a href="#" class="text-decoration-none text-white me4">React Native</a>
									<a href="#" class="text-decoration-none text-white me4">Flutter</a>
									<a href="#" class="text-decoration-none text-white me4">Wordpress</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row mb7">
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6 text-center">
								<img src="assets/media/illustration/2.svg" class="height-180 m6" alt="">
								<h6 class="mb4">The New Git Status</h6>
								<p class="mb6">Maecenas lobortis sollicitudin justo, vitae tristique diam vulputate all disse nunc europ.</p>
								<a href="#" class="btn btn-soft btn-primary">Read More</a>
							</div>
						</div>
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6 text-center">
								<img src="assets/media/illustration/3.svg" class="height-180 m6" alt="">
								<h6 class="mb4">Visualize Your Progress</h6>
								<p class="mb6">Purabitur mollis maurisnisina, sed posuere nisi varius quis. Nunci viverra lobortis nulla.</p>
								<a href="#" class="btn btn-soft btn-primary">Read More</a>
							</div>
						</div>
						<div class="col-xxl-4">
							<div class="card shadow-card p6 text-center">
								<img src="assets/media/illustration/4.svg" class="height-180 m6" alt="">
								<h6 class="mb4">Git for Windows & Mac</h6>
								<p class="mb6">Etiam tincidunt vehiculaelit, quis dignis velit eleifend in. Suspen disse quis. lipsum quis.</p>
								<a href="#" class="btn btn-soft btn-primary">Read More</a>
							</div>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row mb6">
								<div class="col-lg-4 offset-lg-4 text-center">
									<h5>Freequently Asked Questions</h5>
									<p class="m0">Fusce placerat pretium mauris, vel sollicitudin elit lacinia vitae. Quisque sit amet nisi erat.</p>
								</div>
							</div>
							<div class="row">
										...
										<div class="accordion" id="accordionFaq">
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-1" aria-expanded="true" aria-controls="faqCollapse-1">
														<h6 class="mb0">How do I get started with your software?</h6>
													</button>
												</div>
												<div id="faqCollapse-1" class="accordion-collapse collapse show" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
												</div>
											</div>
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-2" aria-expanded="true" aria-controls="faqCollapse-2">
														<h6 class="mb0">What are the system requirements for your software?</h6>
													</button>
												</div>
												<div id="faqCollapse-2" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
											...
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-3" aria-expanded="true" aria-controls="faqCollapse-3">
														<h6 class="mb0">Can I try your software before purchasing it?</h6>
													</button>
												</div>
												<div id="faqCollapse-3" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
											...
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-4" aria-expanded="true" aria-controls="faqCollapse-4">
														<h6 class="mb0">How do I update my software to the latest version?</h6>
													</button>
												</div>
												<div id="faqCollapse-4" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
											...
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-5" aria-expanded="true" aria-controls="faqCollapse-5">
														<h6 class="mb0">What kind of support do you offer for your software products?</h6>
													</button>
												</div>
												<div id="faqCollapse-5" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
											...
											<div class="accordion-item">
												<div class="accordion-header">
													<button class="accordion-button p6" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse-6" aria-expanded="true" aria-controls="faqCollapse-6">
														<h6 class="mb0">How can I get support for your software products?</h6>
													</button>
												</div>
												<div id="faqCollapse-6" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
													<div class="accordion-body border-top-dashed">
														<p>Quisque quis dignissim erat, in malesuada lacus. Donec faucibus cursus tincidunt. Vivamus vitae purus orci. Etiam lacinia ipsum velit, a lobortis nisi consectetur eget.</p>
														<p>Curabitur elementum nibh eget interdum consequat. Vestibulum at justo nunc. Vivamus nunc nisl, consectetur ac lacinia non, laoreet eget diam. Nulla erat dolor, congue non fermentum id, ultrices vel nunc. Cras dictum, ante vel ultrices hendrerit, elit lectus semper ante, in sollicitudin velit neque tempor lorem.</p>
													</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:54 GMT -->
</html>