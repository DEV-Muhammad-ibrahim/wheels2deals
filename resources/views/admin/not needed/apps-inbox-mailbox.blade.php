...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-inbox-mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:13 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">Add Label</h5>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-inbox-mailbox.html"><span>Mailbox</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Inbox</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<a href="apps-inbox-compose.html" class="btn btn-primary">Compose</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						...
						<div class="col-xxl-3 mb6">
							<div class="card shadow-card p6">
								<a href="apps-inbox-compose.html" class="btn btn-primary mb6">Compose</a>
									...
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded active-light">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="inbox" width="22"></i>
												<small class="text-heading">Inbox</small>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-primary">3</span>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="send" width="22"></i>
												<small class="text-heading">Sent</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="edit-3" width="22"></i>
												<small class="text-heading">Draft</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="alert-circle" width="22"></i>
												<small class="text-heading">Spam</small>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-danger">1</span>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="trash-2" width="22"></i>
												<small class="text-heading">Trash</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="star" width="22"></i>
												<small class="text-heading">Starred</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="archive" width="22"></i>
												<small class="text-heading">Archive</small>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-success">7</span>
										</a>
									</li>
								</ul>

								<ul class="list-unstyled mb6">
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-primary me3" data-feather="circle" width="14"></i>
												<small class="text-heading">Design Customer</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-info me3" data-feather="circle" width="14"></i>
												<small class="text-heading">Payments</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-success me3" data-feather="circle" width="14"></i>
												<small class="text-heading">Freelance Works</small>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-primary">2</span>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-warning me3" data-feather="circle" width="14"></i>
									...
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-danger me3" data-feather="circle" width="14"></i>
												<small class="text-heading">In Progress</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-secondary me3" data-feather="circle" width="14"></i>
												<small class="text-heading">Coding Works</small>
											</div>
										</a>
									</li>
									<li>
										<a href="#" data-bs-toggle="modal" data-bs-target="#addModal" class="text-decoration-none d-flex align-items-center justify-content-between hover-light p3 rounded">
											<div class="d-flex align-items-center justify-content-start">
												<i class="text-body me3" data-feather="plus" width="20"></i>
												<small class="text-body">Add Label</small>
											</div>
										</a>
									</li>
								</ul>

								<span class="mb2">2.40 GB of 15 GB used</span>
								<div class="progress w-100 height-10 mb3" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
								...
								<div class="border-bottom">
									<div class="p6">
										<div class="row align-items-center">
											<div class="col-md-4 d-flex flex-row align-items-center justify-content-start mobile-bottom-fix">
											...
											<div class="col-md-8 text-end">
												<div id="edit-buttons" class="visibility-hide">
													<span id="selected-items">1</span>
													<span class="me2">Selected</span>
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add Star">
														<i class="text-body" data-feather="star" width="20"></i>
													</button>
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Report Spam">
														<i class="text-body" data-feather="alert-circle" width="20"></i>
													</button>
													<button type="button" class="btn btn-secondary btn-soft me1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive">
														<i class="text-body" data-feather="archive" width="20"></i>
													</button>
													<button type="button" class="btn btn-danger btn-soft" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
														<i class="text-danger" data-feather="trash-2" width="20"></i>
													</button>
												</div>
											</div>
										</div>
										...
										<table class="table qd-table mb6 align-middle">
											<tbody>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check2" id="check2" class="select-item">
															<label for="check2"></label>
														</div>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																<div class="width-60 height-60 img-fix rounded-circle me4">
																	<img src="assets/media/avatars/4.jpg" alt="">
																</div>
																<strong class="text-heading mt2">Norman Gordon</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-heading">Welcome to Qoduby -</strong>
															<span class="text-heading">We are here if you need help.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-heading">16:00PM</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check3" id="check3" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-body mt2">Fleece Marigold</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															...
															<span class="text-body">Payment Successfully received, check your invoice.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-text">10:32AM</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check4" id="check4" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-heading mt2">Thomas R. Toe</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-heading">Membership -</strong>
															<span class="text-heading">Your Membership Has Been Created</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-heading">Today</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check5" id="check5" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																<div class="width-60 height-60 rounded-circle me4 bg-primary-subtle d-flex align-items-center justify-content-center">
																	<h6 class="m0 text-primary">BE</h6>
																</div>
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-heading">Invoice -</strong>
															<span class="text-heading">Hi, you can find the invoice attached.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-heading">Today</span>
												...
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check6" id="check6" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-body mt2">Niles Peppertrout</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-body">Social -</strong>
															<span class="text-body">Norman commented on the photo.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-body">2 days ago</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check7" id="check7" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-body mt2">Rodney Artichoke</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-body">About Meeting -</strong>
															<span class="text-body">The meeting is today at 16:00PM.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-body">09 Apr, 2023</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check8" id="check8" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-info-subtle">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-heading">Support -</strong>
															<span class="text-heading">Your support ticket has been answered.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-heading">07 Apr, 2023</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check9" id="check9" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-body mt2">Justin Case</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-body">Invite -</strong>
															<span class="text-body">Your invite to DeveloperWeek 2023</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-body">01 Apr, 2023</span>
													</td>
												</tr>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check10" id="check10" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-success-subtle">
																	<h6 class="m0 text-success">ND</h6>
																</div>
																<strong class="text-body">Nathaneal Down</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-body">Meeting -</strong>
															<span class="text-body">Private Banking Meets Crypto</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-body">01 Apr, 2023</span>
												...
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check11" id="check11" class="select-item">
													...
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<div class="d-inline-flex flex-row align-items-center">
																...
																<strong class="text-body mt2">Norman Gordon</strong>
															</div>
														</a>
													</td>
													<td>
														<a href="apps-inbox-view-reply.html" class="text-decoration-none d-block">
															<strong class="text-body">Welcome to Qoduby -</strong>
															<span class="text-body">We are here if you need help.</span>
														</a>
													</td>
													<td class="text-end">
														<span class="text-body">01 Apr, 2023</span>
									...
									<div class="row align-items-center">
										...
										<div class="col-lg-6">
											<nav aria-label="Page navigation example">
												<ul class="pagination justify-content-center justify-content-lg-end align-items-center">
													<li class="page-item">
														<a class="page-link">
	...
	<script src="assets/js/pages/apps/inbox/mailbox.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-inbox-mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:14 GMT -->
</html>