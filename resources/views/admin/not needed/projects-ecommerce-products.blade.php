...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:45:00 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-ecommerce-products.html"><span>Products</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<div class="dropdown d-inline me4">
								...
								<div class="dropdown-menu width-330 p0">
									...
									<div class="p5 px-4">
										...
										<div class="row mb5">
											<div class="col-12">
												<label class="qd-switch switch-primary switch-sm">
							...
							<!-- Add Button Start-->
							<a href="projects-ecommerce-add-product.html" class="btn btn-primary">Add Product</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
											...
											<tbody>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/11.jpg" alt="">
															</div>
															<strong class="text-heading">Home Theater Projector</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/12.jpg" alt="">
															</div>
															<strong class="text-heading">Women’s Lace Back Sleep</strong>
														</div>
													</td>
													<td>
													...
													<td>
														<strong class="text-heading">8</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/13.jpg" alt="">
															</div>
															<strong class="text-heading">Traditional Short</strong>
														</div>
													</td>
													<td>
														<strong>Clothing</strong>
													...
													<td>
														<strong class="text-heading">11</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/14.jpg" alt="">
															</div>
															<strong class="text-heading">Women's Silver 925 Irish</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/15.jpg" alt="">
															</div>
															<strong class="text-heading">Desktop Computer 8gb</strong>
														</div>
													</td>
													<td>
														<strong>Electronics</strong>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/16.jpg" alt="">
															</div>
															<strong class="text-heading">Ring Stainless Steel</strong>
														</div>
													</td>
													<td>
														<strong>Accessories</strong>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/17.jpg" alt="">
															</div>
															<strong class="text-heading">Walking Shoes Casual Flats</strong>
														</div>
													</td>
													<td>
														<strong>Shoes</strong>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/18.jpg" alt="">
															</div>
															<strong class="text-heading">Qodu Smart Phone 16gb</strong>
														</div>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/19.jpg" alt="">
															</div>
															<strong class="text-heading">15.6" Ultra Slim Notebook</strong>
														</div>
													</td>
													<td>
														<strong>Electronics</strong>
													...
													<td>
														<strong class="text-heading">$40,00</strong>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/20.jpg" alt="">
															</div>
															<strong class="text-heading">High Heels In Black Velvet</strong>
														</div>
													</td>
													<td>
														<strong>Shoes</strong>
													...
													<td>
														<strong class="text-heading">$50,85</strong>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/21.jpg" alt="">
															</div>
															<strong class="text-heading">Wired Gaming Headset</strong>
														</div>
													</td>
													<td>
														<strong>Electronics</strong>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-60 height-60 img-fix rounded me4">
																<img src="assets/media/ecommerce/22.jpg" alt="">
															</div>
															<strong class="text-heading">Men's Textured Sweater</strong>
														</div>
													</td>
													<td>
														<strong>Clothing</strong>
	...
	<script src="assets/js/pages/projects/ecommerce/products.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:46:15 GMT -->
</html>