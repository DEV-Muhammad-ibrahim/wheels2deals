...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-inbox-compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:14 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-inbox-compose.html"><span>Compose</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12">
							<h1 class="page-title mb2">Compose</h1>
							...
							<div class="card shadow-card p6">
								...
								<div class="border rounded-3 mb6">
									...
									<div class="border-0">
										<div class="row align-items-center">
											<div class="col-12">
												<div class="mail-editor height-610">
