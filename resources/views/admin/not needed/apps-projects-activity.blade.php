...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:51 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-sm-12 mb5">
									<div class="border-dashed rounded p6 pb3 group-contact height-380 overflow-auto">
										<input id="group-search" class="form-control mb3" type="text" autocomplete="off" placeholder="Search...">
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check1" id="check1" checked>
										...
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											<div class="d-flex align-items-center justify-content-between">
												<div class="width-40 height-40 rounded-circle me3 bg-primary-subtle d-flex align-items-center justify-content-center">
										...
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check5" id="check5">
										...
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check6" id="check6">
												<label for="check6"></label>
											</div>
										</div>
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											<div class="d-flex align-items-center justify-content-between">
												<div class="width-40 height-40 rounded-circle me3 bg-info-subtle d-flex align-items-center justify-content-center">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check7" id="check7">
										...
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check8" id="check8">
												<label for="check8"></label>
											</div>
										</div>
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											<div class="d-flex align-items-center justify-content-between">
												<div class="width-40 height-40 rounded-circle me3 bg-success-subtle d-flex align-items-center justify-content-center">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check9" id="check9">
												<label for="check9"></label>
											</div>
										</div>
										<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none mb1">
											<div class="d-flex align-items-center justify-content-between">
												<div class="width-40 height-40 rounded-circle me3 bg-warning-subtle d-flex align-items-center justify-content-center">
											...
											<div class="checkbox checkbox-success">
												<input type="radio" name="check10" id="check10">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-activity.html"><span>Activity</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Package Delivery Mobile App UI Kit</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-projects-project-list.html">Project List</a></li>
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<a href="#" class="btn btn-primary btn-soft me2">Export</a>
							<a href="apps-projects-add-project.html" class="btn btn-primary">Add New</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6">
								<div class="img-fix w-100 height-170 rounded mb6">
									<img src="assets/media/projects/1.jpg" alt="">
								</div>
								<h6 class="mb2">Package Delivery Mobile App UI Kit</h6>
								<p class="mb4">UI/UX Design, prototype, wireframing, mockups, clients collaboration</p>
								<div class="d-flex align-items-center justify-content-start mb6">
									<span class="badge rounded-pill badge-soft text-bg-primary me3">Mobile Design</span>
									<span class="badge rounded-pill badge-soft text-bg-info me3">Mobile Development</span>
								</div>
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb3 hover-light">
									<span>Create Date</span>
									<strong class="text-heading">07 January 2023</strong>
								</div>
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb3 hover-light">
									<span>Due Date</span>
									<strong class="text-heading">09 April 2023</strong>
								</div>
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb3 hover-light">
									<span>Open Tasks</span>
									<div class="d-flex align-items-center justify-content-start">
										<strong class="text-heading me2">48</strong>
										<i class="me2 text-danger" data-feather="trending-down" width="20" stroke-width="2"></i>
										<strong>-7.2%</strong>
									</div>
								</div>
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb3 hover-light">
									...
									<div class="d-flex align-items-center justify-content-start">
										<strong class="text-heading me2">27</strong>
										<i class="me2 text-success" data-feather="trending-up" width="20" stroke-width="2"></i>
										<strong>+16.7%</strong>
									</div>
								</div>
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb5 hover-light">
									<span>Budget Spent</span>
									<strong class="text-heading">$16.000</strong>
								</div>
								<div class="d-flex align-items-center justify-content-between">
									<strong class="mb2 text-heading text-end">Progress Status</strong>
									<span>60%</span>
								</div>
								<div class="progress w-100 height-10 mb5" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
									<div class="progress-bar bg-primary" style="width: 60%"></div>
								</div>
								<div class="d-flex team-avatars mb5">
									<div class="shadow-card shadow-lg rounded-circle img-fix width-40 height-40 border border-white">
										<img src="assets/media/avatars/4.jpg" alt="">
									</div>
									<div class="shadow-card shadow-lg rounded-circle width-40 height-40 border border-white bg-info-subtle d-flex align-items-center justify-content-center">
										<h6 class="m0 text-info">WR</h6>
									</div>
									<div class="shadow-card shadow-lg rounded-circle img-fix width-40 height-40 border border-white">
										<img src="assets/media/avatars/13.jpg" alt="">
									</div>
									...
									<div class="shadow-card shadow-lg rounded-circle width-40 height-40 border border-white bg-warning-subtle d-flex align-items-center justify-content-center">
										<h6 class="m0 text-warning">PM</h6>
									</div>
									<div class="shadow-card shadow-lg rounded-circle img-fix width-40 height-40 border border-white">
								...
								<a href="#" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-primary btn-soft">Add User</a>
							</div>
						</div>
						<!-- Left Column Start -->
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									<li><a href="apps-projects-project-overview.html">Overview</a></li>
									<li><a href="apps-projects-users.html">Users</a></li>
									<li><a href="apps-projects-files.html">Files</a></li>
									<li class="active"><a href="apps-projects-activity.html">Activity</a></li>
									<li><a href="apps-projects-settings.html">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
							...
							<!-- Content Start -->
							<div class="row">
								<div class="col-lg-12 mb6">
									<div class="card shadow-card p6">
										<!-- Item 1 Start -->
										<div class="d-flex pb7 position-relative">
											<div class="position-absolute h-100 border-start-dashed left-20 z-1"></div>
											<div class="width-40 height-40 bg-info-subtle rounded-circle d-flex align-items-center justify-content-center me5 z-2">
												<i data-feather="mail" stroke-width="1.5" height="22" class="text-info"></i>
											</div>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Hilary Ouse accepted the invitation to join the project.</strong>
												<div class="d-flex align-items-center justify-content-start mb5">
													<div class="img-fix width-30 height-30 rounded-circle me2">
														<img src="assets/media/avatars/4.jpg" alt="">
													</div>
													<small>09 Mar 2023, 18:32 pm</small>
												</div>
												<div class="border-dashed rounded p5 d-flex flex-row align-items-center justify-content-between">
													<div class="d-flex flex-row align-items-center justify-content-start me7">
														<div class="img-fix width-60 height-60 rounded-circle me4">
															<img src="assets/media/avatars/11.jpg" alt="">
														</div>
														<div class="d-flex flex-column">
															<h6 class="mb2">Hilary Ouse</h6>
										...
										<div class="d-flex pb7 position-relative">
											<div class="position-absolute h-100 border-start-dashed left-20 z-1"></div>
											<div class="width-40 height-40 bg-warning-subtle rounded-circle d-flex align-items-center justify-content-center me5 z-2">
												<i data-feather="check" stroke-width="1.5" height="22" class="text-warning"></i>
											</div>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Task #356 has been marked as complete by Jackson Pot</strong>
												<div class="d-flex align-items-center justify-content-start mb5">
													<div class="img-fix width-30 height-30 rounded-circle me2">
														<img src="assets/media/avatars/8.jpg" alt="">
													</div>
													<small>09 Mar 2023, 15:12 pm</small>
												</div>
											</div>
										</div>
										<!-- Item 2 End -->
										...
										<div class="d-flex pb7 position-relative">
											<div class="position-absolute h-100 border-start-dashed left-20 z-1"></div>
											<div class="width-40 height-40 bg-success-subtle rounded-circle d-flex align-items-center justify-content-center me5 z-2">
												<i data-feather="clock" stroke-width="1.5" height="22" class="text-success"></i>
											</div>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Task #153 started by Lance Bogrol</strong>
												<div class="d-flex align-items-center justify-content-start mb5">
													<div class="img-fix width-30 height-30 rounded-circle me2">
														<img src="assets/media/avatars/3.jpg" alt="">
													</div>
													<small>08 Mar 2023, 09:32 am</small>
												</div>
											</div>
										</div>
										<!-- Item 3 End -->
										...
										<div class="d-flex pb7 position-relative">
											<div class="position-absolute h-100 border-start-dashed left-20 z-1"></div>
											<div class="width-40 height-40 bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center me5 z-2">
												<i data-feather="file-plus" stroke-width="1.5" height="22" class="text-primary"></i>
											</div>
											<div class="d-flex flex-column w-100">
												<strong class="text-heading mb1">Added 3 new image files</strong>
												<div class="d-flex align-items-center justify-content-start mb5">
													<div class="img-fix width-30 height-30 rounded-circle me2">
														<img src="assets/media/avatars/3.jpg" alt="">
													</div>
													<small>07 Mar 2023, 13:09 pm</small>
												</div>
												<div class="border-dashed rounded p5">
													<div class="row">
														<div class="col-lg-4 mobile-bottom-fix">
															<a href="assets/media/projects/1.jpg" class="d-block w-100 height-100 img-fix rounded" data-fslightbox="gallery">
																<img src="assets/media/projects/1.jpg" alt="">
															</a>
														</div>
														<div class="col-lg-4 mobile-bottom-fix">
															<a href="assets/media/projects/2.jpg" class="d-block w-100 height-100 img-fix rounded" data-fslightbox="gallery">
																<img src="assets/media/projects/2.jpg" alt="">
															</a>
														</div>
														<div class="col-lg-4 mobile-bottom-fix">
															<a href="assets/media/projects/3.jpg" class="d-block w-100 height-100 img-fix rounded" data-fslightbox="gallery">
																<img src="assets/media/projects/3.jpg" alt="">
															</a>
														</div>
													</div>
												</div>
										...
										<div class="d-flex position-relative">
											<div class="position-absolute h-100 border-start-dashed left-20 z-1"></div>
											<div class="width-40 height-40 bg-danger-subtle rounded-circle d-flex align-items-center justify-content-center me5 z-2">
												<i data-feather="file" stroke-width="1.5" height="22" class="text-danger"></i>
											</div>
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">1 new file added</strong>
												<div class="d-flex align-items-center justify-content-start mb5">
													<div class="img-fix width-30 height-30 rounded-circle me2">
														<img src="assets/media/avatars/10.jpg" alt="">
													</div>
													<small>06 Mar 2023, 14:23 pm</small>
												</div>
												<div class="border-dashed rounded">
													<a href="#" class="p6 d-flex flex-row align-items-center justify-content-between text-decoration-none">
														<div class="d-flex align-items-center justify-content-between me7">
															<i class="fa fa-file-pdf-o text-body-tertiary fa-3x me4" aria-hidden="true"></i>
															<div class="d-flex flex-column">
																<strong class="text-heading mb1">project-documentation.pdf</strong>
																<span class="text-body">Jackson Pot</span>
															</div>
														</div>
														<span class="badge rounded-pill badge-soft text-bg-success me3">16.2 MB</span>
													</a>
												</div>
											</div>
										</div>
	...
	<script src="assets/js/pages/apps/projects/project.js" crossorigin="anonymous"></script>
</body>
