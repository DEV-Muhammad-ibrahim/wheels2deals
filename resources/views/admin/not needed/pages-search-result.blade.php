...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:53:01 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Search Result</h1>
					...
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card">
								<div class="p6 pb0 border-bottom">
									<div class="position-relative w-100 height-50 mb4">
										<input class="form-control h-100" type="text" placeholder="Search..." value="react template">
										<button class="btn btn-transparent position-absolute top-0 end-0 height-50 rounded-start-0" role="button">
											<i data-feather="search" stroke-width="1.5" width="24" class="text-body"></i>
										</button>
									</div>
									<ul class="horizontal-menu ss-container ps0 pe0">
									...
									<div class="row">
										<div class="col-xxl-8">
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Qoduby - Dashboard | ThemeForest</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://themeforest.net/user/tempload</a>
												</strong>
												<p class="m0">Take your admin dashboard to the next level with Qoduby Admin Template, a modern and dynamic theme designed to streamline your management process and enhance your user experience.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Qoduby Admin Template: A Modern Dashboard Solution</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/modern-dashboard-solution</a>
												</strong>
												<p class="m0">Transform your admin interface with Qoduby Admin Template, a responsive and customizable theme that offers a dynamic and intuitive experience for your users.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Customizable and Responsive: Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/customizable-responsive</a>
												</strong>
												<p class="m0">Optimize your workflow with Qoduby Admin Template, an efficient and user-friendly theme that helps you stay organized and on top of your data management tasks.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Efficient and User-Friendly: Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/efficient-user-friendly</a>
												</strong>
												<p class="m0">Simplify your content management process with Qoduby Admin Template, a comprehensive and streamlined theme that offers a hassle-free experience for website administrators.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Streamlined Content Management with Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/streamlined-content-management</a>
												</strong>
												<p class="m0">Upgrade your website's UI with Qoduby Admin Template, a visually stunning and versatile theme that offers a range of customizable options to fit your unique needs.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Visually Stunning and Versatile: Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/visually-stunning-versatile</a>
												</strong>
												<p class="m0">Gain valuable insights and make data-driven decisions with Qoduby Admin Template, an organized and insightful theme designed to make data analysis a breeze.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Insightful Data Analysis with Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/insightful-data-analysis</a>
												</strong>
												<p class="m0">Empower your website's management capabilities with Qoduby Admin Template, a powerful and scalable theme that offers ultimate control over your website's functionality and performance.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Powerful and Scalable: Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/powerful-scalable</a>
												</strong>
												<p class="m0">Increase your productivity and efficiency with Qoduby Admin Template, an efficient and feature-rich theme that offers a range of tools and options to help you optimize your workflow.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Boost Productivity with Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/boost-productivity</a>
												</strong>
												<p class="m0">Take advantage of the latest trends in admin interface design with Qoduby Admin Template, a modern and minimalistic theme that offers a clean and uncluttered user experience.</p>
											</div>
											<div class="border-bottom-dashed pb5 mb5">
												<h6 class="text-primary mb1">
													<a href="#" class="text-decoration-none">Modern and Minimalistic: Qoduby Admin Template</a>
												</h6>
												<strong class="text-success d-block mb3">
													<a href="#" class="text-decoration-none text-success">https://www.tempload.com/qoduby-admin-template/modern-minimalistic</a>
												</strong>
												<p class="m0">Experience the ultimate in admin dashboard customization with Qoduby Admin Template, a comprehensive and versatile theme that offers a range of options and features to fit your unique needs.</p>
											</div>
											<div class="row align-items-center mb6">
										...
										<div class="col-xxl-4 mb6">
											<div class="border-dashed rounded p6 pb0">
												<div class="d-flex align-items-center justify-content-between mb4">
													<h6 class="m0">Image Results</h6>
													<span>8 Results</span>
												</div>
												<div class="row">
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/1.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/1.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/2.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/2.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/3.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/3.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/4.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/4.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/5.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/5.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/6.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/6.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/7.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/7.jpg" alt="">
														</a>
													</div>
													<div class="col-xxl-6 col-lg-3 col-sm-6 mb6">
														<a href="assets/media/screenshot/8.jpg" class="d-block img-fix w-100 height-100 rounded" data-fslightbox="gallery">
															<img src="assets/media/screenshot/8.jpg" alt="">
														</a>
													</div>
												</div>
											</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:53:56 GMT -->
</html>