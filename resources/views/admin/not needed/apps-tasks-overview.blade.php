...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:51 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-tasks-overview.html"><span>Overview</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Tasks</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="apps-tasks-add-task.html" class="btn btn-primary">Add Task</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						...
						<div class="col-12 mb6">
							<div class="card shadow-card overflow-hidden">
								<div class="row">
									<div class="col-xxl-4">
										<div class="bg-light p6 h-100">
											<div class="img-fix w-100 height-170 rounded mb5">
											...
											<div class="d-flex flex-row justify-content-start align-items-center mb4">
												...
												<span class="badge rounded-pill badge-soft text-bg-info">Wireframe</span>
											</div>
									...
									<div class="col-xxl-8 ps0">
										<div class="p6">
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task1" id="task1" checked>
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task2" id="task2" checked>
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													...
													<span>Start of wireframe work, creation of page list.</span>
												</div>
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task4" id="task4">
														<label for="task4"></label>
													</div>
													<span>The first presentation meeting of the design with the client.</span>
												</div>
												<small>22 April 2023</small>
											</div>
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb5">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task5" id="task5">
														<label for="task5"></label>
													</div>
													<span>Completion of the design and sending it to the coding team.</span>
												</div>
												<small>30 April 2023</small>
											</div>
											<div class="d-flex align-items-center justify-content-between">
												<span class="badge badge-soft text-bg-success">22 days left</span>
												<div class="d-flex align-items-center justify-content-start">
													<a href="apps-tasks-add-task.html" class="btn btn-primary me3">Add New Task</a>
													<a href="apps-tasks-task-detail.html" class="btn btn-primary btn-soft">Project Details</a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-xxl-4">
										<div class="bg-light p6 h-100">
											...
											<h6 class="mb2">Expense Tracker Mobile App Development</h6>
											<p class="mb4 text-body">Front-end coding, back-end coding, database design, server setup.</p>
											<div class="d-flex flex-row justify-content-start align-items-center mb4">
												<span class="badge rounded-pill badge-soft text-bg-success me3">Mobile Development</span>
												<span class="badge rounded-pill badge-soft text-bg-warning">Server Setup</span>
											</div>
											<div class="d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<span class="me2">Tasks:</span>
									...
									<div class="col-xxl-8 ps0">
										<div class="p6">
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task6" id="task6" checked>
														<label for="task6"></label>
													</div>
													<span>Determination of front-end programming technologies.</span>
												</div>
												<small>09 April 2023</small>
											</div>
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task7" id="task7" checked>
														<label for="task7"></label>
													</div>
													<span>Determination of back-end programming technologies.</span>
												</div>
												<small>10 April 2023</small>
											</div>
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task8" id="task8" checked>
														<label for="task8"></label>
													</div>
													<span>Determination and testing of libraries to be used.</span>
												</div>
												<small>14 April 2023</small>
											</div>
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task9" id="task9">
														<label for="task9"></label>
													</div>
													<span>Programming the project and sending it to the testing team.</span>
												</div>
												<small>22 April 2023</small>
											</div>
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb5">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task10" id="task10">
														<label for="task10"></label>
													</div>
													<span>Submission of the project to the Apple Store and Google Play.</span>
												</div>
												<small>30 April 2023</small>
											</div>
											<div class="d-flex align-items-center justify-content-between">
												<span class="badge badge-soft text-bg-success">16 days left</span>
												<div class="d-flex align-items-center justify-content-start">
													<a href="apps-tasks-add-task.html" class="btn btn-primary me3">Add New Task</a>
													<a href="apps-tasks-task-detail.html" class="btn btn-primary btn-soft">Project Details</a>
												</div>
								...
								<div class="row">
									<div class="col-xxl-4">
										<div class="bg-light p6 h-100">
											...
											<h6 class="mb2">Furniture Shop Mobile App UI Kit</h6>
											<p class="mb4 text-body">UI/UX Design, prototype, wireframing, mockups, clients collaboration</p>
											<div class="d-flex flex-row justify-content-start align-items-center mb4">
												<span class="badge rounded-pill badge-soft text-bg-primary me3">Mobile Design</span>
												<span class="badge rounded-pill badge-soft text-bg-info">Wireframe</span>
									...
									<div class="col-xxl-8 ps0">
										<div class="p6">
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task11" id="task11" checked>
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task12" id="task12">
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task13" id="task13">
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task14" id="task14" checked>
											...
											<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb5">
												<div class="d-flex align-items-center justify-content-start">
													<div class="checkbox checkbox-primary me2">
														<input class="task-checkbox" type="checkbox" name="task15" id="task15">
											...
											<div class="d-flex align-items-center justify-content-between">
												<span class="badge badge-soft text-bg-success">26 days left</span>
												<div class="d-flex align-items-center justify-content-start">
													<a href="apps-tasks-add-task.html" class="btn btn-primary me3">Add New Task</a>
													<a href="apps-tasks-task-detail.html" class="btn btn-primary btn-soft">Project Details</a>
												</div>
	...
	<script src="assets/js/pages/apps/tasks/task-overview.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:52 GMT -->
</html>