...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:46 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-activity.html"><span>Activity</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Activity</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-activity.html">Activity</a></li>
							...
							<div class="card shadow-card p6 mb6">
								...
								<div class="d-flex pb7 position-relative">
									...
									<div class="d-flex flex-column w-100">
										<strong class="text-heading mb1">Hilary Ouse and Norman Gordon accepted the invitation to join the project.</strong>
										...
										<div class="row w-100">
											<div class="col-xxl-6 mobile-bottom-fix">
										...
										<div class="border-dashed rounded p5">
											<div class="row">
												<div class="col-lg-4 mobile-bottom-fix">
													<a href="assets/media/projects/1.jpg" class="d-block w-100 height-120 img-fix rounded" data-fslightbox="gallery">
														<img src="assets/media/projects/1.jpg" alt="">
													</a>
												</div>
												<div class="col-lg-4 mobile-bottom-fix">
													<a href="assets/media/projects/2.jpg" class="d-block w-100 height-120 img-fix rounded" data-fslightbox="gallery">
														<img src="assets/media/projects/2.jpg" alt="">
													</a>
												</div>
												<div class="col-lg-4 mobile-bottom-fix">
													<a href="assets/media/projects/3.jpg" class="d-block w-100 height-120 img-fix rounded" data-fslightbox="gallery">
