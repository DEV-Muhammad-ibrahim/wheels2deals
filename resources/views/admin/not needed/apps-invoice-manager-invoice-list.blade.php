...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-invoice-manager-invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:06 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-invoice-manager-invoice-list.html"><span>Invoice List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Invoice List</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="apps-invoice-manager-new-invoice.html" class="btn btn-primary">New Invoice</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						<!-- Card 1 Start -->
						<div class="col-xxl-3 col-lg-6 mb6">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-12 d-flex flex-row align-items-center justify-content-start">
										<div class="rounded-circle width-40 height-40 bg-light me3 d-flex align-items-center justify-content-center">
											<i data-feather="send" stroke-width="2" height="20" class="text-body"></i>
										</div>
										<h6 class="mb0 text-body">Invoices Sent</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0 text-primary">$23.081,14</h3>
												<span class="badge rounded-pill text-bg-primary">3843</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-3 col-lg-6 mb6">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-12 d-flex flex-row align-items-center justify-content-start">
										<div class="rounded-circle width-40 height-40 bg-light me3 d-flex align-items-center justify-content-center">
											<i data-feather="check" stroke-width="2" height="20" class="text-body"></i>
										</div>
										<h6 class="mb0 text-body">Paid Invoices</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0 text-success">$16.347,00</h3>
												<span class="badge rounded-pill text-bg-success">3843</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
										</div>
									</div>
						...
						<div class="col-xxl-3 col-lg-6 mb6">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-12 d-flex flex-row align-items-center justify-content-start">
										<div class="rounded-circle width-40 height-40 bg-light me3 d-flex align-items-center justify-content-center">
											<i data-feather="clock" stroke-width="2" height="20" class="text-body"></i>
										</div>
										<h6 class="mb0 text-body">Unpaid Invoices</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0 text-warning">$3.261,12</h3>
												<span class="badge rounded-pill text-bg-warning">536</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
										</div>
									</div>
						...
						<div class="col-xxl-3 col-lg-6 mb6">
							<div class="card shadow-card p2">
								<div class="row align-items-center p5">
									<div class="col-12 d-flex flex-row align-items-center justify-content-start">
										<div class="rounded-circle width-40 height-40 bg-light me3 d-flex align-items-center justify-content-center">
											<i data-feather="x" stroke-width="2" height="20" class="text-body"></i>
										</div>
										<h6 class="mb0 text-body">Cancelled Invoices</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="position-relative">
											<div class="z-2 position-relative p5 d-flex flex-row align-items-center justify-content-between">
												<h3 class="mb0 text-danger">$3.473,02</h3>
												<span class="badge rounded-pill text-bg-danger">550</span>
											</div>
											<div class="position-absolute w-100 h-100 start-0 bottom-0 bg-light rounded-bottom z-1"></div>
										</div>
									</div>
										...
										<div class="row align-items-center">
											...
											<div class="col-md-9 text-end">
												<div id="edit-buttons" class="visibility-hide">
													...
													<button type="button" class="btn btn-outline-danger me2">Delete</button>
													<button type="button" class="btn btn-outline-secondary me2">Edit</button>
												</div>
											</div>
										</div>
									</div>
										...
										<table class="table qd-table mb6 align-middle">
											...
											<tbody>
												<tr>
													<td>
														<div class="checkbox checkbox-primary">
															<input type="checkbox" name="check1" id="check1" class="select-item">
															<label for="check1"></label>
														</div>
													</td>
													<td>
														<strong class="text-heading">#3843</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
																<img src="assets/media/avatars/4.jpg" alt="">
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Norman Gordon</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">norman@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Sage Technologies</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">09 Apr, 2023</strong>
															<small>11:38PM</small>
														</div>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-success">Paid</span>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3842</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																...
																<a href="#" class="text-decoration-none text-body hover-primary">fleece@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>IntraRailroading</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">09 Apr, 2023</strong>
													...
													<td>
														<strong class="text-heading">$26,45</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3841</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																...
																<a href="#" class="text-decoration-none text-body hover-primary">thomas@domain.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Equipmentee</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">08 Apr, 2023</strong>
															<small>08:12PM</small>
														</div>
													</td>
													<td>
													...
													<td>
														<strong class="text-heading">$70,00</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3840</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 rounded-circle me4 d-flex align-items-center justify-content-center bg-primary-subtle">
																<h6 class="m0 text-primary">BE</h6>
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Benjamin Evalent</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">benjamin@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Profession Fashion</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">08 Apr, 2023</strong>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-warning">Unpaid</span>
													</td>
													<td>
														<strong class="text-heading">$7,90</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3839</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																...
																<a href="#" class="text-decoration-none text-body hover-primary">niles@site.com</a>
															</div>
														</div>
													</td>
													<td>
													...
													<td>
														<strong class="text-heading">$30,20</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3838</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Rodney Artichoke</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">rodney@example.com</a>
															</div>
														</div>
													</td>
													<td>
													...
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">07 Apr, 2023</strong>
															<small>12:44PM</small>
														</div>
													</td>
													<td>
													...
													<td>
														<strong class="text-heading">$12,20</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3837</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 rounded-circle me4 d-flex align-items-center justify-content-center bg-info-subtle">
																<h6 class="m0 text-info">WR</h6>
															</div>
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Wisteria Ravenclaw</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">wisteria@revenclaw.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>MonoApplication</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">07 Apr, 2023</strong>
													...
													<td>
														<strong class="text-heading">$80,75</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3836</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Justin Case</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">justin@yoursite.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Click Profession</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">07 Apr, 2023</strong>
													...
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Cancel</span>
													</td>
													<td>
														<strong class="text-heading">$750,90</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3833</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Indigo Violet</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">indigo@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Justice Engineering</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">06 Apr, 2023</strong>
															<small>07:22AM</small>
														</div>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger">Refund</span>
													</td>
													<td>
														<strong class="text-heading">$46,30</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">#3832</strong>
													</td>
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															<div class="width-40 height-40 img-fix rounded-circle me4">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Lance Bogrol</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">lance@example.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Technologies Graph</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">05 Apr, 2023</strong>
															<small>11:30PM</small>
														</div>
													</td>
													<td>
													...
													<td>
														<strong class="text-heading">$20,90</strong>
													</td>
													<td>
														<div class="dropdown text-end">
															<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
	...
	<script src="assets/js/pages/apps/invoice-manager/invoice-list.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-invoice-manager-invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:08 GMT -->
</html>