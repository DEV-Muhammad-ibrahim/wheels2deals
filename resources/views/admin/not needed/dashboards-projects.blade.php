...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:43:44 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="dashboards-projects.html"><span>Projects</span></a></li>
				...
				<div class="container-fluid p0">
					...
					<div class="row">
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card d-flex flex-row align-items-center overflow-hidden">
								<div class="bg-light w-45 p4 pb3">
									<div class="height-80">
										<canvas class="chart12"></canvas>
									</div>
								</div>
								<div class="w-50 p5">
									<small class="d-block mb2">Product Design</small>
									<h5 class="text-heading mb0">5 project</h5>
								</div>
							</div>
						</div>
						<!-- Chart 1 End -->
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card d-flex flex-row align-items-center overflow-hidden">
								<div class="bg-light w-45 p4 pb3">
									<div class="height-80">
										<canvas class="chart13"></canvas>
									</div>
								</div>
								<div class="w-50 p5">
									<small class="d-block mb2">Visual Identity</small>
									<h5 class="text-heading mb0">6 project</h5>
								</div>
							</div>
						</div>
						<!-- Chart 2 End -->
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card d-flex flex-row align-items-center overflow-hidden">
								...
								<div class="w-50 p5">
									<small class="d-block mb2">Web Development</small>
									<h5 class="text-heading mb0">3 project</h5>
								</div>
							</div>
						</div>
						<!-- Chart 3 End -->
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card d-flex flex-row align-items-center overflow-hidden">
								...
								<div class="w-50 p5">
									<small class="d-block mb2">Illustration Works</small>
									<h5 class="text-heading mb0">7 project</h5>
								</div>
							</div>
						</div>
						<!-- Chart 4 End -->
								...
								<div class="col-12">
									<div class="card shadow-card p6">
										<div class="row">
											<!-- Task Summary Start -->
											<div class="col-lg-9">
												<div class="border-end-dashed pe6 pb0 sm-p-0 sm-border-none">
													<h6 class="text-heading mb4">Task Summary</h6>
													<div class="row">
														<div class="col-lg-4 mb-sm-1">
															<div class="bg-primary rounded height-250 d-flex flex-column align-items-center justify-content-center">
																...
																<span class="text-white d-block mb4">Projects</span>
														...
														<div class="col-lg-4 mb-sm-1">
															<div class="bg-info rounded height-250 d-flex flex-column align-items-center justify-content-center">
																...
																<span class="text-white d-block mb4">Ongoing</span>
														...
														<div class="col-lg-4 mb-sm-1">
															<div class="bg-light rounded height-250 d-flex flex-column align-items-center justify-content-center">
																...
																<span class="text-heading d-block mb4">Completed</span>
											...
											<!-- Our Team Start -->
											<div class="col-lg-3">
												<h6 class="text-heading mb4">Our Team</h6>
												<span class="d-block mb4">Team members</span>
												<div class="d-flex team-avatars mb5">
													<div class="shadow-card shadow-lg rounded-circle img-fix width-50 height-50 border border-white">
														<img src="assets/media/avatars/6.jpg" alt="">
													</div>
													<div class="shadow-card shadow-lg rounded-circle img-fix width-50 height-50 border border-white">
													...
													<div class="shadow-card shadow-lg rounded-circle width-50 height-50 border border-white d-flex justify-content-center align-items-center">
														<span class="text-heading">+7</span>
													</div>
												</div>
												<div class="border border-dashed rounded height-140">
													<div id="chart16" class="chart16 d-flex align-items-center justify-content-center">
														<div class="position-absolute text-center">
															<small>Progress</small>
															<h5 class="text-heading mb0">72%</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-12 mb2">
												<div class="border border-dashed rounded overflow-hidden">
													<div class="row">
														...
														<div class="col-xxl-3 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
															<div class="d-flex flex-column">
													...
													<div class="row">
														...
														<div class="col-xxl-3 mb-4 mb-xxl-0 d-flex align-items-center justify-content-center">
															<div class="d-flex flex-column">
																...
																<div class="progress width-200 height-5" role="progressbar" aria-label="Basic example" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100">
												...
												<div class="col-12">
													<div class="d-flex align-items-center justify-content-between border-bottom-dashed pb4">
														<div class="d-flex align-items-center pe6">
															...
															<div class="d-flex flex-column">
																<strong class="text-heading mb1">Project design for Sketch</strong>
																<small>2 days remaining</small>
															</div>
														</div>
													</div>
	...
	<script src="assets/js/pages/dashboards/dashboard-03.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:43:56 GMT -->
</html>