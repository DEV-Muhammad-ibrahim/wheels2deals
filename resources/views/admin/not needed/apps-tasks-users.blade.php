...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-users.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-tasks-users.html"><span>Users</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row">
						...
						<div class="col-12 mb6">
							<div class="card shadow-card">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="apps-tasks-users.html">Users</a></li>
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<div class="card shadow-card rounded p5 d-flex flex-row align-items-center justify-content-between">
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<div class="card shadow-card rounded p5 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-row align-items-center justify-content-start me7">
									<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-primary-subtle">
										<h6 class="m0 text-primary">HD</h6>
									</div>
									<div class="d-flex flex-column">
							...
							<div class="card shadow-card rounded p5 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-row align-items-center justify-content-start me7">
									<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-success-subtle">
										<h6 class="m0 text-success">EF</h6>
									</div>
									<div class="d-flex flex-column">
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<div class="card shadow-card rounded p5 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-row align-items-center justify-content-start me7">
									<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-warning-subtle">
										<h6 class="m0 text-warning">DA</h6>
									</div>
									<div class="d-flex flex-column">
										<h6 class="mb2">Dianne Ameter</h6>
										<span>SEO Executive</span>
									</div>
								</div>
								<button class="btn btn-secondary btn-soft">
						...
						<div class="col-xxl-4 col-lg-6 mb6">
							<div class="card shadow-card rounded p5 d-flex flex-row align-items-center justify-content-between">
								<div class="d-flex flex-row align-items-center justify-content-start me7">
									<div class="width-60 height-60 rounded-circle me4 d-flex align-items-center justify-content-center bg-secondary-subtle">
										<h6 class="m0 text-secondary">FM</h6>
									</div>
									<div class="d-flex flex-column">
										<h6 class="mb2">Fleece Marigold</h6>
										<span>UI/UX Designer</span>
									</div>
								</div>
								<button class="btn btn-secondary btn-soft">
