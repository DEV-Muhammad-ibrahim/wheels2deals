...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-users.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:50 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-users.html"><span>Users</span></a></li>
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="apps-projects-users.html">Users</a></li>
							...
							<div class="row">
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										<div class="img-fix width-60 height-60 rounded-circle mb6">
											<img src="assets/media/avatars/4.jpg" alt="">
										</div>
										<h6 class="mb2">Jackson Pot</h6>
										<span class="mb4">Project Manager</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										...
										<h6 class="mb2">Pelican Steve</h6>
										<span class="mb4">Developer Relations</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										...
										<span class="mb4">JavaScript Developer</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										<div class="width-60 height-60 rounded-circle mb6 bg-info-subtle d-flex align-items-center justify-content-center">
											<h6 class="text-info mb0">MC</h6>
										</div>
										<h6 class="mb2">Max Conversion</h6>
										<span class="mb4">Back-End Developer</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										...
										<h6 class="mb2">Barry Tone</h6>
										<span class="mb4">UI/UX Designer</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										...
										<h6 class="mb2">Eleanor Fant</h6>
										<span class="mb4">SEO Executive</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										...
										<h6 class="mb2">Miles Tone</h6>
										<span class="mb4">SEO Specialist</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
								...
								<div class="col-lg-6 mb6">
									<div class="card shadow-card p6 d-flex align-items-center justify-content-center">
										<div class="img-fix width-60 height-60 rounded-circle mb6">
											<img src="assets/media/avatars/2.jpg" alt="">
										</div>
										<h6 class="mb2">Hans Down</h6>
										<span class="mb4">Chief Marketing Officer</span>
										<div class="d-flex flex-row align-items-center justify-content-center">
											<button class="btn btn-success btn-soft me2">
												<i class="fa fa-whatsapp fa-lg" aria-hidden="true"></i>
											</button>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-users.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:51 GMT -->
</html>