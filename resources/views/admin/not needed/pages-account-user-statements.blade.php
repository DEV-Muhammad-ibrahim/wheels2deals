...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/pages-account-user-statements.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:49 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-statements.html"><span>Statements</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Statements</h1>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-statements.html">Statements</a></li>
					...
					<!-- Earnings & View Invoices Content Start -->
					<div class="row">
						<!-- Earnings Start -->
						<div class="col-xxl-8 mb6">
							<div class="card shadow-card p6">
								<h6 class="mb4">Earnings</h6>
								<div class="row align-items-center">
									<div class="col-xxl-8 mobile-bottom-fix">
										<span class="d-block mb7">Your sales and referral earnings over the last 30 days</span>
										<div class="row">
											<div class="col-lg-3">
												<div class="d-flex flex-column align-items-start justify-content-start">
													<small class="mb2">My Funds</small>
													<h4 class="text-primary">$79.70</h4>
												</div>
											</div>
											<div class="col-lg-3">
												<div class="d-flex flex-column align-items-start justify-content-start">
													<small class="mb2">Earnings</small>
													<h4 class="text-success">+$130.00</h4>
												</div>
											</div>
											<div class="col-lg-3">
												<div class="d-flex flex-column align-items-start justify-content-start">
													<small class="mb2">Tax Withheld</small>
													<h4 class="text-warning">-$13.00</h4>
												</div>
											</div>
											<div class="col-lg-3">
												<div class="d-flex flex-column align-items-start justify-content-start">
													<small class="mb2">Fees</small>
													<h4 class="text-danger">-$37.30</h4>
												</div>
											</div>
										</div>
									</div>
									<div class="col-xxl-4">
										<div class="btn btn-primary w-100 mb4">Withdraw Earnings</div>
										<div class="btn btn-secondary btn-soft w-100">Print This Overview</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-4 mb6">
							<div class="card shadow-card p6">
								<h6 class="mb5">View Invoices</h6>
								<p class="mb5">You can download the invoice for the month you want by selecting it from the list.</p>
								<div class="row align-items-center mb4">
									<div class="col-7 mb2">
										<select id="settings-form-6" class="form-select js-choice" required>
											...
											<option value="04-2023" selected>Apr 2023</option>
									...
									<div class="col-5 mb2">
										<div class="btn btn-primary btn-sm btn-soft w-100">Download</div>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- Earnings & View Invoices Content End -->

					<!-- Statement Start -->
					<div class="row mb6">
						<div class="col-12">
							<div class="card shadow-card p6">
								<h6 class="mb4">Statement</h6>
									...
									<table class="table qd-table m0 align-middle">
										...
										<tbody>
											<tr>
												...
												<td>
													<span>IT Solutions and Corporate Template</span>
												</td>
												<td>
													<strong class="text-success">$68.93</strong>
												</td>
												<td class="text-end">
											...
											<tr>
												...
												<td>
													<span>Modular Multi Purpose HTML5 Template</span>
												</td>
												<td>
													<strong class="text-success">$136.25</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<strong class="text-danger">$102.80</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading mb1">098 Apr, 2023</strong>
														<small>05:28PM</small>
													</div>
												</td>
												<td>
													<span>Mobile App Development Agency HTML5 Template</span>
												</td>
												<td>
													<strong class="text-success">$42.11</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<strong class="text-danger">$126.45</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<span>Bitcoin and Cryptocurrency ICO HTML Template</span>
												</td>
												<td>
													<strong class="text-success">$68.93</strong>
												</td>
											...
											<tr>
												...
												<td>
													<span>Kitchen & Interior Design Template</span>
												</td>
												<td>
													<strong class="text-success">$102.80</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<strong class="text-danger">$42.11</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
											...
											<tr>
												...
												<td>
													<strong class="text-success">$126.45</strong>
												</td>
												<td class="text-end">
													<button type="button" class="btn btn-secondary btn-soft">PDF</button>
												</td>
