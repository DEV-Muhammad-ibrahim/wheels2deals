...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:06 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="projects-ecommerce-categories.html"><span>Categories</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="projects-ecommerce-add-category.html" class="btn btn-primary">Add Category</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
										...
										<tbody>
												...
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/1.jpg" alt="">
														</div>
														<strong class="text-heading">Computer Components</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
														<i data-feather="external-link" stroke-width="2" height="20" class="text-heading"></i>
														<strong class="text-heading">computer-components</strong>
													</a>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/2.jpg" alt="">
														</div>
												...
												<td>
													<strong class="text-heading">1648</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/3.jpg" alt="">
														</div>
														<strong class="text-heading">Toys & Video Games</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">4376</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/4.jpg" alt="">
														</div>
														<strong class="text-heading">Furniture</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">1265</strong>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/5.jpg" alt="">
														</div>
														<strong class="text-heading">Jewelry & Accessories</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">43</strong>
												</td>
												<td>
													<strong class="text-heading">2754</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/6.jpg" alt="">
														</div>
														<strong class="text-heading">Baby & Toddler</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">6291</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/7.jpg" alt="">
														</div>
														<strong class="text-heading">Kitchen & Dining</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">4912</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/8.jpg" alt="">
														</div>
														<strong class="text-heading">Kid's Rooms</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
														<i data-feather="external-link" stroke-width="2" height="20" class="text-heading"></i>
														<strong class="text-heading">kids-rooms</strong>
													</a>
												</td>
												<td>
												...
												<td>
													<strong class="text-heading">2321</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/9.jpg" alt="">
														</div>
														<strong class="text-heading">Sports & Outdoors</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">1638</strong>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="d-inline-flex flex-row align-items-center">
														<div class="width-120 height-80 img-fix rounded me4">
															<img src="assets/media/ecommerce/10.jpg" alt="">
														</div>
														<strong class="text-heading">Office & School Supplies</strong>
													</div>
												</td>
												<td>
													<a href="#" class="text-decoration-none">
												...
												<td>
													<strong class="text-heading">67</strong>
												</td>
												<td>
													<strong class="text-heading">3821</strong>
												</td>
												<td>
													<span class="badge rounded-pill badge-soft text-bg-success">Published</span>
												</td>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/projects-ecommerce-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:44:59 GMT -->
</html>