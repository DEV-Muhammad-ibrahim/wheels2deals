...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-chat-group-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:13 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="modal-content">
				<form method="post" action="#" id="addcar" class="needs-validation" novalidate>
					<div class="modal-header px-4">
						<h5 class="modal-title fs-5">New Group</h5>
									...
									<div class="row">
										<div class="col-sm-12 mb5">
											<label for="add-form-1" class="form-label">
												...
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a group name."></i>
											</label>
										...
										<div class="col-sm-12 mb5">
											<label for="add-car-form-2" class="form-label">
												<span>Status</span>
												<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select the visibility status for the group."></i>
											</label>
											<select id="add-car-form-2" class="form-select js-choice">
										...
										<div class="col-12">
											...
											<textarea class="form-control" id="add-form-4" rows="7"></textarea>
										</div>
									</div>
								</div>
								<div class="col-6">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-chat-group-chat.html"><span>Group Chat</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Group Chat</h1>
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<button class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#addModal">New Group</button>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
							...
							<div class="row">
								...
								<div class="col-12 mb6">
									<div class="card shadow-card p6 pb3">
										<input id="contact-search" class="form-control mb3" type="text" autocomplete="off" placeholder="Search...">
										<a href="#" class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
											<div class="d-flex align-items-center justify-content-between">
												<div class="img-fix width-40 height-40 rounded-circle me3">
													<img src="assets/media/avatars/4.jpg" alt="">
												</div>
										...
										<a href="#" class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none mb1">
											<div class="d-flex align-items-center justify-content-between">
												<div class="width-40 height-40 rounded-circle me3 bg-warning-subtle d-flex align-items-center justify-content-center">
													<h6 class="mb0 text-warning">PM</h6>
												</div>
							...
							<div class="card shadow-card overflow-hidden">
								<div class="p6 d-flex align-items-center justify-content-between border-bottom">
									<div class="d-flex align-items-center justify-content-start">
										<div class="d-flex team-avatars me3">
											<div class="shadow-card shadow-lg rounded-circle img-fix width-50 height-50 border border-white">
												<img src="assets/media/avatars/12.jpg" alt="">
											</div>
											<div class="shadow-card shadow-lg rounded-circle width-50 height-50 border border-white bg-info-subtle d-flex align-items-center justify-content-center">
											...
											<div class="shadow-card shadow-lg rounded-circle width-50 height-50 border border-white bg-success-subtle d-flex align-items-center justify-content-center">
												<h6 class="m0 text-success">BE</h6>
											</div>
											<div class="shadow-card shadow-lg rounded-circle img-fix width-50 height-50 border border-white">
												<img src="assets/media/avatars/8.jpg" alt="">
											</div>
											<div class="shadow-card shadow-lg rounded-circle width-50 height-50 border border-white d-flex justify-content-center align-items-center">
												<h6 class="m0 text-body">+48</h6>
											</div>
										</div>
										<h6 class="text-heading m0">Web Design Group</h6>
									</div>
									<div class="d-flex">
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none me2 dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div class="p6 pt3 pb3">
									<div class="chat-app-scroll ss-container height-590">
										<div class="d-flex flex-column align-items-start mb6">
											<div class="d-flex align-items-center mb3">
												<div class="img-fix rounded-circle me3 height-30 width-30 me3">
													<img src="assets/media/avatars/12.jpg" alt="">
	...
	<script src="assets/js/pages/apps/chat/group-chat.js" crossorigin="anonymous"></script>
</body>
