...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-contacts-view-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:15 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-contacts-view-contact.html"><span>View Contact</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12">
							<h1 class="page-title mb2">View Contact</h1>
						...
						<div class="col-xxl-9 mb6">
							<div class="card shadow-card">
								<div class="border-bottom">
									<div class="p6 d-flex align-items-center justify-content-between">
										<h6 class="mb0">Contact Details</h6>
										<div class="d-flex align-items-center justify-content-start">
											<button class="btn btn-success btn-soft me2">Message</button>
											<div class="dropdown">
												<button type="button" class="outline-none dropdown-toggle arrow-none border-0 height-40 rounded ps3 bg-body-secondary opacity-75" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
													<i data-feather="more-horizontal" stroke-width="2" width="16" class="text-heading"></i>
												</button>
								...
								<div class="p6 pb0">
									<div class="border-bottom-dashed pb6 mb6">
										<div class="row align-items-center">
											<div class="col-lg-4 mobile-bottom-fix">
												<div class="d-flex align-items-center justify-content-start">
													<div class="width-60 height-60 img-fix rounded-circle me3">
														<img src="assets/media/avatars/3.jpg" alt="">
													</div>
													<div class="d-flex flex-column justify-content-start">
														<strong class="text-heading">Niles Peppertrout</strong>
														<span>@NilesPepper</span>
													</div>
												</div>
											</div>
											<div class="col-lg-4 mobile-bottom-fix">
												<a href="#" class="text-decoration-none">
													<i data-feather="mail" stroke-width="2" width="18" class="text-primary me1"></i>
													<span class="text-body">niles@example.com</span>
												</a>
											</div>
											<div class="col-lg-4">
												<a href="#" class="text-decoration-none">
													<i data-feather="phone" stroke-width="2" width="18" class="text-primary me1"></i>
													<span class="text-body">+1 202-918-2132</span>
												</a>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-12 mb6">
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Company Name</strong>
												<span>Qoduby Inc.</span>
											</div>
										</div>
										<div class="col-12 mb6">
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Country</strong>
												<span>United States</span>
											</div>
										</div>
										<div class="col-12 mb6">
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">City</strong>
												<span>Washington, DC</span>
											</div>
										</div>
										<div class="col-12 mb6">
											<div class="d-flex flex-column">
												<strong class="text-heading mb1">Notes</strong>
												<p>Quisque quis viverra metus. Duis ultricies scelerisque elementum. Suspendisse accumsan consequat leo, eu feugiat neque laoreet ac. Aenean dignissim sodales sapien, a finibus nisi tincidunt eget. Proin ac mollis mauris. Nam venenatis, felis non mattis convallis, ante sapien imperdiet mauris, et rhoncus nunc turpis ac purus. Nam felis mi, cursus at faucibus id, egestas sed leo. Nullam eleifend odio et augue vulputate elementum.</p>
												<p>Praesent vel tellus fringilla, rhoncus neque a, porttitor nisi. Quisque sed pellentesque velit, vitae mollis nibh. Quisque at est malesuada, blandit erat id, feugiat elit. Integer quis maximus nunc, non tempus justo. Quisque et augue ex.</p>
												<p>Nullam iaculis molestie ante ut varius. Aenean luctus quam purus, consectetur egestas lorem bibendum a. Vestibulum sed pharetra ante. Maecenas luctus posuere lorem ut ultrices.</p>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-3 col-6 mb6">
											<a href="assets/media/woman/1.jpg" class="d-block height-150 img-fix rounded" data-fslightbox="gallery">
												<img src="assets/media/woman/1.jpg" alt="">
											</a>
										</div>
										<div class="col-sm-3 col-6 mb6">
											<a href="assets/media/woman/2.jpg" class="d-block height-150 img-fix rounded" data-fslightbox="gallery">
												<img src="assets/media/woman/2.jpg" alt="">
											</a>
										</div>
										<div class="col-sm-3 col-6 mb6">
											<a href="assets/media/woman/3.jpg" class="d-block height-150 img-fix rounded" data-fslightbox="gallery">
												<img src="assets/media/woman/3.jpg" alt="">
											</a>
										</div>
										<div class="col-sm-3 col-6 mb6">
											<a href="assets/media/woman/4.jpg" class="d-block height-150 img-fix rounded" data-fslightbox="gallery">
												<img src="assets/media/woman/4.jpg" alt="">
											</a>
										</div>
									</div>
								</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-contacts-view-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:16 GMT -->
</html>