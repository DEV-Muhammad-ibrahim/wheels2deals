...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-support-center-ticket-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:09 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-support-center-ticket-details.html"><span>Ticket Details</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">In-app purchase problem - [#4827]</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-support-center-overview.html">Support Center</a></li>
					...
					<div class="row mb6">
						...
						<div class="col-xxl-4 mb6">
							...
							<div class="card shadow-card p6 mb6">
								...
								<h6 class="mb2">In-app purchase problem - [#4827]</h6>
								<p class="mb4">Quisque at auctor risus. Orci varius natoque penatibus et magnis dis parturient.</p>
								<div class="d-flex align-items-center justify-content-start mb6">
									<span class="badge rounded-pill badge-soft text-bg-success me3">Inprogress</span>
									<span class="badge rounded-pill text-bg-danger me3">High</span>
								</div>
								...
								<div class="border-dashed p5 rounded d-flex align-items-center justify-content-between mb3 hover-light">
									...
									<strong class="text-heading">22 min ago</strong>
								</div>
								<a href="#" class="btn btn-primary btn-soft">Close Ticket</a>
							</div>
							<!-- Info Card End -->

							<!-- Files Attachment Start -->
							<div class="card shadow-card p6">
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0">Files Attachment</h6>
									</div>
								</div>
								<div class="row">
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">project-php-files.zip</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">ZIP</span>
										</a>
									</div>
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">Error-Screenshot.jpg</span>
											</div>
									...
									<div class="col-12 mb3">
										<a href="#" class="border border-dashed rounded overflow-hidden d-flex align-items-center justify-content-between text-decoration-none pe4">
											<div class="d-flex align-items-center justify-content-start">
												...
												<span class="text-heading">my-sample-code.js</span>
											</div>
											<span class="badge rounded-pill badge-soft text-bg-info">JS</span>
										</a>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6 p6">
								<div class="border-bottom-dashed pb4 mb6">
									<div class="d-flex align-items-center justify-content-between mb4">
										<div class="d-flex align-items-center justify-content-start">
											...
											<div class="d-flex flex-column align-items-start">
												...
												<span class="badge rounded-pill badge-soft text-bg-info me3">Customer</span>
											</div>
										</div>
										<div class="d-flex flex-column align-items-end justify-content-end">
											<small class="text-heading mb2">07 January 2023</small>
											<small class="text-heading">14:32 pm</small>
										</div>
									</div>
									<p>In-app purchase fails. In my account, a credit card is defined, but the payment is not made. I also tried with another credit card but the result is the same. Can you help with this?</p>
									<p>I also have the same problem on my other phone and tablet. I have deleted and reinstalled the app many times. If the problem is not resolved, I will terminate my membership.</p>
								</div>
								<div class="border-bottom-dashed pb4 mb6">
									<div class="d-flex align-items-center justify-content-between mb4">
										<div class="d-flex align-items-center justify-content-start">
											...
											<div class="d-flex flex-column align-items-start">
												...
												<span class="badge rounded-pill badge-soft text-bg-success me3">Support Assistant</span>
											</div>
										</div>
										<div class="d-flex flex-column align-items-end justify-content-end">
											<small class="text-heading mb2">07 January 2023</small>
											<small class="text-heading">16:02 pm</small>
										</div>
									</div>
									<p>First of all, we are very sorry that you are experiencing such a problem. Can you share with us the operating system version of the phone you are using so that we can assist you faster?</p>
									<p>If you don't know how to do this, you can visit the link below.</p>
									<p><a href="#" class="text-decoration-none">https://example.com/docs/how-to-find-out-the-operating-system-version/</a></p>
								</div>
								<div class="pb0">
									<div class="d-flex align-items-center justify-content-between mb4">
										<div class="d-flex align-items-center justify-content-start">
										...
										<div class="d-flex flex-column align-items-end justify-content-end">
											<small class="text-heading mb2">07 January 2023</small>
											<small class="text-heading">17:12 pm</small>
										</div>
									</div>
									<p class="mb0">I think I was able to handle this. The OS version I am using is 16.0.12. Does this work for you?</p>
								</div>
							</div>
							<!-- Correspondence End -->

							<!-- Answer Quickly Start -->
							<div class="card shadow-card p6">
								<h6 class="mb5">Answer Quickly</h6>
								<div class="row">
									<div class="col-12 mb4">
										<label for="add-form-9" class="form-label">
											<span>Answer</span>
											<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Please do not share your password when replying."></i>
										</label>
									...
									<div class="col-12">
										<div class="d-flex align-items-center justify-content-between">
											<button class="btn btn-secondary btn-soft">
												<i data-feather="paperclip" stroke-width="2" width="18" class="text-body"></i>
											</button>
											<div class="d-flex align-items-center justify-content-start">
												<button class="btn btn-secondary btn-soft me4">Discard</button>
												<button class="btn btn-primary">
													Send
													<i data-feather="send" stroke-width="2" width="14"></i>
												</button>
											</div>
										</div>
									</div>
	...
	<script src="assets/js/pages/apps/support-center/ticket-details.js" crossorigin="anonymous"></script>
</body>
