...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:43:25 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
				...
				<ul class="menu-group m-0 px-4 mb-4">
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="dashboards-ecommerce.html"><span>eCommerce</span></a></li>
				...
				<div class="container-fluid p0">
					...
					<div class="row">
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card p6 align-items-center">
								<div class="bg-info-subtle p1 pe4 rounded-pill d-flex flex-row align-items-center mb5">
									<div class="rounded-circle width-30 height-30 bg-info d-flex align-items-center justify-content-center me2">
										<i data-feather="dollar-sign" stroke-width="2" height="14" class="text-white"></i>
									</div>
									<small class="text-info">Total Sales</small>
								</div>
								<h4 class="mb4">$16.745,32</h4>
								<div class="d-flex flex-row align-items-center">
									<div class="d-flex align-items-center me6">
										<i data-feather="trending-up" stroke-width="2" height="18" class="text-success me1"></i>
										<strong class="text-heading">+16.7%</strong>
									</div>
									<strong>+4.2K this week</strong>
								</div>
							</div>
						</div>
						<!-- Chart 1 End -->
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card p6 align-items-center">
								<div class="bg-info-subtle p1 pe4 rounded-pill d-flex flex-row align-items-center mb5">
									<div class="rounded-circle width-30 height-30 bg-info d-flex align-items-center justify-content-center me2">
										<i data-feather="user" stroke-width="2" height="14" class="text-white"></i>
									</div>
									<small class="text-info">Visitors</small>
								</div>
								<h4 class="mb4">36.827</h4>
								<div class="d-flex flex-row align-items-center">
									<div class="d-flex align-items-center me6">
										<i data-feather="trending-down" stroke-width="2" height="18" class="text-danger me1"></i>
										<strong class="text-heading">-7.2%</strong>
									</div>
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card p6 align-items-center">
								<div class="bg-info-subtle p1 pe4 rounded-pill d-flex flex-row align-items-center mb5">
									<div class="rounded-circle width-30 height-30 bg-info d-flex align-items-center justify-content-center me2">
										<i data-feather="shopping-cart" stroke-width="2" height="14" class="text-white"></i>
									</div>
									<small class="text-info">Total Orders</small>
								</div>
								<h4 class="mb4">$23.729</h4>
								<div class="d-flex flex-row align-items-center">
									<div class="d-flex align-items-center me6">
										<i data-feather="trending-up" stroke-width="2" height="18" class="text-success me1"></i>
										<strong class="text-heading">+12.3%</strong>
									</div>
									<strong>+6.7K this week</strong>
								</div>
							</div>
						</div>
						<!-- Chart 3 End -->
						...
						<div class="col-xxl-3 col-lg-6 mb5">
							<div class="card shadow-card p6 align-items-center">
								<div class="bg-info-subtle p1 pe4 rounded-pill d-flex flex-row align-items-center mb5">
									<div class="rounded-circle width-30 height-30 bg-info d-flex align-items-center justify-content-center me2">
										<i data-feather="corner-down-left" stroke-width="2" height="14" class="text-white"></i>
									</div>
									<small class="text-info">Refunded</small>
								</div>
								<h4 class="mb4">$1.262,74</h4>
								<div class="d-flex flex-row align-items-center">
									<div class="d-flex align-items-center me6">
										<i data-feather="trending-up" stroke-width="2" height="18" class="text-success me1"></i>
										<strong class="text-heading">+11.2%</strong>
									</div>
									<strong>+3.1K this week</strong>
								</div>
							</div>
						</div>
						<!-- Chart 4 End -->
							...
							<div class="card shadow-card p6">
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Top Category</h6>
										<div class="dropdown">
								...
								<div class="row">
									<div class="col-12">
										<div class="height-260 d-flex align-items-center justify-content-center mb1 position-relative">
											<canvas class="chart10"></canvas>
											<h4 class="position-absolute">$16.5K</h4>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-12 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Last Orders</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex flex-row justify-content-start align-items-center">
																<div class="img-fix width-40 height-40 rounded me3">
																	<img src="assets/media/pages/ecommerce/1.jpg" alt="">
																</div>
																<strong class="text-heading">Smart Phone</strong>
															</div>
														</td>
														<td>4827</td>
														<td>Apr 9, 2023</td>
													...
													<tr>
														<td>
															<div class="d-flex flex-row justify-content-start align-items-center">
																<div class="img-fix width-40 height-40 rounded me3">
																	<img src="assets/media/pages/ecommerce/2.jpg" alt="">
																</div>
																<strong class="text-heading">Smart Vacuum</strong>
															</div>
														</td>
														<td>387</td>
														<td>Apr 9, 2023</td>
													...
													<tr>
														<td>
															<div class="d-flex flex-row justify-content-start align-items-center">
																<div class="img-fix width-40 height-40 rounded me3">
																	<img src="assets/media/pages/ecommerce/3.jpg" alt="">
																</div>
																<strong class="text-heading">Black Laptop</strong>
															</div>
														</td>
														<td>1187</td>
														<td>Apr 8, 2023</td>
													...
													<tr>
														<td>
															<div class="d-flex flex-row justify-content-start align-items-center">
																<div class="img-fix width-40 height-40 rounded me3">
																	<img src="assets/media/pages/ecommerce/4.jpg" alt="">
																</div>
																<strong class="text-heading">7” Tablet</strong>
															</div>
														</td>
														<td>784</td>
														<td>Apr 7, 2023</td>
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p6">
								<!-- Visitors Start -->
								<div class="row align-items-center mb7">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Visitors</h6>
										<div class="dropdown">
								...
								<div class="row mb5">
									<div class="col-12">
										<div class="border-bottom-dashed pb2 height-230">
								...
								<div class="row align-items-center mb4">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Devices</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
								...
								<div class="row mb4">
									<div class="col-12">
										<div class="d-flex">
											<div class="height-110 bg-primary p4 rounded d-flex align-items-end justify-content-start me2" data-qd-width="58">
												<h6 class="text-white mb0">58%</h6>
											</div>
											<div class="height-110 bg-info p4 rounded d-flex align-items-end justify-content-start me2" data-qd-width="27">
												<h6 class="text-white mb0">27%</h6>
											</div>
											<div class="height-110 bg-secondary-subtle p4 rounded d-flex align-items-end justify-content-start" data-qd-width="21">
												<h6 class="text-heading mb0">21%</h6>
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col d-flex flex-row justify-content-start">
										<div class="d-flex align-items-center me4">
											<div class="width-20 height-20 bg-primary rounded me2"></div>
											<span>Mobile</span>
										</div>
										<div class="d-flex align-items-center me4">
											<div class="width-20 height-20 bg-info rounded me2"></div>
											<span>Desktop</span>
										</div>
										<div class="d-flex align-items-center">
											<div class="width-20 height-20 bg-secondary-subtle rounded me2"></div>
											<span>Other</span>
										</div>
									</div>
								</div>
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p6">
								...
								<div class="row mb5">
									<div class="col-12 mb7">
										<h4 class="text-heading">12.743,649</h4>
										<span>Total customer referrals</span>
									</div>
									<div class="col-lg-12">
										<div class="position-relative height-340">
											<div class="bg-primary rounded-circle d-flex align-items-center justify-content-center position-absolute start-0 top-0 z-0 width-240 height-240">
												<div class="d-flex flex-column align-items-center">
													<span class="text-white">Social Media</span>
													<h3 class="text-white">8.367,357</h3>
												</div>
											</div>
											<div class="bg-success rounded-circle d-flex align-items-center justify-content-center position-absolute start-50 top-0 z-2 width-180 height-180">
												<div class="d-flex flex-column align-items-center">
													<span class="text-white">Organic</span>
													<h3 class="text-white">243,509</h3>
												</div>
											</div>
											<div class="bg-info rounded-circle d-flex align-items-center justify-content-center position-absolute end-0 bottom-0 z-1 width-220 height-220">
												<div class="d-flex flex-column align-items-center">
													<span class="text-white">Google Ads</span>
													<h3 class="text-white">4.132,783</h3>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="col-xxl-4 mb5">
							<div class="card shadow-card p6">
								<div class="row align-items-center mb5">
									<div class="col d-flex flex-row justify-content-between align-items-center">
										<h6 class="mb0 d-inline">Customer Review</h6>
										<div class="dropdown">
											<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
												<i data-feather="more-horizontal" stroke-width="2" height="22" class="text-body"></i>
											</button>
								...
								<div class="row">
									<div class="col-12 mb6">
										<div class="bg-light p4 pounded d-flex justify-content-between align-items-center rounded">
											<div class="d-flex">
												<i data-feather="star" stroke-width="2" height="22" class="text-warning" fill="var(--bs-warning)"></i>
												<i data-feather="star" stroke-width="2" height="22" class="text-warning" fill="var(--bs-warning)"></i>
												<i data-feather="star" stroke-width="2" height="22" class="text-warning" fill="var(--bs-warning)"></i>
												<i data-feather="star" stroke-width="2" height="22" class="text-warning" fill="var(--bs-warning)"></i>
												<i data-feather="star" stroke-width="2" height="22" class="text-warning opacity-30" fill="var(--bs-warning)"></i>
											</div>
											<span>4.0 out of 5</span>
										</div>
									</div>
									<div class="col-12 text-center mb5">
										<span>Total 4.836 review</span>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12 mb4">
										<div class="d-flex justify-content-between mb2">
											<strong class="text-heading">5 star</strong>
											<span>50%</span>
										</div>
										<div class="progress height-10" role="progressbar" aria-label="Basic example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar" style="width: 60%"></div>
										</div>
									</div>
									<div class="col-lg-12 mb4">
										<div class="d-flex justify-content-between mb2">
											<strong class="text-heading">4 star</strong>
											<span>15%</span>
										</div>
										<div class="progress height-10" role="progressbar" aria-label="Basic example" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar" style="width: 15%"></div>
										</div>
									</div>
									<div class="col-lg-12 mb4">
										<div class="d-flex justify-content-between mb2">
											<strong class="text-heading">3 star</strong>
											<span>13%</span>
										</div>
										<div class="progress height-10" role="progressbar" aria-label="Basic example" aria-valuenow="13" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar" style="width: 13%"></div>
										</div>
									</div>
									<div class="col-lg-12 mb4">
										<div class="d-flex justify-content-between mb2">
											<strong class="text-heading">2 star</strong>
											<span>12%</span>
										</div>
										<div class="progress height-10" role="progressbar" aria-label="Basic example" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar" style="width: 12%"></div>
										</div>
									</div>
									<div class="col-lg-12 mb6">
										<div class="d-flex justify-content-between mb2">
											<strong class="text-heading">1 star</strong>
											<span>10%</span>
										</div>
										<div class="progress height-10" role="progressbar" aria-label="Basic example" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
											<div class="progress-bar" style="width: 10%"></div>
										</div>
									</div>
									<div class="col-lg-12 mb1">
										<a class="btn btn-primary btn-soft d-block mb1" href="#" role="button">View All Comments</a>
									</div>
								</div>
							</div>
						</div>
	...
	<script src="assets/js/pages/dashboards/dashboard-02.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/dashboards-ecommerce.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:43:44 GMT -->
</html>