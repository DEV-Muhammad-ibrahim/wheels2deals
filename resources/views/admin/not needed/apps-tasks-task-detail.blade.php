...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-task-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-tasks-task-detail.html"><span>Task Detail</span></a></li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Smart Home Mobile App UI Kit</h1>
						...
						<div class="col-12 mb6">
							<div class="card shadow-card">
								...
								<ul class="horizontal-menu ss-container">
									<li class="active"><a href="apps-tasks-task-detail.html">Overview</a></li>
									<li><a href="apps-tasks-users.html">Users</a></li>
									<li><a href="apps-tasks-files.html">Files</a></li>
								</ul>
							</div>
						</div>
						<!-- Task Top Start -->
						...
						<div class="col-12 mb6">
							<div class="card shadow-card p6">
								...
								<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between mb2">
									<div class="d-flex align-items-center justify-content-start">
										<div class="checkbox checkbox-primary me2">
											<input class="task-checkbox" type="checkbox" name="task6" id="task6">
								...
								<div class="border-dashed rounded p4 d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center justify-content-start">
										<div class="checkbox checkbox-primary me2">
											<input class="task-checkbox" type="checkbox" name="task7" id="task7">
