...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-crm-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-crm-contact.html"><span>Contact</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-6 mobile-bottom-fix">
							<h1 class="page-title mb2">Contact List</h1>
										...
										<table class="table qd-table mb6 align-middle">
											...
											<tbody>
												<tr>
													...
													<td>
														<strong class="text-heading">326</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
														<span class="badge rounded-pill badge-soft text-bg-info me2">Partner</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
												...
												<tr>
													...
													<td>
														<strong class="text-heading">183</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-info me2">Partner</span>
														<span class="badge rounded-pill badge-soft text-bg-danger me2">Exiting</span>
													</td>
													<td>
														<div class="d-flex flex-column justify-content-start">
															<strong class="text-heading mb1">09 Apr, 2023</strong>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">463</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
														<span class="badge rounded-pill badge-soft text-bg-info me2">Partner</span>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">173</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger me2">Exiting</span>
													</td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">362</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
														<span class="badge rounded-pill badge-soft text-bg-danger me2">Exiting</span>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">267</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
														<span class="badge rounded-pill badge-soft text-bg-info me2">Partner</span>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">832</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-danger me2">Exiting</span>
													</td>
												...
												<tr>
													...
													<td>
														<strong class="text-heading">136</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
													</td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Nathaneal Down</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">nathaneal@sitename.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Technologyia</span>
													</td>
													<td>
														<strong class="text-heading">251</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
													</td>
												...
												<tr>
													...
													<td>
														<div class="d-inline-flex flex-row align-items-center">
															...
															<div class="d-flex flex-column justify-content-start">
																<strong class="text-heading mb1">Parsley Montana</strong>
																<a href="#" class="text-decoration-none text-body hover-primary">parsley@yourdomain.com</a>
															</div>
														</div>
													</td>
													<td>
														<span>Railroading</span>
													</td>
													<td>
														<strong class="text-heading">373</strong>
													</td>
													<td>
														<span class="badge rounded-pill badge-soft text-bg-primary me2">Lead</span>
														<span class="badge rounded-pill badge-soft text-bg-danger me2">Exiting</span>
	...
	<script src="assets/js/pages/apps/crm/contact.js" crossorigin="anonymous"></script>
</body>

<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-crm-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:56 GMT -->
</html>