...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-invoice-manager-invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:49:08 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-invoice-manager-invoice-details.html"><span>Invoice Details</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Invoice Details - #3844</h1>
							...
							<div class="card shadow-card">
								<div class="p6 border-bottom">
									<div class="row d-flex align-items-center justify-content-between">
										<div class="col-xxl-8 col-lg-6 d-flex flex-column align-items-start justify-content-start mobile-bottom-fix">
										...
										<div class="col-xxl-4 col-lg-6 text-end">
											<div class="row mb4">
												<div class="col-6">
													<h5 class="m0 me6">Invoice:</h5>
												</div>
												<div class="col-6">
													<h5 class="m0">#3844</h5>
												</div>
											...
											<div class="row mb2">
												<div class="col-6">
													<strong class="me6">Date Issued:</strong>
												</div>
												<div class="col-6">
											...
											<div class="row">
												<div class="col-6">
													<strong class="me6">Due Date:</strong>
												</div>
												<div class="col-6">
													<strong class="text-heading">16 Apr, 2023</strong>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="p6 border-bottom">
									<div class="row d-flex align-items-start justify-content-between">
										<div class="col-md-5 d-flex flex-column align-items-start justify-content-start mobile-bottom-fix">
											...
											<p class="mb0">5 Harriman Woods Dr, Harriman,<br>New York 10926, USA</p>
											<p class="mb0">Sage Technologies Inc.</p>
											<p class="mb0">Norman Gordon</p>
											<p class="mb0">+1 (570) 253-2853</p>
										</div>
										<div class="col-md-6 offset-md-1">
											<h6 class="mb4">Bill To:</h6>
											<div class="row mb2">
												<div class="col-4">
													<strong class="me6">Total Due:</strong>
												</div>
												<div class="col-6">
													<strong class="text-heading">$3.745,20</strong>
												</div>
											</div>
											<div class="row mb2">
												<div class="col-4">
													<strong class="me6">Bank Name:</strong>
												</div>
												<div class="col-8">
													<strong class="text-heading">American Bank</strong>
												</div>
											</div>
											<div class="row mb2">
												<div class="col-4">
													<strong class="me6">Country:</strong>
												</div>
												<div class="col-8">
											...
											<div class="row mb2">
												<div class="col-4">
													<strong class="me6">IBAN:</strong>
												</div>
												<div class="col-8">
													<strong class="text-heading">US61C142001109919890N422042</strong>
												</div>
											</div>
											<div class="row">
												<div class="col-4">
													<strong class="me6">SWIFT Code:</strong>
												</div>
												<div class="col-8">
													<strong class="text-heading">US91905</strong>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="p6">
									<div class="alert alert-info m0" role="alert">All accounts are to be paid within 7 days from receipt of invoice.</div>
								</div>
							</div>
						</div>
						<!-- Invoice End -->
								...
								<div class="row">
									...
									<div class="col-12 mb6">
										<div class="card shadow-card p6">
											<button type="button" class="btn btn-primary mb2">Pay Now</button>
											<button type="button" class="btn btn-secondary btn-soft mb2">Download</button>
											<button type="button" class="btn btn-secondary btn-soft">Print</button>
										</div>
									</div>
									<!-- Buttons End -->
								</div>
