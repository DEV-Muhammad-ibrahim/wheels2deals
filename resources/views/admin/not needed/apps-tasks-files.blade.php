...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-tasks-files.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:54 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-tasks-files.html"><span>Files</span></a></li>
						</ul>
					</li>
			...
			<div class="app-content p6 pb2 smp1">
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-12">
							<h1 class="page-title mb2">Files</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-tasks-overview.html">Tasks</a></li>
					...
					<div class="row">
						...
						<div class="col-12 mb6">
							<div class="card shadow-card">
								<div class="p6 border-bottom">
									<div class="row">
										<div class="col-xxl-5">
											<div class="img-fix height-240 rounded mobile-bottom-fix">
												<img src="assets/media/projects/1.jpg" alt="">
											</div>
										</div>
										<div class="col-xxl-7">
											<h6 class="mb2">Smart Home Mobile App UI Kit</h6>
											<p class="mb4 text-body">Quisque at auctor risus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam elementum dui in nibh eleifend ultricies. Sed ut lorem vel diam luctus condimentum.</p>
											<div class="d-flex flex-row justify-content-start align-items-center mb4">
												<span class="badge rounded-pill badge-soft text-bg-primary me3">Mobile Design</span>
												<span class="badge rounded-pill badge-soft text-bg-info">Mobile Development</span>
											</div>
											<div class="row mb4 align-items-center">
												<div class="col-md-6 mobile-bottom-fix">
													<div class="border-dashed p4 rounded d-flex align-items-center justify-content-between hover-light">
											...
											<div class="d-flex align-items-center justify-content-between mb2">
												<strong class="text-heading">Progress Status</strong>
												<span>60%</span>
											</div>
								...
								<ul class="horizontal-menu ss-container">
									<li><a href="apps-tasks-task-detail.html">Overview</a></li>
									<li><a href="apps-tasks-users.html">Users</a></li>
									<li class="active"><a href="apps-tasks-files.html">Files</a></li>
								</ul>
							</div>
						</div>
						<!-- Task Top Start -->
