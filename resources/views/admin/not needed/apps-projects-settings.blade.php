...
<!-- Mirrored from qoduby.tempload.com/html/demo6/dist/apps-projects-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2024 19:48:51 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-settings.html"><span>Settings</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="apps-projects-settings.html">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
											...
											<div class="row">
													...
													<div id="drop-area" class="d-flex bg-light">
														<div class="width-120 height-120 border-dashed rounded bg-body-secondary position-relative overflow-hidden d-flex align-items-center justify-content-center">
															...
															<div class="img-fix width-120 height-120 position-absolute top-0 start-0">
																<img id="preview-img" src="assets/media/projects/1.jpg" class="">
															</div>
														</div>
												...
												<div class="col-lg-6 mb5">
													<label for="add-form-1" class="form-label">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a project name."></i>
													</label>
													<input id="add-form-1" class="form-control" type="text" value="App Landing Page Web Template UI Kit" required>
												...
												<div class="col-lg-6 mb5">
													<label for="add-form-2" class="form-label">
														...
														<span class="text-danger">*</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select project category."></i>
													</label>
													<select id="add-form-2" class="form-select js-choice" required>
														<option value="">Select Category</option>
														<option value="1" selected>Development</option>
														<option value="2">Front-End Coding</option>
														<option value="3">Back-End Coding</option>
												...
												<div class="col-lg-6 mb5">
													<label for="add-form-3" class="form-label">
														<span>Create Date</span>
														<span class="text-danger">*</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select a create date."></i>
													</label>
													<input id="add-form-3" class="form-control qd-datepicker-single" type="text" value="07 January 2023" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-lg-6 mb5">
													<label for="add-form-4" class="form-label">
														<span>Due Date</span>
														<span class="text-danger">*</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select a due date."></i>
													</label>
													<input id="add-form-4" class="form-control qd-datepicker-single" type="text" value="09 April 2023" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-lg-6 mb5">
													<label for="add-form-4" class="form-label d-block">
														<span>Notifications</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select a notification settings."></i>
													</label>
													<div class="checkbox checkbox-primary me4">
														<input type="checkbox" name="check-form-1" id="check-form-1" checked>
														<label for="check-form-1">Email</label>
													</div>
													<div class="checkbox checkbox-primary me4">
														<input type="checkbox" name="check-form-2" id="check-form-2">
														<label for="check-form-2">SMS</label>
													</div>
												</div>
												<div class="col-lg-6 mb5">
													<label for="add-form-4" class="form-label d-block">
														<span>Status</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Select a status."></i>
													</label>
													<div class="d-flex align-items-center justify-content-start">
														<label class="qd-switch switch-primary switch-sm me2">
												...
												<div class="col-12">
													<label for="add-form-5" class="form-label">
														...
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a project description (optional)."></i>
													</label>
													<textarea class="form-control" id="add-form-5" rows="6">UI/UX Design, prototype, wireframing, mockups, clients collaboration</textarea>
												</div>
											</div>
										</div>
									</div>
