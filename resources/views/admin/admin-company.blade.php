                ...
                <div class="container p0">
                    ...
                    <div class="row mb6 align-items-center">
                        ...
                        <div class="col-md-6 text-start text-md-end">
                            ...
                            <!-- Add Button Start-->
                            <a href="{{ Route('add_company') }}" class="btn btn-primary">Add
                                Company</a>
                            <!-- Add Button End-->
                        </div>
                    </div>
                                                    ...
                                                    <td>
                                                        <div class="d-inline-flex flex-row align-items-center">
                                                            <div class="width-120 height-80 img-fix rounded me4">
                                                                <img src="{{ asset('public/storage/' . $company->image) }}"
                                                                    alt="">
                                                            </div>
                                                            <strong class="text-heading">{{ $company->name }}</strong>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="dropdown text-end">
                                                            ...
                                                            <ul class="dropdown-menu text-start">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('edit_company', $company->id) }}">Edit</a>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item d-flex align-items-center justify-content-between"
                                                                        href="#">
                                                                        <form
                                                                            action="{{ route('delete_company', $company->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('POST')
                                                                            <button type="submit"
