                ...
                @foreach ($types as $type)
                    <div class="col">
                        <a href="{{ route('vehicles.search', ['type' => $type->id]) }}" class="category-card">
                            <img src="{{ asset($type->image) }}" alt="category" /><span>{{ $type->name }}
                            </span>
                        </a>
                    </div>
                @endforeach
                ...
                @foreach ($brands as $comp)
                    <div class="col">
                        <a class="brand-card" href="{{ route('vehicles.search', ['company' => $comp->id]) }}">
                            <img src="{{ asset($comp->image) }}" alt="brand" class="img-fluid" />
                            <h6>{{ $comp->name }}</h6>
                        </a>
                    </div>
                @endforeach
                        ...
                        <div class="product-grid-card">
                            ...
                            <div class="product-grid-content">
                                ...
                                <ul class="product-grid-extra">
                                    ...
                                    <li>
                                        <i
                                            class="material-icons">local_gas_station</i><span>{{ $car->fuel }}</span>
                                    </li>
                                </ul>
                ...
                <div class="col-xl-12">
                    <div class="section-head">
                        ...
                        <a href="{{ Route('about') }}" class="btn btn-inline"><i
                                class="material-icons"></i><span>more
                                details</span></a>
                    </div>
                </div>
            </div>
