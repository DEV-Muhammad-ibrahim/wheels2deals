    ...
    <section class="section-gap-100">
        <div style="background: url(../images/banner/single/01.jpg) no-repeat center / cover;">
            <div class="single-banner">
                <div class="container">
                    <h2>vendor grid page</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">vendor-grid</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="col-xl-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-action"><a href="vendor-grid.html" title="Grid View"
                                        class="material-icons active">grid_view</a><a href="vendor-list.html"
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3">
                        ...
                        <div class="col">
                            <div class="vendor-grid-card"><a class="vendor-grid-cover" href="profile.html"><img
                                ...
                                <ul class="vendor-grid-meta">
                                    ...
                                    <li class="rating"><i class="material-icons">star</i><span><b>4.9</b>/28
                                            Ratings</span></li>
                                    <li class="store"><i class="material-icons">store</i><span>dealership</span></li>
                                </ul>
                                <div class="vendor-grid-action"><a href="profile.html">visit profile</a><button
                                        type="button" data-bs-toggle="modal" data-bs-target="#modalMessage">send
                                        message</button></div>
                        ...
                        <div class="col">
                            <div class="vendor-grid-card"><a class="vendor-grid-cover" href="profile.html"><img
                                        src="../images/bg/cover.jpg" alt="cover"></a><a class="vendor-grid-avatar"
                                    href="profile.html"><img src="../images/logo/03.jpg" alt="logo"></a>
                                <ul class="vendor-grid-meta">
                                    <li class="profile"><i class="material-icons">account_circle</i><a
                                            href="profile.html">brand name</a></li>
                                    <li class="location"><i class="material-icons">map</i><span>chashara,
                        ...
                        <div class="col">
                            <div class="vendor-grid-card"><a class="vendor-grid-cover" href="profile.html"><img
                                        src="../images/bg/cover.jpg" alt="cover"></a><a class="vendor-grid-avatar"
                                    href="profile.html"><img src="../images/avatar/04.jpg" alt="avatar"></a>
                                <ul class="vendor-grid-meta">
                                    <li class="profile"><i class="material-icons">account_circle</i><a
                                            href="profile.html">person name</a></li>
                                    <li class="location"><i class="material-icons">map</i><span>chashara,
                        ...
                        <div class="col">
                            <div class="vendor-grid-card"><a class="vendor-grid-cover" href="profile.html"><img
                                        src="../images/bg/cover.jpg" alt="cover"></a><a class="vendor-grid-avatar"
                                    href="profile.html"><img src="../images/logo/04.jpg" alt="logo"></a>
                                <ul class="vendor-grid-meta">
                                    <li class="profile"><i class="material-icons">account_circle</i><a
                                            href="profile.html">brand name</a></li>
                                    <li class="location"><i class="material-icons">map</i><span>chashara,
                        ...
                        <div class="col">
                            <div class="vendor-grid-card"><a class="vendor-grid-cover" href="profile.html"><img
                                        src="../images/bg/cover.jpg" alt="cover"></a><a class="vendor-grid-avatar"
                                    href="profile.html"><img src="../images/avatar/05.jpg" alt="avatar"></a>
                                <ul class="vendor-grid-meta">
                                    <li class="profile"><i class="material-icons">account_circle</i><a
                                            href="profile.html">person name</a></li>
                                    <li class="location"><i class="material-icons">map</i><span>chashara,
