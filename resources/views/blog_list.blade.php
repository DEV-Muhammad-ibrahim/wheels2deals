                    ...
                    <div class="row row-cols-1">
                        <div class="col">
                            <div class="blog-list-card">
                                <div class="blog-list-media"><img src="../images/blog/01.jpg" alt="blog"></div>
                                <div class="blog-list-content">
                                    ...
                                    <h3 class="blog-list-title"><a href="blog-single.html">Lorem ipsum dolor sit amet
                                            consectetur adipisicing elit expedita quam distinctio aliquid quaerat.</a>
                                    </h3>
                                    <p class="blog-list-descrip">Lorem ipsum dolor sit, amet consectetur adipisicing
                                        elit. Eius placeat aperiam similique quisquam Distinctio voluptas rerum culpa
                                        deleniti voluptatum adipisci quod libero itaque mollitia doloribus ipsa in nihil
                                        ipsam, sequi eos eaque! Dolorem repellendus facere aut aliquam provident in! Sit
                                        voluptatum fugiat assumenda in fuga ratione optio, beatae blanditiis
                                        officiis...<a href="blog-single.html">read more</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="blog-list-card">
                                <div class="blog-list-media"><img src="../images/blog/02.jpg" alt="blog"></div>
                                <div class="blog-list-content">
                                    <ul class="blog-list-meta">
                                        <li><i class="material-icons">account_circle</i><span>post by <a
                                                    href="blog-single.html">admin</a></span></li>
