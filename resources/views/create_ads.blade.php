                ...
                <div class="col-lg-7 col-xl-8">
                    <form class="create-ads-form" action="{{ Route('ad_create') }}" method="POST">
                        ...
                        <div class="common-card active">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group"><label class="form-label">Title
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-12 col-xl-4">
                                    <div class="form-group"><label class="form-label">make
                                            <span>*</span></label><select class="form-select">
                                            <option selected>---</option>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-12 col-xl-4">
                                    <div class="form-group"><label class="form-label">year
                                            <span>*</span></label><select class="form-select">
                                            <option selected>---</option>
                                    ...
                                    <div
                                        ...
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    ...
                                                    for="check1">power Steering</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check2"><label class="form-check-label"
                                                    for="check2">Manually Adjustable</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check3"><label class="form-check-label"
                                                    for="check3">Vanity Mirror</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check4"><label class="form-check-label"
                                                    for="check4">Trunk Light</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check5"><label class="form-check-label"
                                                    for="check5">Knee Airbags</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check6"><label class="form-check-label"
                                                    for="check6">power Steering</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check7"><label class="form-check-label"
                                                    for="check7">Rain Sensing</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check8"><label class="form-check-label"
                                                    for="check8">Warranty Time</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                        ...
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    ...
                                                    for="check10">Sensing Lock</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check11"><label class="form-check-label"
                                                    for="check11">Manually Adjustable</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check12"><label class="form-check-label"
                                                    for="check12">Warranty Time</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check13"><label class="form-check-label"
                                                    for="check13">Trunk Light</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="check14"><label class="form-check-label"
                                    ...
                                    <div
                                            ...
                                            <div class="form-group-radio"><label class="form-group-radio-label">Power
                                                ...
                                                <div class="form-group-radio-check">
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup2" id="radio3"><label
                                                            class="form-check-label" for="radio3">yes</label></div>
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup2" id="radio4"><label
                                        ...
                                        <div class="col">
                                            <div class="form-group-radio"><label class="form-group-radio-label">Cruise
                                                ...
                                                <div class="form-group-radio-check">
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup3" id="radio5"><label
                                                            class="form-check-label" for="radio5">yes</label></div>
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup3" id="radio6"><label
                                        ...
                                        <div class="col">
                                            <div class="form-group-radio"><label class="form-group-radio-label">Driver
                                                ...
                                                <div class="form-group-radio-check">
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup4" id="radio7"><label
                                                            class="form-check-label" for="radio7">yes</label></div>
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup4" id="radio8"><label
                                        ...
                                        <div class="col">
                                            <div class="form-group-radio"><label class="form-group-radio-label">Bucket
                                                ...
                                                <div class="form-group-radio-check">
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup5" id="radio9"><label
                                                            class="form-check-label" for="radio9">yes</label></div>
                                                    <div class="form-check"><input class="form-check-input"
                                                            type="radio" name="radioGroup5" id="radio10"><label
                        ...
                        <div class="common-card">
                            ...
                            <div class="common-card-body">
                                ...
                                <div class="create-social">
                                    <div
                                        class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2">
                                        <div class="col">
                                            <div class="form-group"><label class="form-label">facebook
                                                    URL</label><input type="url" class="form-control"></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group"><label class="form-label">twitter
                                                    URL</label><input type="url" class="form-control"></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group"><label class="form-label">linkedin
                                                    URL</label><input type="url" class="form-control"></div>
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="form-group"><label class="form-label">youtube
                                                    URL</label><input type="url" class="form-control"></div>
                                        </div>
                                        <div class="col">
                        ...
                        <div class="common-card">
                            ...
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2">
                                ...
                                <div class="col">
                                    <div class="form-group"><label class="form-label">road no</label><input
                                            type="text" class="form-control"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group"><label class="form-label">shop no</label><input
                                            type="text" class="form-control"></div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="form-group mb-0"><label class="form-label">Others</label>
                                        <textarea class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="common-card">
                                    ...
                                    <li class="accordion-item">
                                        ...
                                        <div class="accordion-ans">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="add a new answer"></textarea>
                                            </div>
                            ...
                            <div class="create-new-faqs">
                                ...
                                <div class="form-group"><label class="form-label">add a new answer
                                        <span>*</span></label>
                                    <textarea class="form-control"></textarea>
                                </div><button type="submit" class="form-btn">add faqs</button>
                            </div>
                        </div>
                        <div class="common-card">
                            <div class="common-card-header">
                                ...
                                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2">
                                    ...
                                    <div class="col col-lg-6">
                                        <div class="create-pay-card"><i class="material-icons">check_circle</i><img
                                                src="../images/cards.png" alt="cards"><small>Pay with
                                                card</small></div>
                                    </div>
                                    <div class="col col-lg-6">
                                        <div class="create-pay-card"><i class="material-icons">check_circle</i><img
                                                src="../images/paypal.png" alt="paypal"><small>Pay with
                                                paypal</small></div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="form-check"><input class="form-check-input" type="checkbox"
                                                id="checkAgree"><label class="form-check-label" for="checkAgree">I
